<div id="aba_localizar_img">        
	<div class="submenu">
        ...
        <div class="item_selecionado"><a href="?pagina=pagedit&menu=<?=$_GET['menu']?>&idPag=<?=$_GET['idPag'];?>&aba=imagens&sb=buscar"><img src="../layout/imagens/intra_btn_buscar.png" border="0" alt="buscar no repositório"></a></div>
    </div>
	<div class="subabas" id="img_busca">       
		<?php include("conteudo/forms/form_imgbusca.php"); ?> 
	</div>
</div>