	...
	<div id="margem_direita"><br>
		<div class="conteudo_abas">
            ...
            <div id="conteudo_dados" style="display:inline">
				...
				<input name="FnewPass1" id="FnewPass1" type="password" class="componente_miolo_menor" maxlength="10" />
                <script type="text/javascript">
					var FnewPass1= new LiveValidation('FnewPass1');
					FnewPass1.add(Validate.Presence, {failureMessage: "Obrigatorio"});
				</script> 
                <br>
				<div class="texto_formulario">Confirmar Nova Senha:</div>
                <input name="FnewPass2" id="FnewPass2" type="password" class="componente_miolo_menor" maxlength="10" />
                <script type="text/javascript">
