...
<body>
  ...
  <header>
    <a href="http://ramais.pmf.sc.gov.br">
  ...
  <h1>Serviços Públicos Municipais</h1>
...
<h1>Serviços Públicos Estaduais</h1>

<section class="ajustSectionUm">
  
<?php include_once("php/direta3.php"); ?>

<?php include_once("php/direta4.php"); ?>
