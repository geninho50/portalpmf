...
class gdb
{
  ...
  function open(
    ...
    if (!$this->conexao_lg) {      
      $this->conexao('ouvidoria', '192.168.12.2:3309', 'root', 'Change1.');
    }
  ...
  function formato($vr_varv, $vr_form)
  {
    ...
    function editarSenha($id_pessoa,$senha){
      ...
      if( $this->linhas>0 ){
          ...
          // criar aqui o select para inserir o usu�rio e senha        
      }
    ...
    function pHTML($texto) {

      // Use mb_convert_encoding para converter a string
      $caracteres = array(
        ' ' => '&aacute;',
        ' ' => '&agrave;',
        ' ' => '&acirc;',
        ...
        ' ' => '&Ugrave;',
        ' ' => '&Ucirc;',
        // Adicione outros caracteres e suas substitui  es conforme necess rio
    );
   ...
   function tipoDados($codigo){
      ...
      return $mysql_data_type_hash[$codigo];
