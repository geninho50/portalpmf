...
<?php
	//header("Location: /arquivos/arquivos/pdf/30_09_2015_16.52.51.ea817ecc7690af665baa1206f9f09cce.pdf");
?> 
...
<?php
	...
	{	
	   ...
	   $sql5 = "SELECT DISTINCT pac_serv_pac_id, 
		               pac_serv_serv_id 
		          FROM pacote_servicos 
				 WHERE pac_serv_serv_id = $id 
			  ORDER BY pac_serv_pac_id ASC";
