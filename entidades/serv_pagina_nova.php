...
<div class="centro">
     ...
     <a href="../serv_pagina_print.php?acao=open&id=<?=$id?>">
     <img src="../../layout/imagens/btn_entid_impressao_novo.png" alt="versão para impressão" border="0" align="bottom" /></a>
     ...
     <?php
	  	...
	  	if($objserv->serv_flag_online == "t")
		{
			...
			{
			echo("<a href=\"$objserv->serv_link\" target=\"_self\" border=\"0\"><img src=\"../../layout/imagens/btn_entid_online_novo.png\" border=\"0\" /></a>");
		
			}
			else
			{
			echo("<a href=\"sistema.php?servicoid=".$objserv->serv_id."\" target=\"_self\" border=\"0\"><img src=\"../../layout/imagens/btn_entid_online_novo.png\" border=\"0\" /></a>");
			}
      ...
      <?php
			...
			$string .= "<img src=\"../../layout/imagens/entid_marcador_grande.png\"  align=\"absmiddle\" />";
      ...
      <?php
		 	if($rowdocumentos !=0)
			{
				...
				$string .= "&nbsp;documentos para download</h3><table>";
					...
					{
						$string .= "<tr><td>" . html_entity_decode($objdoc->doc_nome) . "</td><td width=\"140\"><a href=\"index.php?pagina=servdoc&menu=3&id=$objdoc->doc_id\"><img src=\"../../layout/imagens/serv_btn_info.png\" alt=\"informações\" border=\"0\" align=\"absmiddle\" /></a> <a href=\"../../arquivos/documentos/$objdoc->doc_link\"><img src=\"../../layout/imagens/entid_btn_download_novo.png\" alt=\"online\" border=\"0\" align=\"absmiddle\" /></a></td></tr> ";
					}
