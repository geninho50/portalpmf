...
if(isset($_POST['entid_intranet']))
{
	...
	$sqlEntidade	= "SELECT entidade_tipo 
	                     FROM entidades 
						WHERE entidade_id = ".$_SESSION['SuserEnt'];
	...
	$sqlPerfil 		= "SELECT * 
						...
						WHERE intranet_user_id = ".$_SESSION['SuserId']." AND intranet_entidade_id = ".$_SESSION['SuserEnt']."";
	...
	$sqlAssMenu = 	"SELECT REL.intranet_menu_rel_atalho 
	                   FROM intranet_menu_relacionado AS REL 
				 INNER JOIN intranet_submenu AS SUB 
				         ON REL.intranet_menu_rel_menu_id = SUB.intranet_submenu_id 
	...
	$sqlPaginasLiberadas	= "SELECT SUBM.intranet_submenu_atalho 
								 FROM intranet_submenu AS SUBM 
						   INNER JOIN intranet_perfil_submenu AS PERF 
						           ON intranet_submenu_id = intranet_perfil_submenu_submenu_id 
								WHERE intranet_perfil_submenu_perfil_id = $TperfilInicial";
	...
	$sqlMenu 	 = "SELECT MEN.intranet_menu_atalho 
				...
				INNER JOIN intranet_perfil_menu AS PERF 
					 ...
					 WHERE PERF.intranet_perfil_menu_perfil_id = $TperfilInicial";
...
<link rel="shortcut icon" href="../layout/imagens/brasao.gif" type="image/x-icon" />
...
<link rel="stylesheet" href="../scripts/slidesjs/css/global.css" type="text/css">
<link rel="stylesheet" href="../scripts/js/livevalidation/livevalidation13.css" type="text/css" />
...
<script type="text/javascript" src="../scripts/js/ui/jquery-ui.min.js"></script>
<script type="text/javascript" src="../scripts/slidesjs/js/slides.min.jquery.js"></script>
<!--<link rel="stylesheet" href="../scripts/jcarosellite/jcarousellite.css" type="text/css" media="screen"/>-->
<!--<script type="text/javascript" src="http://gsgd.co.uk/sandbox/jquery/easing/jquery.easing.1.3.js"></script>-->
<!--<script type="text/javascript" src="../scripts/jcarosellite/jcarousellite.js"></script>-->
<!-- ============================= -->
<!-- rever utilização deste script -->
<!-- ============================= -->
<script>
	$(document).ready(function(){
		$("a[rel='colorbox-principal']").colorbox({transition:"elastic"});
		$("a[rel='colorbox-galeria']").colorbox({transition:"elastic"});
		$(".cboxpagina").colorbox({width:"520", height:"90%", iframe:true});
	});
</script>
<!-- ============================= -->
<!-- rever utilização deste script -->
...
<?php require_once("requires_ptags.php"); ?>
<?php require_once("requires_maling.php"); ?>
</div>

<div class="layout_intranet interno">

<?php $menu_principal = "intranet";  ?>
			...
			<div id="conteudo_coluna1">
		     	<div id="menu">
     				<div id="titulo-intranet">&nbsp;</div>
       					<?php
						$menu = 0;
					 	include("../layout/menus/menu_intranet.php");
	 					?>
