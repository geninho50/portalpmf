        ...
        <main class="main-content">
            ...
            <header class="header">
                <div class="header-left">
                    ...
                    <h1>Gerenciar Notícias e Eventos</h1>
                    <p>Administre as notícias, eventos, editorias e calendario</p>
                </div>
            ...
            <div class="dashboard-content">
                ...
                <div class="card text-center" >
                    ...
                    <div class="menu-nav-bootstrap">
                        <ul class="nav nav-tabs  mb-4 main">

                            <li class="nav-item main-item">
                                <h3><a id="1menu" class="nav-link active" aria-current="page" href="#" onclick="trocaMenu(1)">Noticias</a></h3>
                            </li>
                            <li class="nav-item main-item">
                                <h3><a id="2menu" class="nav-link" href="#" onclick="trocaMenu(2)">Eventos</a></h3>
                            </li>
                            <li class="nav-item main-item">
                                <h3><a id="3menu" class="nav-link" href="#" onclick="trocaMenu(3)">Editoria</a></h3>
                            </li>
                            <li class="nav-item main-item">
                                <h3><a id="4menu" class="nav-link" href="#" onclick="trocaMenu(4)">Calendarios</a></h3>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div id="1new-menu" style="display:block">
                        ...
                        <div class="card text-center" >
                            ...
                            <!--Abas do Menu Noticias-->
                            <div class="menu-nav-bootstrap">
                                <ul class="nav nav-tabs  mb-4 subMenu">
                                    <li class="nav-item">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div style="flex: 1;">
                                                        ...
                                                        <input type="radio"  id="StatusEs" class="radio-form" name="escolha" checked><label for="StatudEs" class="radioEscolhas">Editando</label>
                                                        <input type="radio"  id="StatusPu" class="radio-form" name="escolha" ><label for="StatudPu" class="radioEscolhas">Publicar</label>
                                                ...
                                                <div class="form-row">
                                                    <div style="flex: 1;">
                                                        <label class="form-label">Linha de Apoio</label>
                                                        <textarea name="textocaixa" class="form-input" placeholder="" required rows="2"></textarea>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div style="flex: 1;">
                                                        ...
                                                        <input type="file" id="input-file" hidden>
                                                        <label for="input-file" class="btn custom-file">Seu Banner</label>
                                                    </div>

                                                    <div style="flex: 1;">
                                                        <label class="form-label">Midia</label>
                                                        <select name="categoria" class="form-input">
                                                        <option value="Imagem" for="input-file">Imagem</option>
                                                        <option value="Video">Video</option>
                                                        <option value="Audio">Áudio</option>
                                                        <option value="Arquivo">Arquivo</option>
                                                        </select>
                                     ...
                                     <div class="card-footer">
                                        <div class="form-row">
                                            <div style="flex: 1;">
                                                <label class="form-label">Evento ao vivo?</label>
                                                <input class="radioEscolhas" type="radio" id="radioEv"  name="liberar"  checked> <label class="radio-label" for="radioEv">Sim</label>
                                                <input class="radioEscolhas" type="radio" id="radioEA" name="liberar"> <label class="radio-label" for="radioEA">Não</label>
                                            </div>
                                            <div style="flex: 3;">
                                                <input type="text" class="form-input opcao1" placeholder="Link para o evento, http://">
                                             </div>
                                            <div style="flex: 1;">
                                                <button type="submit" class="btn btn-primary" style="color:#00B1EB">Criar Notícia </button>
                                            </div>
                                            ...
                                            <div style="flex: 1;">
                                                <button type="button" class="btn btn-primary" onclick=""  style="color:#00B1EB;">Cancelar</button>
                                            </div>
                                        </div>
                                    </div>
