...
<div id="margem_direita">
    <div class="painel_abas">
        <a href="?pagina=pagedit&menu=<?=$_GET['menu']?>&idPag=<?=$_GET['idPag'];?>&aba=dados"><div id="aba_dados" class="aba_sel"><span>dados</span></div></a>
    ...
    <div class="conteudo_abas">  
		<div id="conteudo_dados">
			<?php include("conteudo/forms/form_pagedit.php"); ?> 
		</div>
    </div>
</div>