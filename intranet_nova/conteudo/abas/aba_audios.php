...
<div id="margem_direita">
    <div class="painel_abas">
        ...
        <a href="?pagina=pagedit&menu=<?=$_GET['menu']?>&idPag=<?=$_GET['idPag'];?>&aba=audios"><div id="aba_audio" class="aba_sel"><span>&aacute;udios</span></div></a>
    ...
    <div class="conteudo_abas">  
        <div id="conteudo_audio">
			<?php 
            switch($_GET['sb']){
                case "galeria": require_once("audios/aud_galeria.php"); break;
                case "insere": require_once("audios/aud_insere.php"); break;     
				case "buscar": require_once("audios/aud_buscar.php"); break;               
               	default: require_once("audios/aud_galeria.php");
            }
            ?>      
            <br class="clearfloat">     
        </div>
