...
<div id="margem_direita">
    <div class="painel_abas">
        ...
        <a href="?pagina=pagedit&menu=<?=$_GET['menu']?>&idPag=<?=$_GET['idPag'];?>&aba=videos"><div id="aba_video" class="aba_sel"><span>v&iacute;deos</span></div></a>
    ...
    <div class="conteudo_abas">  
        <div id="conteudo_video">
            <?php 
            switch($_GET['sb']){
                case "galeria": require_once("videos/vid_galeria.php"); break;
                case "insere": require_once("videos/vid_insere.php"); break; 
				case "buscar": require_once("videos/vid_buscar.php"); break;                 
               	default: require_once("videos/vid_galeria.php");
            }
            ?> 
            <br class="clearfloat">       
        </div>
