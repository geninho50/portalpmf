...
<div id="margem_direita">
    <div class="painel_abas">
        ...
        <a href="?pagina=pagedit&menu=<?=$_GET['menu']?>&idPag=<?=$_GET['idPag'];?>&aba=visualizar"><div id="aba_view" class="aba_sel"><span>visualiza&ccedil;&atilde;o</span></div></a>
    </div> 
    <div class="conteudo_abas">  
        <div id="conteudo_view">
            <div id="exemplo_publicacao">
                <?php include("conteudo/forms/form_pagina.php"); ?> 
            </div>
        </div>
	</div>
</div>    