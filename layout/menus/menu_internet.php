...
//-------------------------------------------
$sqlSubMenu = "
SELECT intranet_perfil_submenu.intranet_perfil_submenu_perfil_id, intranet_menu.intranet_menu_id, intranet_menu.intranet_menu_tipo, intranet_menu.intranet_menu_posicao
FROM (intranet_perfil_submenu INNER JOIN intranet_submenu ON intranet_perfil_submenu.intranet_perfil_submenu_submenu_id = intranet_submenu.intranet_submenu_id) INNER JOIN intranet_menu ON intranet_submenu.intranet_submenu_pai_id = intranet_menu.intranet_menu_id
...
//---------------------------------------------
$sqlMenu = "
SELECT intranet_menu.intranet_menu_id, intranet_menu.intranet_menu_titulo, intranet_menu.intranet_menu_tipo_pai, intranet_menu.intranet_menu_endereco_fisico, intranet_menu.intranet_menu_atalho, intranet_menu.intranet_menu_posicao, intranet_menu.intranet_menu_tipo, intranet_perfil_menu.intranet_perfil_menu_perfil_id
FROM `intranet_menu` INNER JOIN intranet_perfil_menu ON intranet_menu.intranet_menu_id = intranet_perfil_menu.intranet_perfil_menu_menu_id
...
<ul>
     <li id="menu_fechado_0" style="display:none">
      <span><a href="inicio.php">HOME</a></span></li>

    <li id="menu_aberto_0" style="display:block">
      <span><a href="inicio.php" class="selecionado">HOME</a></span>
    </li>
