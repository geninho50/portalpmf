<?php
	...
	include(CAMINHO_SITE."/layout/themePMF/includes/headerNoCaptcha.php");
?>
...
<?php
	...
	if(($menu_principal != "intranet") && ($menu_principal != "internet")){
	    ...
	    <ul class="mini-header__items">
	      <li><a href="http://<?php echo($urlHost);?>/intranet/index.php" target="_self">Intranet</a></li>
	      <li><a href="http://<?php echo($urlHost);?>/governo/index.php?pagina=govquem" target="_self">Contatos</a></li>
	      <li><a href="http://<?php echo($urlHost);?>/sites/portalservidor">Portal do Servidor</a></li>
		  <li class="mini-header__social" ><a href="http://www.pmf.sc.gov.br/entidades/sadm/index.php?cms=contratacoes+e+aquisicoes+da+lei+no++13+979+2020&menu=0"><b>Dispensas de Licitação nas Ações de Enfrentamento ao CORONAVÍRUS</b></a></li>
		  <li class="mini-header__social" >
		    <a href="http://www.pmf.sc.gov.br/entidades/sadm/index.php?cms=pregoes+e++editais+de+chamamento+da+covid+19"><b>Pregões Eletrônicos simplificados - Lei nº 13.979/2020</b></a></li>
	      ...
	      <li>
		  <a href="http://somarfloripa.com/" target="_blank">Somar Floripa</a>
		  </li>
	    </ul>
...
<div class="header">
  <div class="header__brand">
  	<a href="http://<?php echo($urlHost);?>">
  		<img src="http://<?php echo($urlHost);?>/layout/imagens/marca-pmf.svg">
  	</a>
	</div>
	...
	<ul class="header__nav">
		...
		<li class="has-submenu">
			<a href="http://<?php echo($urlHost);?>/servicos/index.php">Carta de Serviços</a>
			<div class="header__submenu">
				...
				<div data-parent="todos-os-servicos" class="header__submenu-tier-2">
					...
					<a class="orange" href="http://<?php echo($urlHost);?>/servicos/index.php?pagina=servonline">Ver todos os serviços</a>
				</div>
		...
		<li>
			<a href="http://<?php echo($urlHost);?>/governo/index.php?pagina=goveditais">Editais</a>
		</li>
		...
		<li class="has-submenu">
			...
			<div class="header__submenu">
				<div class="header__submenu-tier-2 open">
					<ul>
						<li><a href="http://<?php echo($urlHost);?>/governo/index.php?pagina=govestrutura">Estrutura Organizacional</a></li>
						<li><a href="http://<?php echo($urlHost);?>/governo/index.php?pagina=govquem">Contatos</a></li>
						<li><a href="http://<?php echo($urlHost);?>/entidades/fazenda/index.php?cms=pro+cidadao&menu=4&submenuid=1968">Pró-Cidadão</a></li>
						<li><a href="https://leismunicipais.com.br/prefeitura/sc/florianopolis/">Leis Municipais</a></li>
						<li><a href="https://www.floripanoponto.com.br/" target="_blank">Floripa no Ponto</a></li>
						<li><a href="http://<?php echo($urlHost);?>/ouvidoria/index.php">Ouvidoria</a></li>
					</ul>
				</div>
			</div>
		</li>
		...
		<li>
			 <a href="http://<?php echo($urlHost);?>/transparencia/index.php" target="_blank">Transpar&ecirc;ncia</a>
		</li>
		<?php if(($menu_principal != "intranet") && ($menu_principal != "internet")){  ?>
		    ...
		    <a href="http://www.pmf.sc.gov.br/entidades/sadm/index.php?cms=pregoes+e++editais+de+chamamento+da+covid+19" ><b>Pregões Eletrônicos simplificados - Lei nº 13.979/2020</b></a></li>
					  ...
					  <li><a href="http://<?php echo($urlHost);?>/transparencia/index.php" target="_blank">Portal de transparência</a></li>
					  <!--<li><a href="http://www.pmf.sc.gov.br/temporeal/" target="_blank">Floripa em Tempo Real</a></li>-->
		...
		<li>
			<a href="http://www.pmf.sc.gov.br/entidades/fazenda/index.php?pagina=notpagina&menu=&noti=22571" alt="Facebook"><img src="http://www.pmf.sc.gov.br/entidades/fazenda/arquivos/bannerAgenda.png" width="240px" height="80px" ></a>
		</li>		
       <!--
          <a href="http://agendamentoprocidadao.pmf.sc.gov.br" target="_blank" alt="Facebook"><img src="http://www.pmf.sc.gov.br/entidades/fazenda/arquivos/bannerAgenda.png" width="240px" height="80px" ></a>	
		<li>
			<a href="http://www.pmf.sc.gov.br/radio/" target="_blank" alt="Facebook"><img src="http://www.pmf.sc.gov.br/radio/images/logo_radio_colorido.png" width="60px" height="50px" ></a>
		</li>
	...
	<!--<ul class="header__secondary-nav">
		<li>Serviços para:</li>
		<li><a href="http://<?php echo($urlHost);?>/servicos/index.php?pagina=servcategoria&perfil=cidadao">Cidadão</a></li>
		<li><a href="http://<?php echo($urlHost);?>/servicos/index.php?pagina=servcategoria&perfil=empresa">Empresa</a></li>
	</ul>-->
