     ...
     <li id="menu_fechado_6" style="display:block"><div><a href="javascript:ControlarMenu('6','abrir')">PERSONALIZAR SITE</a></div></li>
     
     <li id="menu_aberto_6" style="display:none">
     <div class="submenu_adm"><a href="javascript:ControlarMenu('6','fechar')">PERSONALIZAR SITE</a> 
         <ul>
         <li>
