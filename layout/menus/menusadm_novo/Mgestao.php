 <li id="menu_fechado_4" style="display:block"><span><a href="javascript:ControlarMenu('4','abrir')">GESTÃO E TRANSPARÊNCIA</a></span></li>
     
     <li id="menu_aberto_4" style="display:none">
     <span><a href="javascript:ControlarMenu('4','fechar')" class="selecionado">GESTÃO E TRANSPARÊNCIA</a> </span>
         <ul>
         <li>
