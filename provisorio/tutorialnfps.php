...
$db->open("SELECT * FROM suporteStm.bannerSuporte WHERE ID_SISTEMA = 2 ORDER BY ID");
...
<meta property="og:site_name" content="Prefeitura de Florianópolis"/>
  ...
  <?php
      echo("<link rel=\"stylesheet\" href=\"https://".$_SERVER['HTTP_HOST']."/layout/pmf-estilo.css\">");
   ?>

<!--Para autocomplete -->
  <link rel="stylesheet" href="layout/pmf-estilo-home-new-2.css" >
		...
		<div class="row" align="center">
			...
			<div class="col-md-4">
				<video width="320" height="240" poster="/arquivos/imagensNFPSe/thumbnail.png" controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #1A272B">
					...
					<a href="sistemas/suporte/nfpssuporte/consultar.php" target="_blank"><h4 style="color:white">CONSULTAR NOTA CELULAR E PC 🔗</h4></a>
				</div>
			...
			<div class="col-md-4">
				<video width="320" height="240" poster="/arquivos/imagensNFPSe/thumbnail.png" controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #1A272B">
					...
					<a href="sistemas/suporte/nfpssuporte/emitirnota.php" target="_blank"><h4 style="color:white">EMITIR NOTA🔗</h4></a>
				</div> 
			...
			<div class="col-md-4">
				<video width="320" height="240" poster="/arquivos/imagensNFPSe/thumbnail.png" controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #1A272B">
					<source src="sistemas/suporte/nfpssuporte/imagens/Cancelar Nota.mp4" type="video/mp4">
						...
						<a href="sistemas/suporte/nfpssuporte/cancelarnota.php" target="_blank"><h4 style="color:white">CANCELAR NOTA 🔗</h4></a>
				</div>
			<div class="col-md-4">
				<video width="320" height="240" poster="/arquivos/imagensNFPSe/thumbnail.png" controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #1A272B">
					<source src="sistemas/suporte/nfpssuporte/imagens/Emitir Nota Celular.mp4" type="video/mp4">
						...
						<a href="sistemas/suporte/nfpssuporte/emitirnotacelular.php" target="_blank"><h4 style="color:white">Emitir Nota no Celular 🔗</h4></a>
				</div>
			<div class="col-md-4">
				<video width="320" height="240" poster="/arquivos/imagensNFPSe/thumbnail.png" controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #1A272B">
					...
					<a href="sistemas/suporte/nfpssuporte/baixarxmlpdf.php" target="_blank"><h4 style="color:white">BAIXAR XML E PDF DA NOTA 🔗</h4></a>
				</div>
			...
			<div class="col-md-4">
				<video width="320" height="240" poster="/arquivos/imagensNFPSe/thumbnail.png" controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #1A272B">
					...
					<a href="sistemas/suporte/nfpssuporte/adesaopf.php" target="_blank"><h4 style="color:white">SOLICITAR NFPS PF E MEI 🔗</h4></a>
				</div>
...
<script>
 $( function() {
    $( "#autocomplete" ).autocomplete({
      source: 'sistemas/suporte/banco/getpagenfps.php',
      minLength: 1,
