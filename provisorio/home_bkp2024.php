...
<body>
  ...
  <script>
    $(document).ready(function(){
      $(".view_pagina").colorbox({iframe:true, width:"1024px", height:"550px"});
    });
  </script>  
  <br>
...
<style>
  ...
  .floatCCA{ right:140px; 
            ...
            border-radius:10px;
            box-shadow: 2px 2px 3px #999;
            background-image:url(sistemas/tainha/taxa.png); 
            background-size:100%; 
            text-align:center;
            font-size:30px; 
            z-index:100;} 
  ...
  .floatIPTU{ 
            ...
            border-radius:10px;
            box-shadow: 2px 2px 3px #999;
            background-image:url(sistemas/tainha/botao_iptu_2024.png); 
            background-size:100%; 
            text-align:center;
            font-size:30px; 
            z-index:100;
  ...
  .floatIncentivoCultura{ 
            ...
            border-radius:10px;
            box-shadow: 2px 2px 3px #999;
            background-image:url(sistemas/tainha/incentivocultura.png); 
            background-size:100%; 
            text-align:center;
            font-size:30px; 
            z-index:100;
  ...
  .floattainhometro{ 
            ...
            border-radius:10px;
            box-shadow: 2px 2px 3px #999;
            background-image:url(sistemas/tainha/popup.png); 
            background-size:100%; 
            text-align:center;
            font-size:30px; 
            z-index:100;
