...
<head>
    ...
    <title>PMGIRS Caderno 5: Programas, Metas e A&ccedil;&atilde;es PMGIRS Florian&oacute;polis</title>
...
<body>
   ...
   <div class="menu pull-left esquerda">
    ...
    <div class="container">
        ...
        <h2 class="text-center">PMGIRS Caderno 5: Programas, Metas e A&ccedil;&atilde;es PMGIRS Florianópolis</h2>

        <br>

        <div class="pdf">
            <iframe src="https://www.pmf.sc.gov.br/sistemas/pmgirs/arquivos/PMGIRS_CADERNO_5_AA_Programas, Metas e Acoes_PMGIRS_Florianópolis.pdf" width="100%" height="100%" style="border: 1px solid;"></iframe>
        </div>
         <div class="alert alert-danger" id="error"></div>


        <h2 class="text-center">Anexo 1: Plano de Metas e Investimentos para implantação do Plano</h2>        
     <div class="pdf">
            <iframe src="https://www.pmf.sc.gov.br/sistemas/pmgirs/arquivos/PMGIRS_CADERNO_5_ANEXO_1_Plano_de_Metas_Investimentos_implantacao_Plano.pdf" width="100%" height="100%" style="border: 1px solid;"></iframe>
        </div>

        <h2 class="text-center">Anexo 2: Estratégias, Programas e Ações</h2>        
     <div class="pdf">
            <iframe src="https://www.pmf.sc.gov.br/sistemas/pmgirs/arquivos/PMGIRS_CADERNO_5_ANEXO_2_ESTRATEGIAS_PROGRAMAS_ACOES.pdf" width="100%" height="100%" style="border: 1px solid;"></iframe>
        </div> 
