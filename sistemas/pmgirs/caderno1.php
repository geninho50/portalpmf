...
<head>
    ...
    <title>PMGIRS Caderno 1: CAPA e Apresentação Introdução</title>
...
<body>
   ...
   <div class="menu pull-left esquerda">
    ...
    <div class="container">
        ...
        <h2 class="text-center">PMGIRS Caderno 1: CAPA e Apresenta&ccedil;&atilde;o Introdu&ccedil;&atilde;o</h2>

        <br>

        <div class="pdf">
            <iframe src="https://www.pmf.sc.gov.br/sistemas/pmgirs/arquivos/PMGIRS_CADERNO_1_CAPA e Apresentação Introdução PMGIRS_Florianópolis.pdf" width="100%" height="100%" style="border: 1px solid;"></iframe>
        </div>
