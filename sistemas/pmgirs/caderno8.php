...
<head>
    ...
    <title>PMGIRS Caderno 8: Minuta Res&iacute;duo da Constru&ccedil;&otilde;o Civil</title>
...
<body>
   ...
   <div class="menu pull-left esquerda">
    ...
    <div class="container">
        ...
        <h2 class="text-center">PMGIRS Caderno 8: Minuta Res&iacute;duo da Constru&ccedil;&atilde;o Civil</h2>

        <br>

        <div class="pdf">
            <iframe src="https://www.pmf.sc.gov.br/sistemas/pmgirs/arquivos/PMGIRS_CADERNO_8_MINUTA RESIDUO DA COSNTRUCAO CIVIL.pdf" width="100%" height="100%" style="border: 1px solid;"></iframe>
        </div>
