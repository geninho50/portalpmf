...
{ 
	...
	**/
	...
	//function DB_mysql($bd = 'gmf',$host = 'localhost',$user = 'root',$pass = 'mkstec8045')
	//function DB_mysql($bd = 'gmf',$host = '187.45.196.207',$user = 'gmf',$pass = 'ser@07@SQL') 
	function DB_mysql($bd = 'gmf',$host = '192.168.1.20',$user = 'gmf',$pass = '6f532!@AT')
	{
		$this->BaseDatos = $bd;
		$this->Servidor = $host;
		$this->Usuario = $user;
