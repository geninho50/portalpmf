<?php
	...
	{
			$query = "INSERT INTO folga (login,guarda,descricao, qtade, qtadeatual, data) values ('$login','$gm','$descricao','$qtade',0,'$data_atual')";
		$verIncluir = true;
	}
	...
	if( $verIncluir == true )
	{
		header ("Location:../controle/cadastro_folga.php");
	}
	else
	{
