<?php
	...
	{
		// alterar dados
		$query = "UPDATE recado_agente set nome='$nome',texto='$texto' where id=$idRecado";
	...
	{
		// excluir notícia
		$query = "delete from recado_agente where id=$idRecado";
		$conexao->executaQuery($query);
	}
	else
	{
		...
		$query = "insert into recado_agente (nome,texto,data,data_texto) values ('$nome','$texto',CURRENT_DATE(),'$data_texto')";
		$conexao->executaQuery($query);
	...
	// Redireciona
	header ("Location:../controle/busca_recado_agente.php");
?>