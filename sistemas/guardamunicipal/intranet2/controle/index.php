...
<table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="787" align="center"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          ...
          <form name="form" method="post" action="../classes/processaLogin.php" onSubmit="return validaFormAll(this,'Continuar','Entrar')">
            <table width="100%"  border="0" cellspacing="1" cellpadding="1">
              ...
              <tr>
                ...
                <td height="30"><input type="password" name="xSENHA" id="xSENHA" class="negrito" onkeypress="return SomenteNumero(event);"/></td>
                </tr>
              <tr>
                <td>&nbsp;</td>
                <td align="left">
      ...
      <tr>
        <td>&nbsp;</td>
        <td align="center"><a href="javascript:POPUP('ajuda_acesso.htm','400','400')"><img src="imagens/ajuda.png" width="207" height="22" border="0"></a></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td align="center" class="letra"><a href="recuperar_senha.php">Esqueceu a senha ou está bloqueada.</a></td>
        <td>&nbsp;</td>
      </tr>
