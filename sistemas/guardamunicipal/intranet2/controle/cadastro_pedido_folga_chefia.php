...
<table width="100%"  border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<!--inicio adm-->
	<fieldset>
	<legend class="cabecalho">CADASTRO PEDIDO FOLGA</legend>
...
<table width="100%"  border="0" cellspacing="1" cellpadding="1">
	  ...
	  <tr>
        <td width="14%" align="right" class="letra">Atividade ou Turno:</td>
        <td width="71%"><select name="yturno" id="yturno" class="negrito" onfocus="mudacor(this,'#8BC5F3')" onblur="mudacor(this,'white')">
	  ...
	  <tr>
	    <td width="14%" height="24" align="right" class="letra">Data da folga:</td>
  	    <td width="71%" align="left">
			<input name="xdatainicio" type="text" class="stylo1" id="xdatainicio" value="<? echo $datainicio;?>" size="12" readonly onfocus="mudacor(this,'#8BC5F3')" onblur="mudacor(this,'white')"/>  			
			...
			a 
			<input name="xdatafim" type="text" class="stylo1" id="xdatafim" value="<? echo $datafim;?>" size="12" readonly onfocus="mudacor(this,'#8BC5F3')" onblur="mudacor(this,'white')"/>  			
			<a onClick="displayCalendar(document.forms[0].xdatafim,'yyyy-mm-dd',this)"> <img  src="imagens/calendario.gif" width='16' height='16' border='0' alt='Selecione a data'></a> 
   		</td>
		<td>&nbsp;</td>
	  </tr>
	  <tr>
        <td width="14%" align="right" valign="top" class="letra">Motivo(s): </td>
        <td width="71%"><textarea name="motivo" cols="80" rows="8" onkeyup="converteUpper(this);"></textarea></td>
      	<td>&nbsp;</td>      
	  </tr>
