...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<!-- inicio do adm -->
	<fieldset>
	<legend class="cabecalho">DUPLICAR CADASTRO DE EVENTOS</legend>
	<form name="form1" method="post" action="../classes/controleEvento.php" enctype="multipart/form-data" onSubmit="return validaFormAll(this,'Confirmar','Confirmar')">
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="1">
		 <tr>
			<td width="196" height="24" align="right" class="letra">Nome:</td>
			<td width="1095"><input name="xnome" id="xnome" type="text" size="52" class="negrito" onkeyup="converteUpper(this);" value="<? echo $nome;?>" readonly="readonly"/></td>
		 </tr>
		  <tr>
		  ...
		  <tr>
			...
			<input type="text" value="<? echo $dataini;?>" name="xdataini" size="12" class="negrito" onfocus="mudacor(this,'#8BC5F3')" onblur="mudacor(this,'white')"/>
		  ...
		  <tr>
			...
			<td width="1095"><input name="hora" id="hora" type="text" size="12" class="negrito" value="<? echo $hora;?>" maxlength="8"  onkeypress="valida_horas(this)"/></td>
		  </tr>
		  <tr>
		  ...
		  <tr>
			...
			<td align="left" class="letra"><input name="xrua" id="xrua" type="text" size="52" class="negrito" value="<? echo $rua;?>" onkeyup="converteUpper(this);" onfocus="mudacor(this,'#8BC5F3')" onblur="mudacor(this,'white')"/>
			  &raquo; Bairro:<font color="#FF0033">*
			  <input name="xbairro" id="xbairro" type="text" size="30" value="<? echo $bairro;?>" class="negrito" onkeyup="converteUpper(this);" onfocus="mudacor(this,'#8BC5F3')" onblur="mudacor(this,'white')"/>
			  </font></td>
		  </tr>
		  <tr>
			<td align="right" valign="top" class="letra">Descrição:</td>
			<td align="left" class="letra"><textarea name="descricao" cols="80" rows="8" class="negrito" id="descricao"><? echo $descricao; ?></textarea></td>
		  </tr>
	  <tr height="2">
