...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<!--inicio adm-->
	<fieldset>
	<legend class="cabecalho">CADASTRO FALTAS</legend>
        ...
        <tr>
          <td colspan="2"><table width="100%"  border="0" cellspacing="1" cellpadding="1">
            <tr>
              ...
              <td width="86%"><input name="idtemp" type="text" id="idtemp" value="<?php echo $idtemp; ?>" size="5" readonly="readonly" class="negrito"/></td>
            </tr>
          </table></td>
        </tr>
        <tr>
          ...
          <table width="100%"  border="0" cellspacing="1" cellpadding="1">
            ...
            <td><input name="gmautorizou" type="text" id="gmautorizou" value="<?php echo $login; ?>" size="20" readonly="readonly" class="negrito"/></td>
              ...
              <input name="status" type="text" id="status" value="<?php echo $status; ?>" size="3" readonly="readonly" class="negrito"/>
        ...
        <tr>
          <td colspan="2"><table width="100%"  border="0" cellspacing="1" cellpadding="1">
            <tr>
              ...
              <td width="86%"><textarea name="xmotivostatus" cols="80" rows="8" onkeyup="converteUpper(this);" class="negrito"></textarea> </td>
            </tr>
          </table></td>
        </tr>
        <tr>
