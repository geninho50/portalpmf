...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<!-- inicio do adm -->
	<fieldset>
	<legend class="cabecalho">CONSULTAR RECADOS</legend>
...
?>
	<tr bgColor="<?PHP if($chavet)
		...
		<td width="60%" align="left" class="negrito"><? echo $nome; ?></td>
		<td width="10%" align="center"><A HREF="cadastro_recado.php?idRecado=<? echo $linha['id']; ?>" border="0"><IMG SRC="imagens/editor_texto.png" WIDTH="18" HEIGHT="18" BORDER="0" TITLE="ALTERAR"></A></td>
	    <td width="10%" class="letra" align="center"><a onClick="Excluir('../classes/controleRecado.php?idRecado=<? echo $linha['id']; ?>')" href="#">	   
	   <IMG SRC="imagens/excluir.png" WIDTH="18" HEIGHT="18" BORDER="0" TITLE="EXCLUIR"></A></td>
...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
	...
	<tr>
		<td width="100%" colspan="3" align="center" class="negrito">NENHUMA OCORRÊNCIA PARA<B><?echo $xBusca;?></B></td>
	</tr>
