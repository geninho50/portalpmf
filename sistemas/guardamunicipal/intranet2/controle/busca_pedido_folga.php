...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<!--inicio adm-->
	<fieldset>
	<legend class="cabecalho">CONSULTAR FOLGAS ENTRE VAGAS</legend>
	...
	<table width="67%" border="0" cellspacing="1" cellpadding="1">
	  ...
	  <tr>
		...
		<td width="47%" align="left" class="letra">
			...
			a 
			<input value="<? echo $datafim;?>" name="datafim" class="negrito" size="12" />
				<a onClick="displayCalendar(document.forms[0].datafim,'yyyy-mm-dd',this)"> <img  src="imagens/calendario.gif" width='16' height='16' border='0' alt='Selecione a data'></a>
		</td>
	  </tr>
