...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<!-- inicio do adm -->
<fieldset>
	<legend class="cabecalho">CADASTRO ALTORIZAÇÃO ESCALAS</legend>	
<form name="form1" method="post" action="../classes/controlePublicarAutorizacao.php" enctype="multipart/form-data" onSubmit="return validaFormAll(this,'Confirmar','Confirmar')">
