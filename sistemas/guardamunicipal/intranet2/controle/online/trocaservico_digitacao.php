<?php 
	$query = "SELECT id, DAY(datatroca) as dia,MONTH(datatroca) as mes,YEAR(datatroca) as ano,gmsolicitante,gmsolicitado,formareposicao,motivotroca,status,data,grupo FROM trocaservico where status=0 and grupo='Digitacao' order by id desc";
	...
	?>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="96%" class="negrito"  bgcolor="#CCCCCC">DIGITAÇÃO</td>
          </tr>
        </table>
