<?php 
	$query = "SELECT id, DAY(datadoacao) as dia,MONTH(datadoacao) as mes,YEAR(datadoacao) as ano,gmsolicitante,status,data,datadoacao,turno FROM doacaosangue where status=0 and grupo='Vespertino' order by id desc";
