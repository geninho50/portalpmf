...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<!-- inicio do adm -->
	<fieldset>
	<legend class="cabecalho">ESCALAS QUE ESTOU CONCORRENDO</legend>
	...
	<?php 
		...
		while( $linhaE = mysql_fetch_array($resultE) )
		{
			...
			$ids = $linhaE["idescala"];
				...
				$queryF = "select * from escalahoraextra where id=$ids and status='S'";
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="1">
		...
		<tr bgColor="<?PHP if($chaveF)
							...
							$chaveF=!$chaveF;
						?>">
			<td width="53%" align="left" class="negrito"><? echo $linhaF['local'].' - '.$semana.' / '.$horainicial.' às '.$horafinal; ?></td>		
			<td width="11%" class="negrito" align="center"><A HREF="../classes/controleNomeEscala.php?id=<? echo $linhaF['id']; ?>&login=<? echo $login; ?>&chave=2" border="0"><IMG SRC="imagens/negado.png" title="CLIC NA IMAGEM PARA RETIRAR O NOME DA ESCALA" width="20" height="20"BORDER="0"></A></td>
		</tr>
	...
	<fieldset>
		<legend class="cabecalho">CANDIDATOS QUE ESTÃO CONCORRENDO A ESCALA</legend>
	...
	?>
		...
		<tr bgColor="<?PHP if($chave)
							...
							$chave=!$chave;
						?>">
			<td width="40%" align="left" class="negrito"><? echo $local.' - '.$semanaJ; ?> - <?php echo $dia." / ".$mes." / ".$ano.' - '.$horainicial; ?> às <?php echo $horafinal; ?></td>
	...
	<fieldset>
		<legend class="cabecalho">ESCALAS DISPONÍVEIS</legend>
	
		<table bgcolor="#0086a8"  width="100%" bordercolor="#FFFFFF" border="1" cellspacing="1" cellpadding="1">
		<tr>
			<td width="32%" align="left" class="branco"><B>Evento</B></td>
			<td width="62%" align="left" class="branco"><B>Informações do Evento</B></td>	
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="1">
		<tr bgColor="<?PHP if($chavet)
						...
						$chavet=!$chavet;
					?>">
			<td width="32%" align="left" class="negrito"><? echo $linhaN['local'].'<br><font class="fieldset"> '.$dia.'/'.$mes.'/'.$ano.' - '.$semanaN.'</font> - '.$horainicial; ?> às <?php echo $horafinal; ?> </td>		
			...
			<td width="6%" align="center" class="negrito"><A HREF="../classes/controleNomeEscala.php?id=<? echo $linhaN['id']; ?>&login=<? echo $login; ?>&chave=1" border="0"><IMG SRC="imagens/true.png" TITLE="CLIC NA IMAGEM PARA FAZER PARTE DA ESCALA" width="20" height="20"BORDER="0"></A></td>
		</tr>
	</table>
	</div>
	<?php
