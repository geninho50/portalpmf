...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<fieldset>
	  <legend class="cabecalho">CONTROLE INFORMAÇÕES INSTITUCIOANL</legend>
    ...
    <form name="form" action="../classes/controleAtividadeExtra.php" method="post" onSubmit="return validaFormAll(this,'Confirmar','Confirmar')">
<table width="100%" border="0" cellspacing="1" cellpadding="1">
  ...
  <tr>
    <td align="right" valign="top" class="letra">Atividade Realizada:</td>
    <td><textarea name="atividadeextra" cols="80" rows="5" class="negrito" onkeyup="converteUpper(this);" ><? echo $atividadeextra;?></textarea></td>
  </tr>
 ...
 <!--dados do curso-->
  ...
  <tr>
    <td width="14%" class="branco">Atividade Realizada </td>
 ...
 <table width="100%"  border="0" cellspacing="1" cellpadding="1">
<? 
	$sqlG = "SELECT atividadeextra,DAY(data) as dia,MONTH(data) as mes,YEAR(data) as ano FROM atividadeextra where matricula='$matricula' order by id desc";
	$resultadoG = $conexao->executaQuery($sqlG);
	while($linhaG = mysql_fetch_array($resultadoG)){
		$atividadeextra = $linhaG['atividadeextra'];
		$dia = $linhaG['dia'];
		$mes = $linhaG['mes'];
		$ano = $linhaG['ano'];
?>
  <tr>
    <td width="14%" class="negrito"><? echo $atividadeextra;?></td>
