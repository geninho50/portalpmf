...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<!--inicio adm-->
	<fieldset>
	<legend class="cabecalho">PEDIDO PARA TROCA DE SERVIÇO</legend>
			...
			<tr>
			  <td colspan="2"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
				<tr>
				  ...
				  <td width="86%"><input name="id" type="text" id="id" value="<?php echo $id; ?>" size="5" readonly="readonly" class="negrito" /></td>
				</tr>
			  </table></td>
			</tr>
			<tr>
			...
			<tr>
			  <td colspan="2"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
				<tr>
				  ...
				  <td width="86%"><textarea name="xmotivostatus" cols="80" rows="8" onkeyup="converteUpper(this);" class="negrito"></textarea>
				  </td>
				</tr>
			  </table></td>
			</tr>
