...
<table width="100%" border="0" cellpadding="1" cellspacing="1">
								<tr bgColor="#FFFFFF" onMouseOver="bgColor='#cccccc'" onMouseOut="bgColor='#FFFFFF'">
				 				 <td width="51%"><input name="login" type="text" value="<?php echo $login; ?>" readonly="readonly" class="negrito"/td>
								 <td width="25%" align="center"><input name="hora1" type="text" value="<?php echo $hora1; ?>" size="1" readonly="readonly" class="negrito"/></td>
								 <td width="24%" align="center"><input name="hora2" type="text" value="<?php echo $hora2; ?>" size="1"readonly="readonly" class="negrito"/></td>
							    </tr>
			  </table>
			<?
						}
