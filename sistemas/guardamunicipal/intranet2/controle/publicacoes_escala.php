...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<!--inicio adm-->
	<fieldset>
	<legend class="cabecalho">PUBLICA ESCALAS</legend>
	...
	<table width="67%" border="0" cellspacing="1" cellpadding="1">
	  ...
	  <tr>
		...
		<td width="31%"><input name="xBusca" class="negrito" onkeyup="converteUpper(this);" type="text" size="30" value="<?echo $xBusca;?>"/></td>
	...
	?>
		<tr bgColor="<?PHP if($chave)
			...
			<td width="9%" align="center" class="negrito"><?php if($tamanho_arquivo>0){ ?><A HREF="forcaDownload.php?id=<? echo $id ?>&file=<? echo $path ?>&tipo=<?php echo $tipo; ?>"><IMG SRC="imagens/anexar.png" width="20" height="20" BORDER="0"></A><?php } else { echo "arquivo n�o encontrado"; } ?></td>
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="1">
		<tr>
			<td width="5%" align="right" class="negrito"><IMG SRC="imagens/File - PDF.png" ALT="Dicas" width="19" height="24" BORDER="0"></td>
