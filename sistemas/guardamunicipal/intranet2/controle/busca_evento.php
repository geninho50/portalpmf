<?php
	...
	$query = "SELECT id, nome,hora,solicitante, telefone, rua, bairro, descricao,DAY(data) as dia,MONTH(data) as mes,YEAR(data) as ano FROM evento where UPPER(nome) like UPPER('%$xBusca%') and data='".$data."' order by data asc";
	if( $tamanho > 0 )
	{
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<!-- inicio do adm -->
	<fieldset>
	<legend class="cabecalho">CONSULTAR EVENTOS</legend>
	<form name="form1" method="post" action="busca_evento.php" onSubmit="return validaFormAll(this,'Pesquisar','Pesquisar')">
		...
		<table width="67%" border="0" cellspacing="1" cellpadding="1">
		  ...
		  <tr>
			...
			<td>
			<input type="text" value="<? echo $dataini;?>" readonly name="xdataini" class="stylo1" size="12" onfocus="mudacor(this,'#8BC5F3')" onblur="mudacor(this,'white')"/>
