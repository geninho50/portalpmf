...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <table border="0" cellpadding="1" cellspacing="1">
    <tr>
      ...
      <td width="328"><input name="xchefe" type="text" value="<?php echo $chefe ?>" size="35" class="negrito" /></td>
      </tr>
    <tr>
      <td width="138" align="right" class="letra">Auditado por:</td>
      <td width="328"><input name="auditado" type="text" value="<?php echo $auditado ?>" size="35" class="negrito" /></td>
      </tr>
  </table>
...
?>
  <table width="100%" border="0" cellpadding="1" cellspacing="1">
    <tr>
      <td width="5%"><input name="conf[]" type="checkbox" value="<?php echo $linhaE['login']; ?>" class="negrito" /></td>
      <td width="33%"><input name="login" type="text" value="<?php echo $linhaE['login']; ?>" readonly="readonly" class="negrito" /></td>
      <td width="12%"><input name="hora1" type="text" value="<?php echo $linha['qtdhoras1']; ?>" size="4" readonly="readonly" class="negrito"/></td>
      <td width="12%"><input name="hora2" type="text" value="<?php echo $linha['qtdhoras2']; ?>" size="4"readonly="readonly" class="negrito" /></td>
      <td width="22%"><input name="data" type="text" value="<?php echo $linha['data']; ?>" size="10" readonly="readonly" class="negrito"/></td>
      <td width="11%"><input name="idescala" type="text" value="<?php echo $linha['id']; ?>" size="1" readonly="readonly" class="negrito"/></td>
      <td width="5%" align="center"><input name="he" type="text" value="<?php echo $linha['he']; ?>" size="1" readonly="readonly" class="negrito"/></td>
      </tr>
  </table>
  <?php 
	}
...
?>
          <tr bgColor="#FFFFFF" onMouseOver="bgColor='#cccccc'" onMouseOut="bgColor='#FFFFFF'">
            <td width="31%" align="left" class="negrito"><? echo $login1; ?></td>		
            <td width="18%" class="negrito" align="center"><? echo $hora1; ?></td>
            <td width="17%" class="negrito" align="center"><? echo $total1; ?></td>
            <td width="17%" class="negrito" align="center"><? echo $hora2; ?></td>
            <td width="17%" class="negrito" align="center"><? echo $total2; ?></td>
            </tr>
  <?php
			  }
		}	
