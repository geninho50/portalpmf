...
<table width="540"  border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="150"><a href="cadastro_usuario_escolaridade.php?matricula=<? echo $matricula; ?>"><img src="imagens/escolaridade_1.jpg"  width="150" height="40" border="0" onMouseOver="this.src='imagens/escolaridade_0.jpg'" onMouseOut="this.src='imagens/escolaridade_1.jpg'" /></a></td>
...
<fieldset>
	<legend class="cabecalho">CONTROLE CADASTRO ESCOLARIDADE</legend>

    <table width="100%"  border="0">
      <tr>
	  
        <td width="7%" align="center">&nbsp;</td>
        <td width="14%" align="center"><a href="javascript:POPUP('escolaridade_graduacao.php?matricula=<? echo $matricula; ?>','750','650')"><IMG SRC="imagens/graduacao.png" WIDTH="60" HEIGHT="60" BORDER="0" title="ADICIONAR INFORMAÇÕES DA GRADUAÇÃO"></a></td>
        <td width="14%" align="center"><a href="javascript:POPUP('escolaridade_posgraduacao.php?matricula=<? echo $matricula; ?>','750','650')"><IMG SRC="imagens/posgraduacao.png" WIDTH="60" HEIGHT="60" BORDER="0" title="ADICIONAR INFORMAÇÕES DA PÓS-GRADUAÇÃO"></a></td>
        <td width="14%" align="center"><a href="javascript:POPUP('escolaridade_cursos.php?matricula=<? echo $matricula; ?>','750','650')"><IMG SRC="imagens/cursos.png" WIDTH="60" HEIGHT="60" BORDER="0" title="ADICIONAR INFORMAÇÕES DE CURSOS"></a></td>
