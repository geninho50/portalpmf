			...
			for ($intCont = 0; $intCont < $pNumColunas; $intCont++) {
				...
				if ($i > $linha) {
					...
					if($data_fim < $data_atual){ 
						echo "<td align='center'><font color='#FF0000'><b>".$numinicialbloco."</b></font></td>\n";
					}else{
		...
		<script type="text/javascript">
			  ...
			  $(document).ready(function(){
			   ...
			   $(document).ready(function(){
				 ...
				 $("select[name=yespecie]").change(function(){
			  ...
			  $(document).ready(function(){
				 ...
				 $("select[name=ygrupo]").change(function(){
