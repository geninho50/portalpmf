...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<!--inicio adm-->
	<fieldset>
	<legend class="cabecalho">CONSULTAR MONOGRAFIA</legend>
	...
	?>
		<tr bgColor="<?PHP if($chave)
			...
			<td width="8%" align="center" class="negrito"><?php if($tamanho_arquivo>0){ ?><A HREF="forcaDownload.php?id=<? echo $id ?>&file=<? echo $path ?>&tipo=<?php echo $tipo; ?>"><IMG SRC="imagens/anexar.png" width="20" height="20" BORDER="0"></A><?php } else { echo "arquivo n�o encontrado"; } ?></td>
			...
			<td width="3%" class="negrito" align="center"><A HREF="cadastro_monografia.php?id=<? echo $linha['id']; ?>" border="0"><IMG SRC="imagens/editor_texto.png" WIDTH="20" HEIGHT="20" BORDER="0" ALT="Alterar"></A></td>
		    <td width="3%" class="negrito" align="center">
				<a onClick="Excluir('../classes/controleMonografia.php?id=<? echo $linha['id']; ?>')" href="#"><IMG SRC="imagens/excluir.png" WIDTH="20" HEIGHT="20" BORDER="0" ALT="Excluir"></A>
			</td>
