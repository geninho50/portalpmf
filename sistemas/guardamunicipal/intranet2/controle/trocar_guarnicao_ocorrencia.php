  ...
  <tr>
    ...
    <table bgcolor="#006699"  width="100%" bordercolor="#FFFFFF" border="1" cellspacing="1" cellpadding="1">
	  <tr>
	  	...
	  	<td width="12%" align="center" class="branco"><b>Guarnição</b></td>
	...
	<table width="100%"  border="0" cellpadding="1" cellspacing="1">
	  ...
	  <tr bgColor="<?PHP if($chavee)
		...
		<td width="7%" align="center" class="negrito"><a href="javascript:POPUP('trocar_guarnicao.php?idOcorrencia=<? echo $idOcorrencia;?>&idGuarnicao=<? echo $idGuarnicao;?>','720','250')"><img src="imagens/troca.png" width="20" height="20" title="TROCAR GUARNICAO DA OCORRENCIA" border="0"/></a></td>
