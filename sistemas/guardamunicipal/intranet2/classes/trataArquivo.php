...
{ 
	...
	// Configuracão do Path para envio de arquivos [ imagens ]
	/*
	function getPath($opcao)
	{
		...
		if( $opcao == 1 ) 
		{
			$path = "/home/arautom/public_html/adm/fotos/noticia/";
		}
		else
		if( $opcao == 2 ) 
		{
			$path = "/home/arautom/public_html/adm/fotos/produto/";
		}
		else
		if( $opcao == 3 ) 
		{
			$path = "/home/arautom/public_html/adm/fotos/galeria/";
		}
		else
		if( $opcao == 4 ) 
		{
			$path = "/home/arautom/public_html/adm/fotos/download/";
		}
		else
		if( $opcao == 5 ) 
		{
			$path = "/home/arautom/public_html/adm/fotos/noticiaimagem/";
		}
		else
		if( $opcao == 6 ) 
		{
			$path = "/home/arautom/public_html/adm/fotos/videoimagem/";
		}
		else
		if( $opcao == 7 ) 
		{
			$path = "/home/arautom/public_html/adm/fotos/anuncioimagem/";
		}
		else
		if( $opcao == 8 ) 
		{
			$path = "/home/arautom/public_html/adm/fotos/galeriafotos/";
		}
		else
		if( $opcao == 9 ) 
		{
			$path = "/home/arautom/public_html/adm/fotos/beleza/";
		}
		else
		if( $opcao == 10 ) 
		{
			$path = "/home/arautom/public_html/adm/fotos/esportes/";
		}
		else
		if( $opcao == 11 ) 
		{
			$path = "/home/arautom/public_html/adm/fotos/anunciantes/";
		}
		else
		if( $opcao == 12 ) 
		{
			$path = "/home/arautom/public_html/adm/fotos/anunciantesanuncio/";
		}
		else
		if( $opcao == 13 ) 
		{
			$path = "/home/arautom/public_html/adm/fotos/horoscopo/";
		}
		else
		if( $opcao == 14 ) 
		{
			$path = "/home/arautom/public_html/adm/fotos/comentaristas/";
		}
		else
		if( $opcao == 15 ) 
		{
			$path = "/home/arautom/public_html/adm/fotos/comentario/";
		}
		else
		if( $opcao == 16 ) 
		{
			$path = "/home/arautom/public_html/adm/fotos/eventogratis/";
		}
		else
		if( $opcao == 17 ) 
		{
			$path = "/home/arautom/public_html/adm/fotos/resumodenovelas/";
		}
		else
		if( $opcao == 18 ) 
		{
			$path = "/home/arautom/public_html/adm/fotos/videopatrocinador/";
		}
		return $path;
	}
	...
	*/
	...
	{
		$path = "";
		//$principal = "C:/Apache/htdocs/intranet2";
		$principal = "/home/www/sistemas/guardamunicipal/intranet2";
		if( $opcao == 1 ) 
		{
		...
		if( $opcao == 6 ) 
		{
			$path = $principal."/controle/fotos/digital/";
		}
		else
		if( $opcao == 7 ) 
		{
		...
		if( $opcao == 10 ) 
		{
			$path = $principal."/controle/fotos/escola/";
   		}
		else
		if( $opcao == 11 ) 
		{
		...
		if( $opcao == 13 ) 
		{
			$path = $principal."/controle/fotos/horoscopo/";
		}
		else
		if( $opcao == 14 ) 
		{
