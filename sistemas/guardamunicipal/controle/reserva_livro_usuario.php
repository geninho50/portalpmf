...
header("Expires: Mon, 26 Jul 1997 05:00:00 GMT"); // Date in the past
	...
	$codLivro = $_POST['codigolivro'];
	if( $idLivro == 0 )
    {
       $idLivro = (int)$_GET['idLivro'];
	   $codLivro = $_GET['codigolivro'];
    }
...
<form name="form1" method="post" action="../classes/controleReservaLivroUsuario.php" onSubmit="return validaFormAll(this,'Confirmar','Confirmar')">

<table width="80%" border="0" cellspacing="1" cellpadding="1">
 <tr>
    <td width="19%" align="right" class="letra">Guarda:<FONT COLOR="#FF0033">*</FONT></td>
...
<fieldset>
	<legend class="negrito">Reservas deste Exemplar </legend>
    <table bgcolor="#006699"  width="100%" bordercolor="#FFFFFF" border="1" cellspacing="1" cellpadding="1">
  <tr>
    <td width="53%" align="left" class="branco"><B>Titulo:</B></td>
	<td width="27%" align="center" class="branco"><B>Data da Reserva:</B></td>
  </tr>
</table>
<table  width="100%" bordercolor="#FFFFFF" border="1" cellspacing="1" cellpadding="1">
<?php 
$chavee = true;
	$queryE = "SELECT id, DAY(datareserva) as dia,MONTH(datareserva) as mes,YEAR(datareserva) as ano,guardareserva,titulo,datareserva FROM reserva where codigolivro='$codLivro' and datareserva >= '$data_atual' order by datareserva desc";
...
?>
  <tr bgColor="<?PHP if($chavee)
						...
						$chavee=!$chavee;
					?>">
    <td width="53%" align="left" class="negrito"><? echo $titulo; ?></td>
	 <td width="27%" align="center" class="negrito"><? echo $dia.' / '.$mes.' / '.$ano; ?></td>
  </tr>
    <?php
	}
?>
