...
<table width="100%"  border="0" cellspacing="1" cellpadding="1">
        <tr>
         <td align="right"><span class="letra">N&ordm;:</span></td>
		  <td align="left"><input name="idTransporte" type="text" id="idTransporte2" value="<?php echo $idTransporte; ?>" size="3" readonly="readonly" /></td>
        </tr>
        <tr>
          <td align="right"><span class="letra">Status:</span></td>
		  <td align="left"><input name="status" type="text" id="status3" value="<?php echo $status; ?>" size="3" readonly="readonly" />
            <?php echo $tempstatus; ?></td>
        </tr>
        <tr>
          <td align="right"><span class="letra">Hora: </span></td>
		  <td><input name="xhora" type="text" id="xhora3" onKeyPress="valida_horas(this)" size="12" maxlength="8"></td>
        </tr>
        <tr>
          <td align="right" valign="top">Informacoes adicionais: </td>
		  <td align="left"><textarea name="xinformacao" id="xinformacao" cols="50" rows="5" onkeyup="converteUpper(this);"></textarea></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
