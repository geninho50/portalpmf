...
{
	document.ReturnValue=confirm('Deseja confirmar a Exclusão?');
...
function J4(link)
{
	document.ReturnValue=confirm('Deseja colocar a Guarnição em J4?');
	if (document.ReturnValue)
	{
		location = ''+link;
	}
...
function J5(link)
{
	document.ReturnValue=confirm('Deseja colocar a Guarnição em J5?');
	if (document.ReturnValue)
	{
		location = ''+link;
	}
...
function J6(link)
{
	document.ReturnValue=confirm('Deseja colocar a Guarnição em J6?');
	if (document.ReturnValue)
	{
		location = ''+link;
	}
...
function J8(link)
{
	document.ReturnValue=confirm('Deseja colocar a Guarnição em J8?');
	if (document.ReturnValue)
	{
		location = ''+link;
	}
...
{
	document.ReturnValue=confirm('Deseja deixar a Guarnição INDISPONIVEL?');
	if (document.ReturnValue)
	{
		location = ''+link;
	}
...
{
	document.ReturnValue=confirm('Ao Excluir a Galeria as suas fotos também serão excluídas. Deseja confirmar a Exclusão da Galeria ?');
	if (document.ReturnValue)
	{
...
{
	document.ReturnValue=confirm('Os produtos cadastrados para a SubCategoria que deseja excluir também serão deletados da base de dados. Deseja confirmar a Exclusão da SubCategoria e de seus produtos ?');
	if (document.ReturnValue)
	{
		location = ''+linkCategoria;
	}
...
{
	var vetor = new Array('solteiro(a)','casado(a)','viuvo(a)','separado(a)','união estável');
...
{
	var vetor = new Array('manhã','tarde');
