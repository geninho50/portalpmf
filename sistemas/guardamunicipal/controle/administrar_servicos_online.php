<?php
	...
	if( $login=='JONAS' || $login=='CLAUDIA' || $login=='ALEX' || $login=='CARLA' || $login=='JOSUE'){
	...
	if( $login=='LARISSA' || $login=='EDUARDO'){
		//$queryD = "SELECT id, DAY(datatroca) as dia,MONTH(datatroca) as mes,YEAR(datatroca) as ano,gmsolicitante,gmsolicitado,formareposicao,motivotroca,status,data,turno FROM trocaservico where status=0 and turno in('Matutino','Central') order by id desc";
		//$resultD = $obj->executaQuery($queryD);
		$query = "SELECT id,DAY(data) as diaD,MONTH(data) as mesD,YEAR(data) as anoD, DAY(datainicio) as diainicio,MONTH(datainicio) as mesinicio,YEAR(datainicio) as anoinicio,DAY(datafim) as diafim,MONTH(datafim) as mesfim,YEAR(datafim) as anofim,idfolga,gmsolicitante,datainicio,datafim, motivofolga, motivostatus, status FROM pedidofolga where status=0 and turno in('Matutino','Central') order by id desc";
		$result = $obj->executaQuery($query);
		$queryE = "SELECT id, DAY(datadoacao) as dia,MONTH(datadoacao) as mes,YEAR(datadoacao) as ano,gmsolicitante,status,data,datadoacao,turno FROM doacaosangue where status=0 and turno in('Matutino','Central') order by id desc";
		$resultE = $obj->executaQuery($queryE);
	}
	
	if( $login=='REGINATO' || $login=='NASCIMENTO'){
		//$queryD = "SELECT id, DAY(datatroca) as dia,MONTH(datatroca) as mes,YEAR(datatroca) as ano,gmsolicitante,gmsolicitado,formareposicao,motivotroca,status,data,turno FROM trocaservico where status=0 and turno in('Sentinela','Logistica','Obras') order by id desc";
		//$resultD = $obj->executaQuery($queryD);
		$query = "SELECT id,DAY(data) as diaD,MONTH(data) as mesD,YEAR(data) as anoD, DAY(datainicio) as diainicio,MONTH(datainicio) as mesinicio,YEAR(datainicio) as anoinicio,DAY(datafim) as diafim,MONTH(datafim) as mesfim,YEAR(datafim) as anofim,idfolga,gmsolicitante,datainicio,datafim, motivofolga, motivostatus, status FROM pedidofolga where status=0 and turno in('Sentinela','Logistica','Obras','Canil') order by id desc";
		$result = $obj->executaQuery($query);
		$queryE = "SELECT id, DAY(datadoacao) as dia,MONTH(datadoacao) as mes,YEAR(datadoacao) as ano,gmsolicitante,status,data,datadoacao,turno FROM doacaosangue where status=0 and turno in('Sentinela','Logistica','Obras','Canil') order by id desc";
		$resultE = $obj->executaQuery($queryE);
	}
	...
	if( $login=='RAFAEL'){
		//$queryD = "SELECT id, DAY(datatroca) as dia,MONTH(datatroca) as mes,YEAR(datatroca) as ano,gmsolicitante,gmsolicitado,formareposicao,motivotroca,status,data,turno FROM trocaservico where status=0 and turno in('Matutino') order by id desc";
		//$resultD = $obj->executaQuery($queryD);
		$query = "SELECT id,DAY(data) as diaD,MONTH(data) as mesD,YEAR(data) as anoD, DAY(datainicio) as diainicio,MONTH(datainicio) as mesinicio,YEAR(datainicio) as anoinicio,DAY(datafim) as diafim,MONTH(datafim) as mesfim,YEAR(datafim) as anofim,idfolga,gmsolicitante,datainicio,datafim, motivofolga, motivostatus, status FROM pedidofolga where status=0 and turno in('Matutino') order by id desc";
		$result = $obj->executaQuery($query);
		$queryE = "SELECT id, DAY(datadoacao) as dia,MONTH(datadoacao) as mes,YEAR(datadoacao) as ano,gmsolicitante,status,data,datadoacao,turno FROM doacaosangue where status=0 and turno in('Matutino') order by id desc";
		$resultE = $obj->executaQuery($queryE);
	}
	
	if( $login=='FRANCO' || $login=='PEREIRA'){
		...
		//$resultD = $obj->executaQuery($queryD);
		$query = "SELECT id,DAY(data) as diaD,MONTH(data) as mesD,YEAR(data) as anoD, DAY(datainicio) as diainicio,MONTH(datainicio) as mesinicio,YEAR(datainicio) as anoinicio,DAY(datafim) as diafim,MONTH(datafim) as mesfim,YEAR(datafim) as anofim,idfolga,gmsolicitante,datainicio,datafim, motivofolga, motivostatus, status FROM pedidofolga where status=0 and turno in('15x33','Vespertino','Canil') order by id desc";
		$result = $obj->executaQuery($query);
		$queryE = "SELECT id, DAY(datadoacao) as dia,MONTH(datadoacao) as mes,YEAR(datadoacao) as ano,gmsolicitante,status,data,datadoacao,turno FROM doacaosangue where status=0 and turno in('15x33','Vespertino','Canil') order by id desc";
		$resultE = $obj->executaQuery($queryE);
	}
	...
	if( $login=='FERNANDES'){
		...
		//$resultD = $obj->executaQuery($queryD);
		$query = "SELECT id,DAY(data) as diaD,MONTH(data) as mesD,YEAR(data) as anoD, DAY(datainicio) as diainicio,MONTH(datainicio) as mesinicio,YEAR(datainicio) as anoinicio,DAY(datafim) as diafim,MONTH(datafim) as mesfim,YEAR(datafim) as anofim,idfolga,gmsolicitante,datainicio,datafim, motivofolga, motivostatus, status FROM pedidofolga where status=0 and turno in('Vespertino','Romu') order by id desc";
		$result = $obj->executaQuery($query);
		$queryE = "SELECT id, DAY(datadoacao) as dia,MONTH(datadoacao) as mes,YEAR(datadoacao) as ano,gmsolicitante,status,data,datadoacao,turno FROM doacaosangue where status=0 and turno in('Vespertino','Romu') order by id desc";
		$resultE = $obj->executaQuery($queryE);
	}
