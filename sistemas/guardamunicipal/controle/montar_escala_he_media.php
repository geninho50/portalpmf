			...
			?>
				<table width="100%" border="0" cellpadding="1" cellspacing="1">
					<tr bgColor="#FFFFFF" onMouseOver="bgColor='#cccccc'" onMouseOut="bgColor='#FFFFFF'">
					 ...
					 <td width="12%"><input name="login" type="text" value="<?php echo $login; ?>" readonly="readonly" />
                     <? 
					 	$queryU = "SELECT antiguidade from usuario where login='".$login."'";
						$resultU = $obj->executaQuery($queryU);
						$linhaU = mysql_fetch_array($resultU);
						if($linhaU){
							echo $antiguidade = $linhaU['antiguidade'];	
						}
					 ?>
