...
<table width="100%"  border="0" cellspacing="1" cellpadding="1">
        ...
        <tr>
          <td colspan="2"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="14%" align="right" valign="top" class="letra">Motivo(s) do Cancelamento: </td>
              <td width="86%"><textarea name="xcancelamento" cols="80" rows="8" onkeyup="converteUpper(this);"></textarea>
			  </td>
            </tr>
          </table></td>
        </tr>
