...
.style1 {color: #FFFFFF}
.style5 {font-style: italic; color: #FF0000;}
-->
</style>
        ...
        <td height="200" align="center">
          <form name="form" method="post" action="../classes/processaLogin.php" onSubmit="return validaFormAll(this,'Continuar','Entrar')">
            <table width="100%"  border="0" cellspacing="1" cellpadding="1">
              ...
              <tr>
                <td colspan="2" align="center"><input name="xlogin" type="text" id="login" size="16" class="one" onkeyup="converteUpper(this);"/></td>
              </tr>
              <tr>
              ...
              <tr align="center">
			    ...
			    ?>
				 <span><font face="tahoma" color="ffffff"><CENTER><H3><?echo $mensagem?></H3></CENTER>
				 </font></span>
				</td>
              </tr>
              <tr align="center">
