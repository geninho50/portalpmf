...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
  <tr>
    <td width="5%" align="right" class="letra">GM:<FONT COLOR="#FF0033">*</FONT></td>
    <td width="12%" align="left"><select name="yagente">
      <option value="0">Selecionar...</option>
      <?php 
				$queryS = "SELECT nome,turno,colocacao,dias,DAY(datalimite) as dia,MONTH(datalimite) as mes,YEAR(datalimite) as ano FROM agente_zonaazul where dias != 0  and '$data_atual'<=datalimite order by datalimite asc";
				echo''.$queryS;
	...
	<td width="5%" align="right" class="letra">Data:<FONT COLOR="#FF0033">*</FONT></td>
    ...
    <td width="22%" align="left"><input name="Submit" type="submit" class="botao" id="Confirmar" onClick="onClickButton(null,'Aguarde...','','Confirmar')" value="Confirmar" /></td>
    </tr>
