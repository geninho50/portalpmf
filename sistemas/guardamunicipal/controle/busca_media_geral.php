...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td valign="top" class="negrito"><a href="busca_media_geral_3.php">Listar 1</a><a href="busca_media_geral_2.php">Listar 2</a></td>
    <td valign="top">&nbsp;</td>
  </tr>
  <tr>
    <td valign="top">&nbsp;</td>
...
<?php
		...
		{	
			...
			$sqlhora1 = "SELECT login, (select sum(hora1) FROM listaescala WHERE data BETWEEN '".$ano_atual."-01-01' AND '".$ano_atual."-".$mes_atual."-".$dia_atual."' and login=g.login) as horat1 from guarda_gmf g ORDER BY horat1 ASC";
...
<table width="100%" border="1" cellpadding="1" cellspacing="1" bordercolor="#CCCCCC">
<?php
		$sqlhora2 = "SELECT login, (select sum(hora2) FROM listaescala WHERE data BETWEEN '".$ano_atual."-01-01' AND '".$ano_atual."-".$mes_atual."-".$dia_atual."' and login=g.login) as horat2 from guarda_gmf g ORDER BY horat2 ASC";
