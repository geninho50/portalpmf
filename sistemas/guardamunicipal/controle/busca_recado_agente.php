...
include("incValidaSessao.php");
	...
	$ultimosrecado = (int)$_GET['ultimosrecado'];
	if( $ultimosrecado > 0 )
	{
		// Pegou o Id
	}
	...
	if( $ultimosrecado > 0 )
		$query = "SELECT * FROM recado_agente order by data desc LIMIT 0, 30";
	else
		$query = "SELECT * FROM recado_agente where UPPER(nome) like UPPER('%$xBusca%')";
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<!--inicio adm-->
	<fieldset>
	<legend class="negrito">Consulta Recado Agente</legend>
	<form name="form1" method="post" action="busca_recado_agente.php" onSubmit="return validaFormAll(this,'Pesquisar','Pesquisar')">
	...
	<table width="67%" border="0" cellspacing="1" cellpadding="1">
	  ...
	  <tr>
		<td width="40%" align="right" class="letra">Digite o <B>Nome</B> do Recado:</td>
	  ...
	  <tr>
		...
		<td width="31%" class="negrito"><font class="negrito"><A HREF="busca_recado_agente.php?ultimosrecado=1">Ver as �ltimos 30 recados</A></font></td>
		  <td width="29%">&nbsp;</td>
	  </tr>
	...
	?>
		<tr bgColor="<?PHP if($chavet)
			...
			<td width="60%" align="left" class="negrito"><font class="negrito"><A HREF="cadastro_recado_agente.php?idRecado=<? echo $linha['id']; ?>" border="0"><? echo $nome; ?></A></font></td>
			<td width="10%" class="negrito" align="center"><A HREF="cadastro_recado_agente.php?idRecado=<? echo $linha['id']; ?>" border="0"><IMG SRC="images/editar.gif" WIDTH="16" HEIGHT="16" BORDER="0" ALT="Alterar"></A></td>
			<td width="10%" class="negrito" align="center"><a onClick="Excluir('../classes/controleRecadoAgente.php?idRecado=<? echo $linha['id']; ?>')" href="#">	   
