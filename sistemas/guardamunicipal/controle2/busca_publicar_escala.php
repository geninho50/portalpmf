...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td>
	<!-- inicio do adm -->
	<form name="form1" method="post" class="letra" action="busca_extras_banco.php" onSubmit="return validaFormAll(this,'Pesquisar','Pesquisar')">
...
<table width="67%" border="0" cellspacing="1" cellpadding="1">
  ...
  <tr>
    ...
    <td width="31%"><input name="xBusca" type="text" size="30" value="<?echo $xBusca;?>"/></td>
      <td width="29%"><input name="Submit" type="submit" id="Pesquisar" class="botao" value="Pesquisar" onClick="onClickButton(null,'Aguarde...','','Pesquisar')" /></td>
  </tr>

  <tr>
    <td width="40%" align="right" class="letra">&nbsp;</td>
    <td width="31%" class="letra"><A HREF="busca_publicar_escala.php?ultimastrinta=1">Ver os materiais mais recentes</A></td>
      <td width="29%">&nbsp;</td>
  </tr>
...
?>
	<tr bgColor="<?PHP if($chave)
		...
		<td width="14%" align="center" class="negrito"><FONT SIZE="1"><FONT COLOR="#FF6666"><?php echo $tamanho_k; ?></FONT> (<?php echo $tamanho_arquivo; ?> bytes)</FONT></td>
		 ...
		 <td width="3%" class="negrito" align="center"><A HREF="cadastro_publicar_escala.php?id=<? echo $linha['id']; ?>" border="0"><IMG SRC="images/editar.gif" WIDTH="20" HEIGHT="20" BORDER="0" title="Alterar"></A></td>

	   <td width="3%" class="negrito" align="center">
	   <a onClick="Excluir('../classes/controleExtrasBanco.php?id=<? echo $linha['id']; ?>')" href="#">	   
	   <IMG SRC="images/lixeira.jpg" WIDTH="16" HEIGHT="16" BORDER="0" title="Excluir"></A></td>
