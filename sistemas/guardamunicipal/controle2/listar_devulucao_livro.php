...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<!--inicio adm-->
<fieldset>
	<legend class="negrito">Lista de Devolu&ccedil;&atilde;o de Livros </legend>
  ...
  <tr>
	...
	<td width="12%" align="center" class="branco"><B>Data do Emprestimo:</B></td>
...
<?php 
$chavee = true;
	$queryE = "SELECT id, DAY(datapagamento) as dia,MONTH(datapagamento) as mes,YEAR(datapagamento) as ano,guardareserva,titulo,datapagamento,codigolivro FROM pagamentolivro where status=0 order by datapagamento desc";
	...
	while( $linhaE = mysql_fetch_array($resultE) )
	{
		...
		$datapagamento = $linhaE['datapagamento'];
		$dia = $linhaE['dia'];
		$mes = $linhaE['mes'];
		$ano = $linhaE['ano'];
?>
  <tr bgColor="<?PHP if($chavee)
    ...
    <td width="63%" align="left" class="negrito"><? echo $titulo; ?></td>
	 ...
	 <td width="2%" align="center" class="negrito"><a href="../classes/controlePagamentoLivro.php?idReserva=<? echo $idreserva;?>"><img src="images/para_baixo.jpg" width="13" height="13" border="0" ALT="Recebimento de Livro"></a></td>
  </tr>
    <?php
	}
?>
