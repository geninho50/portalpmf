...
<form name="form1" method="post" action="busca_monografia_adm.php" onSubmit="return validaFormAll(this,'Pesquisar','Pesquisar')">
...
<table width="67%" border="0" cellspacing="1" cellpadding="1">
  ...
  <tr>
    ...
    <td width="31%"><input name="xBusca" type="text" size="30" value="<?echo $xBusca;?>"/></td>
      <td width="29%"><input name="Submit" class="botao" type="submit" id="Pesquisar" value="Pesquisar" onClick="onClickButton(null,'Aguarde...','','Pesquisar')" /></td>
  </tr>

  <tr>
    <td width="40%" align="right" class="letra">&nbsp;</td>
    <td width="31%" class="negrito"><A HREF="busca_monografia_adm.php?ultimastrinta=1">Ver os materiais mais recentes</A></td>
      <td width="29%">&nbsp;</td>
  </tr>
...
?>
<fieldset>
	<legend class="nerito">Resultado(s) <B><?echo $nvaloresencontrados;?></B> para <?echo $xBusca;?></legend>
    ...
    <table  width="100%" border="1" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#0086a8">
      <tr>
        ...
        <td width="36%" align="left" class="branco"><b>Titulo do Trabalho</b></td>
