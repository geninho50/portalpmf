	...
	<td>
			...
			<tr>
				<td width=25% align=left valign=top bgcolor="#006699" bordercolor="#FFFFFF" class="branco"><b>Matutino</b></td>
					...
					<tr>
								<td width=75% align=left class=negrito><a href="../classes/controleNomeHoraExtra.php?id=<? echo $idt;?>&guarda=<? echo $login; ?>"><font color="#000000" size="1"><?php echo $nome; ?></font></a></td>
					</tr>
