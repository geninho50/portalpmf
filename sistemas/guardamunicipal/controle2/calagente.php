...
<tr>
  <td width="23"  align="center"><a href="javascript:mudarAgendaInt(3,1,<?php echo $mesant; ?>,<?php echo $anoant; ?>);"><img src="images/seta_esq.jpg" width="23" height="25" border="0"></a></td>
  <td width="1198" align="center" bgcolor="#E9E9E9" class="style7"><?php echo "".mesesInt($mes)." | <FONT COLOR=\"#7A3635\">".$ano."</FONT>"; ?></td>
  <td width="24" align="center"><a href="javascript:mudarAgendaInt(3,1,<?php echo $mesprox; ?>,<?php echo $anoprox; ?>);"><img src="images/seta_dir.jpg" width="24" height="25" border="0"></a></td>
</tr>
<tr align="center">
  <td colspan="3">
