...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr align="center" bgcolor="#666666">
    <th colspan="2" bgcolor="#666666" scope="col">
	<?php 
  ...
  <tr>
	...
	<!-- inicio do adm -->
	<fieldset>
	<legend class="negrito">Confirmar Escala de Hora Extra - <? echo $local;?></legend>
...
<table width="50%" border="0" cellpadding="1" cellspacing="1">
		...
		<tr bgColor="#FFFFFF" onMouseOver="bgColor='#cccccc'" onMouseOut="bgColor='#FFFFFF'">
			...
			<td width="16%" align="center"><?php echo $hora1; ?></td> 
			<td width="16%" align="center"><?php echo $hora2; ?></td> 
			<td width="22%" align="center"><?php echo $adicional; ?></td> 
            <td width="4%" align="center" class="branco"><a href="javascript:POPUP('alterar_horas_cadidatos.php?idescala=<?php echo $idescala; ?>&login=<? echo $login;?>','500','150')"><img src="images/editar.gif" width="16" height="16" border="0" title="ALTERAR HORA"></a>
            </td>
            <td width="4%" align="center" class="branco"><a href="../classes/controleExcluirCandidato.php?id=<?PHP echo $id; ?>&idescala=<?PHP echo $idescala; ?>"><img src="images/lixeira.jpg" width="16" height="16" border="0" title="EXCLUIR DA LISTA"></a></td>
        </tr>
</table>
<?php 
  endwhile
