...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<!-- inicio do adm -->
	<fieldset>
	<legend class="negrito">Desmonstrativo da soma de hora extra</legend>
		...
		<legend class="negrito"><? echo $localT.' - '.$semanaT.' - '.$diaT." / ".$mesT." / ".$anoT.' - '.$horainicial.' as '.$horafinal; ?></legend>
			...
			<table width="100%" border="1" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#0086a8"  >
              <tr>
                ...
                <td width="12%" align="left" class="branco"><b>Guardas</b></td>
                <td width="6%" align="center" class="branco"><b>HE 100%</b></td>
                <td width="6%" align="center" class="branco"><b>HE 200%</b></td>
                ...
                <td width="25%" align="left" class="branco"><b>Data</b></td>
			...
			<?
				...
				while($linha = mysql_fetch_array($result)){
					...
					$queryS = "SELECT (select count(id) from listaescala where login='".$login."' and MONTH(data)=$mes_atual AND YEAR(data)=$ano_atual and idescala>0 and he=1) as total1, (select count(id) from listaescala where login='".$login."' and MONTH(data)=$mes_atual AND YEAR(data)=$ano_atual and idescala>0 and he=2) as total2";
			...
			?>
				<table width="100%" border="0" cellpadding="1" cellspacing="1">
					<tr>
					 ...
					 <td width="12%"><input name="login" type="text" value="<?php echo $login; ?>" readonly="readonly" /></td>
					 <td width="6%"><input name="hora1" type="text" value="<?php echo $hora1; ?>" size="1" readonly="readonly"/></td>
					 <td width="6%"><input name="hora2" type="text" value="<?php echo $hora2; ?>" size="1"readonly="readonly" /></td>
					 <td width="7%" align="center"><input name="somah1" type="text" value="<?php echo $somah1; ?>" size="1" readonly="readonly"/></td>
                      <td width="7%" align="center"><?php echo $total1; ?></td>
					 <td width="7%" align="center"><input name="somah2" type="text" value="<?php echo $somah2; ?>" size="1"readonly="readonly" /></td>
					 <td width="7%" align="center"><?php echo $total2; ?></td>
					 <td width="25%"><input name="data" type="text" value="<?php echo $data; ?>" size="10" readonly="readonly"/></td>
					 <td width="12%"><input name="idescala" type="text" value="<?php echo $idescala; ?>" size="1" readonly="readonly"/></td>
					 <td width="8%"><input name="he" type="text" value="<?php echo $he; ?>" size="1" readonly="readonly"/></td>
			 		</tr>
			  </table>
			<?
					}
