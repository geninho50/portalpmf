<?php
	...
	if($xMes == 13 & $xAno != 13){
		...
		$queryH = "SELECT sum(hora1) as temphora1 FROM listaescala where UPPER(login) like UPPER('%$xBusca%') and YEAR(data)=$xAno";
		$queryH2 = "SELECT sum(hora2) as temphora2 FROM listaescala where UPPER(login) like UPPER('%$xBusca%') and YEAR(data)=$xAno";
	}else{
		if($xAno == 13 & $xMes != 13){
			...
			$queryH = "SELECT sum(hora1) as temphora1 FROM listaescala where UPPER(login) like UPPER('%$xBusca%') and MONTH(data)=$xMes";
			$queryH2 = "SELECT sum(hora2) as temphora2 FROM listaescala where UPPER(login) like UPPER('%$xBusca%') and MONTH(data)=$xMes";
		}else{
			if($xMes == 13 & $xAno == 13){
				...
				$queryH = "SELECT sum(hora1) as temphora1 FROM listaescala where UPPER(login) like UPPER('%$xBusca%')";
				$queryH2 = "SELECT sum(hora2) as temphora2 FROM listaescala where UPPER(login) like UPPER('%$xBusca%')";
			}else{
				...
				$queryH = "SELECT sum(hora1) as temphora1 FROM listaescala where UPPER(login) like UPPER('%$xBusca%') and MONTH(data)=$xMes and YEAR(data)=$xAno";
				$queryH2 = "SELECT sum(hora2) as temphora2 FROM listaescala where UPPER(login) like UPPER('%$xBusca%') and MONTH(data)=$xMes and YEAR(data)=$xAno";
			}
		}
	}
