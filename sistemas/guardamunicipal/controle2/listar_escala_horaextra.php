  ...
  <tr>
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="1">
		...
		<tr bgColor="<?PHP if($chaveF)
							...
							$chaveF=!$chaveF;
						?>">
			<td width="53%" align="left" class="negrito"><? echo $linhaF['local'].' - '.$semana; ?></td>		
	...
	<?php
		$chave = true;
		$queryJ = "SELECT id,semana,local, DAY(data) as dia,MONTH(data) as mes,YEAR(data) as ano,horainicial,horafinal FROM escalahoraextra where id in (SELECT idescala FROM candidatos) and status='S' order by data asc ";
	...
	<?php
		$chavet = true;
		$query = "SELECT id,semana, DAY(data) as dia,MONTH(data) as mes,YEAR(data) as ano,horainicial,horafinal,local,tempo,qtdguardas,qtdhoras1,qtdhoras2,missao,lanche FROM escalahoraextra where status='S' order by data asc";
