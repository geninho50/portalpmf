...
<form name="form1" method="post" action="busca_livros_usuario.php" onSubmit="return validaFormAll(this,'Pesquisar','Pesquisar')">
...
<table width="67%" border="0" cellspacing="1" cellpadding="1">
  ...
  <tr>
    ...
    <td width="31%" class="negrito"><A HREF="busca_livros_usuario.php?ultimoslivros=1"><font color="#000000" size="2">Listar Todos</font></A></td>
      <td width="29%">&nbsp;</td>
  </tr>
</table>
...
?>
	<tr bgColor="<?PHP if($chavet)
		...
		<a href="javascript:POPUP('reserva_livro_usuario.php?idLivro=<? echo $linha['id']; ?>&codigolivro=<? echo $codigo;?>','700','350')"><IMG SRC="images/calendario.gif" WIDTH="16" HEIGHT="16" BORDER="0" title="Reserva Livro"></a>
