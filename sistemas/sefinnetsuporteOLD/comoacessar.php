...
<link rel="canonical" href="http://www.pmf.sc.gov.br/sistemas/sefinnetsuporte/comoacessar.php"/>
...
<meta property="og:url" content="http://www.pmf.sc.gov.br/sistemas/sefinnetsuporte/comoacessar.php"/>
...
<div id="conteudo_pagina" class="column6-lg" align="justify"  style="margin:auto">
  ...
  <br>
  Filtros:
  <input type="button" class="btn btn-primary botao" value="Profissionais Autônomos" onclick="changeStatus(0)">
  <input type="button" class="btn btn-primary botao" value="Pessoas Jurídicas" onclick="changeStatus(1)">
   <input type="button" class="btn btn-primary botao" value="Certificação Digital" onclick="changeStatus(2)">
  <br>
