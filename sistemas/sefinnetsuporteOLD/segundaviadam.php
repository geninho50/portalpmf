...
<script>
  ...
  <link rel="canonical" href="http://www.pmf.sc.gov.br/sistemas/sefinnetsuporte/segundaviadam.php"/>
  ...
  <meta property="og:url" content="http://www.pmf.sc.gov.br/sistemas/sefinnetsuporte/segundaviadam.php"/>
...
<body onload="carregaPopup()">
  ...
  <div id="conteudo_pagina" class="column6-lg"  style="margin:auto">
    ...
    <h2 align="center">Segunda Via Dam</h2>
    ...
    <video width="600"  height="360"controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747; margin-left: 20%">
      <source src="imagens/Segunda Via DAM.mp4" type="video/mp4">
        Seu navegador não suporta HTML5.
      </video>
         <p><b>*Observação: O precedimento não deve ser realizado para o DAM gerado para a Autorização de Emissão de Documento Fiscal Eletrônico(AEDF-e).</b></p>

      <h3>Segue abaixo passo a passo como emitir a Segunda Via DAM:</h3>

      <li>Acesse a pagina relativa à Segunda Via DAM no site da prefeitura: <a href="http://www.pmf.sc.gov.br/servicos/sistema.php?servicoid=3688" style="color:blue">http://www.pmf.sc.gov.br/servicos/sistema.php?servicoid=3688</a></li>
      <li>Na opção "Número de DAM" coloque os primeiros oito números da DAM.</li>
      <li>Na opção "Parcela" coloque os próximos dois números da DAM.</li>
       <li>Caso o DAM estaja vencido, selecione a opção "Imprimir com acréscimos já calculados" e escolha a nova data de vencimento.</li>

      <img src="imagens/dam1.png" width="100%"alt="">

      <hr style=" border-top: 1px solid black;">

      <li>Por fim selecione a opção "Imprimir Selecionados".</li>


      <img src="imagens/dam2.png" width="100%" alt="">
