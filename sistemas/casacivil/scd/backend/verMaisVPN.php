  	...
  	<body>
  		...
  		<div class="container">
  			<div class="tabela tabelaVPN text-capitalize">
  				...
  				<div class="linha">
  					<div class="form-group">
  						<strong>Nome:</strong> <?php echo utf8_encode($data['nome']);?>
  					</div>
  				</div>
	  			<div class="linha">
					<div class="form-group">
  						<strong>Instituição:</strong> <?php echo utf8_encode($data['nomeInstituicao']);?> 
  					</div>
				</div>
				<div class="linha">
	  				<div class="form-group">
	  					<strong>Entidade / Orgao:</strong> <?php echo utf8_encode($data['entidade']);?>  
	  				</div>
				</div>
				<div class="linha">
	  				<div class="form-group">
	  					<strong>CNPJ:</strong> <?php echo $data['cnpj'];?>  
	  				</div>
				</div>
				<div class="linha">
	  				<div class="form-group">
	  					<strong>Telefone:</strong> <?php echo $data['telefone'];?>  
	  				</div>
				</div>
				<div class="linha">
  					<div class="form-group">
  						<strong>CPF:</strong> <?php echo $data['cpf']?>  
  					</div>
				</div>
				<div class="linha">
  					<div class="form-group">
  						<strong>UF:</strong> <?php  echo estado($data['uf']);?>  
  					</div>
				</div>

				<div class="linha">
	  				<div class="form-group">
	  					<strong>Matricula:</strong> <?php echo $data['matricula'];?>
	  				</div>
				</div>
				<div class="linha">
	  				<div class="form-group">
				...
				<div class="linha">
  				...
  				<div class="linha">
  					<div class="form-group">
  						<strong>Outros dados:</strong> <?php  echo utf8_encode($data['outrosDados']); ?>
  					</div>
  				</div>
  				<div class="linha">
  					<div class="form-group">
  						<strong>Motivo:</strong> <?php  echo utf8_encode($data['motivo']); ?>
  					</div>
  				</div>
	  			<div class="linha">
  					<div class="form-group">
				...
				<div class="linha">
  					<div class="form-group">
  						<strong>Observação:</strong> <?php  echo $data['observacao']; ?>
  					</div>
  				</div>
				<?php } ?>
			...
			$('#error').addClass('hide');
				...
				$.post( "alteracaoStatusVPN.php", obj).done(function( data ) {	
