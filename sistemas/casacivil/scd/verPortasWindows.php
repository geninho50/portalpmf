...
$id = $_GET['id'];
if($id != null){
  $sql = $db->prepare("SELECT * FROM portaswindows where id = $id");
  $sql->execute();
...
<body>
  ...
  <div  class="loginAdm masthead">
    <div class="boxDecisao">
      <a href="servidoresWindows.php" class="btn btn-primary portas">Voltar</a>
    </div>
  </div>
  ...
  <div class="tabelaPortas">
    <table class="table table-striped">
      ...
      <?php 
        include "backend/SelectPortasWindows.php";
        echo $tabela;
      ?>
  </table>
...
<script type="text/javascript">
  ...
  function excluir(id){
    ...
    if(confirmacao){
      ...
      $.post( "backend/deletePortasWindows.php", obj).done(function( data ) { 
  ...
  $('#submit').bind('click',function(){
    ...
    $.post( "backend/formPortasWindowsReq.php", obj).done(function( data ) {  
      var retorno = jQuery.parseJSON(data);
      if(retorno.success == 1){
        location.href = '';
      }else{
