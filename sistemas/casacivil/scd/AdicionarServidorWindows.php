...
$idBotSub = "submit";
if($id != null){
	$sql = $db->prepare("SELECT * FROM servidoreswindows where id = $id");
	$sql->execute();
...
<head>
	...
	<title>Adicionar Servidor Windows</title>
...
<script type="text/javascript">
	...
	function update(){
		...
		$.post( "backend/editarServidorWindows.php", obj).done(function( data ) {	
		   	var retorno = jQuery.parseJSON(data);
		    if(retorno.success == 1){
		    	location.href = "servidoresWindows.php";
		    }else{
