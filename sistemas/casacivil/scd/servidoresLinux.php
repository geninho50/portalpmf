...
<body>
	...
	<div class="tabelaServidor">
		<table class="table table-striped table-bordered">
			...
			<?php
				include "backend/SelectServidoresLinux.php";
				echo $tabela;
			?>
  		</table>
	</div>
<script type="text/javascript">
	function editar(id){
		location.href = "AdicionarServidorLinux.php?id=" + id;
	}

	function verPortas(id){
		location.href = "verPortasLinux.php?id=" + id;
	}
	...
	function excluir(id){
		...
		if(confirmacao){
			...
			$.post( "backend/deleteServidorLinux.php", obj).done(function( data ) {	
	...
	$('#exportar').bind('click',function(){
		location.href = "exportarLinux.php";
	});
	...
	$('#adicionar').bind('click',function(){
		location.href = "AdicionarServidorLinux.php";
	});
