...
<div id="wrapper">
    ...
    menu( $gdb->vargetpost('codigo'),'contato' );
...
?>
	...
	<div id="page" class="container">
		<div class="title">
			<h2>Contato</h2>
			<span class="byline">Caso ocorra alguma dificuldade entre em contato com a Fundação.</span></div>

		<h4>Telefone FME: 3324-1415<strong></strong></h4>
		<h4>Lucas: 99648-5250<strong></strong></h4>
		<h4>Kleber: 9960-2387<strong></strong></h4>
		<h4>Luiz Gustavo: 98416-9811<strong></strong></h4>
		<h4>Email: fmeesportes@gmail.com<strong></strong></h4>
</div>
