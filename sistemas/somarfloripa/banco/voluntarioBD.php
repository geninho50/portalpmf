...
$gdb->open("select * from pessoa p , pessoaAuxiliar pa  where p.codigopessoa = pa.codigopessoa and cpf = '$cpf' and codigoprojeto = '$codigoprojeto' and pa.situacaoSOMAR='V'  ");
