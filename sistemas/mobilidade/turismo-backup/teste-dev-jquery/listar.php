                ...
                <table class="table table-striped table-hover table-bordered">
                    ...
                    <tbody>
                        <?php 
                            ...
                            <tr>
                                <td width="3%"><?php echo $row_usuario['id_viagem']; ?></td>
                                ...
                                <a href="./ficha.php?id_viagem=<?php echo $row_usuario['id_viagem'];?>" class="view" title="View" data-toggle="tooltip"><i class="material-icons" >&#xE417;</i></a>
