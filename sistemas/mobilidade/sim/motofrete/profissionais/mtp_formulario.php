            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="MODALuser_cadastrar">Motofretista: Cadastrar Motorista</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form method="post" id="formuser" autocomplete="off" action="mtp_cadastrar.php">
                            <div><br>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-9">
                                        <label class="col-form-label">Nome do Profissional: </label>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-3">
                                        ...
                                        <input name="cnh" type="text" id="cnh" class="cnh form-control" onchange="validacnhdb();" size="11" placeholder="CNH (numeros)" autocomplete="off" />
                                    </div>                                  
                                </div>
                                <div class="form-row">
