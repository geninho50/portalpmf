...
$query_02 = "SELECT * FROM sim.motofrete_profissional where id_cadastro  = '$id_cadastro' AND codigo_registro  = '$codigo_registro' ";
...
<body>
            ...
            if (($resultado_02_count != 0)) {
                ...
                $sql = "UPDATE sim.motofrete_profissional SET status = :status WHERE id_cadastro=:id_cadastro";
                $stmt = $conn->prepare($sql);
                $stmt->bindValue(':status', 22); //negado
