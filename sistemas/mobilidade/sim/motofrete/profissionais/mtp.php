...
<head>
    ...
    <script src="/bas/js/validaCNH.js"></script>
...
<body>
            ...
            <div class="btn-toolbar justify-content-between" role="toolbar" aria-label="Toolbar with button groups">
                <div class="btn-group mr-2" role="group" aria-label="1 group">
                        <div class="botton-group row">
                            ...
                            <a class="btn btn-success btn-sm" href="/sim/motofrete/profissionais/mtp.php" role="button">Profissionais</a>
                            <a class="btn btn-success btn-sm" href="/sim/motofrete/empresas/mte.php" role="button">Empresas</a>
    ...
    $query_02 = "SELECT * FROM sim.motofrete_profissional ORDER BY id DESC";
    ...
    if (($resultado_02_count != 0)) { ?>
        ...
        <div class="container" theme-showcase" role="main">
            <div class="p-2 mb-2 bg-primary text-white">
                <div class="row">
                    <div class="col">
                        <b>Profissionais:  <?php echo $resultado_02_count ?></b>
                    </div>
            ...
            <table id="dtBasicExample" class="sortable lista-clientes table table-striped table-hover table-sm" cellspacing="0" width="100%">
                ...
                <tr class="table-primary">
                    ...
                    <td><b><a class="text-default">CNH</a></b></td>
                ...
                ?>
                    <tr>
                        ...
                        <td width=20%><?php echo $row['cnh']; ?></td>
                        ...
                        <td width=10%>
                            ...
                            if ($row['status'] == '1') {
                                $status = "autorizar";
                            ?>
                                <a class="btn btn-danger btn-sm" href="mtp_ficha.php?id_cadastro=<?php echo $row['id_cadastro'] ?>" role="button"><?php echo $status ?></a>
                            <?php } elseif ($row['status'] == '2') {
                                $status = "registrado";
                            ?>
                                <a class="btn btn-success btn-sm" href="mtp_ficha.php?id_cadastro=<?php echo $row['id_cadastro'] ?>" role="button"><?php echo $status ?></a>

                            <?php  } elseif ($row['status'] == '22') {
                                $status = "Indeferido";
                            ?>
                                <a class="btn btn-secondary btn-sm" href="mtp_ficha.php?id_cadastro=<?php echo $row['id_cadastro'] ?>" role="button"><?php echo $status ?></a>
                        ...
                        <td width=20%>
                            ...
                            <a type="button" class="btn btn-outline-info btn-sm fa fa-info pequeno" href="mtp_ficha.php?id_cadastro=<?php echo $row['id_cadastro'] ?>" role="button"></a>
                            <a type="button" class="btn btn-outline-warning btn-sm fa fa-pencil-square-o pequeno" href="mtp_editar.php?id_cadastro=<?php echo $row['id_cadastro'] ?>" role="button"></a>
                            <button type="button" class="btn btn-outline-danger btn-sm fa fa-trash pequeno" data-toggle="modal" data-target="#MODALuser_apagar" data-var_id_cadastro="<?php echo $row['id_cadastro']; ?>" data-var_nome="<?php echo $row['nome']; ?>"></button>
                        </td>
                    </tr>
        ...
        echo "<div class='alert alert-danger' role='alert'>Nenhum usuário encontrado!</div></div>";
    }


    include_once("mtp_formulario.php");

        ?>

        <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.9/umd/popper.min.js"></script>
        <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.2.1/js/bootstrap.min.js"></script>
        <script src="mtp_formulario.js"></script>
