        ...
        <div class="container" role="main">
            ...
            ?>
                    ...
                    <div class="container border rounded border-primary" role="main">
                        ...
                        <h5>
                            <b class="text-muted">Razão Social: </b><?php echo $row['razao_social']; ?><br>
                            <b class="text-muted">CNPJ: </b><?php echo $cnpj; ?><br>
                            <b class="text-muted">Data de Abertura : </b><?php echo $data_abertura; ?><br>
                        ...
                        ?>
                            ...
                            <form method="get" id="formuser" autocomplete="off" action="mte_autorizar_cadastro.php?">
                            ...
                            <form method="get" id="formuser" autocomplete="off" action="mte_desautorizar_cadastro.php?">
                                <input name="id_cadastro" type="hidden" value="<?php echo $row['id_cadastro'] ?>">
                                <div class="btn-toolbar mb-3" role="toolbar" aria-label="Toolbar with button groups">
                        ...
                        ?>
                            ...
                            <form method="get" id="formuser" autocomplete="off" action="mte_autorizar_cadastro.php?">
                                ...
                                <div class="btn-toolbar mb-3" role="toolbar" aria-label="Toolbar with button groups">
                                    <div class="input-group" style="margin-right: 20px">
                                        <div class="input-group-prepend">
                                            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#MODAL_ficha" role="button">Imprimir atestado cadastro</button>
                                        </div>
                                        <div class="input-group-append">
                                            <button type="button" role="button" style="width: 90px" class="form-control btn btn-outline-success fa fa-print pequeno" data-toggle="modal" data-target="#MODAL_ficha"></button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="MODAL_ficha">Imprimir Atestado de Cadastro</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <form method="get" id="formuser" autocomplete="off" action="mte_print_atestado.php">
                                    <div class="form-row">
                                        <div class="col col-md-12">
                                            <select class="form-control bg-info text-white" id="nome_fiscal" name="nome_fiscal">
                                                <option selected value="">Escolha o responsável pela emissão:</option>
                ...
                <div align=center><a href="mte.php" class="btn btn-warning" align=center>Fechar | Voltar</a></div>
            <?php
                } ?>
