...
<body>
                ...
                <div class="btn-group mr-2" role="group" aria-label="1 group">
                    <div class="botton-group row">
                        <div class="button-group mr-2">
                            ...
                            <a class="btn btn-success btn-sm" href="/sim/motofrete/profissionais/mte.php" role="button">Profissionais</a>
    ...
    $query_02 = "SELECT * FROM sim.motofrete_empresas ORDER BY id DESC";
    ...
    if (($resultado_02_count != 0)) { ?>
        ...
        <div class="container" theme-showcase" role="main">
            <div class="p-2 mb-2 bg-primary text-white">
                <div class="row">
                    <div class="col">
                        <b>Empresas: <?php echo $resultado_02_count ?></b>
                    </div>
            ...
            <table id="dtBasicExample" class="sortable lista-clientes table table-striped table-hover table-sm" cellspacing="0" width="100%">
                ...
                <tr class="table-primary">
                    ...
                    <td><b><a class="text-default">Razão Social</a></b></td>
                    <td><b><a class="text-default">CNPJ</a></b></td>
                ...
                ?>
                    <tr>
                        ...
                        <td width=30%><?php echo $row['razao_social']; ?></td>
                        ...
                        <td width=10%>
                            ...
                            if ($row['status'] == '1') {
                                $status = "autorizar";
                            ?>
                                <a class="btn btn-danger btn-sm" href="mte_ficha.php?id_cadastro=<?php echo $row['id_cadastro'] ?>" role="button"><?php echo $status ?></a>
                            <?php } elseif ($row['status'] == '2') {
                                $status = "registrado";
                            ?>
                                <a class="btn btn-success btn-sm" href="mte_ficha.php?id_cadastro=<?php echo $row['id_cadastro'] ?>" role="button"><?php echo $status ?></a>

                            <?php  } elseif ($row['status'] == '22') {
                                $status = "Indeferido";
                            ?>
                                <a class="btn btn-secondary btn-sm" href="mte_ficha.php?id_cadastro=<?php echo $row['id_cadastro'] ?>" role="button"><?php echo $status ?></a>
                        ...
                        <td width=20%>
                            ...
                            <a type="button" class="btn btn-outline-info btn-sm fa fa-info pequeno" href="mte_ficha.php?id_cadastro=<?php echo $row['id_cadastro'] ?>" role="button"></a>
                            <a type="button" class="btn btn-outline-warning btn-sm fa fa-pencil-square-o pequeno" href="mte_editar.php?id_cadastro=<?php echo $row['id_cadastro'] ?>" role="button"></a>
    ...
    include_once("mte_formulario.php");
        ...
        <script src="mte_formulario.js"></script>
