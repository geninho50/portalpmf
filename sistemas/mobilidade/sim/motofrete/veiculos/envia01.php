...
if ( @ftp_put( $conexao_ftp, $destino, $arquivo_temp, FTP_BINARY ) ) {
	...
	$sql = "INSERT INTO lacustre.viagens (id, id_viagem, id_embarcacao, data_operacao, horario_operacao, data_criado, sentido, modalidade,  imagem, status, contrato, num_ficha) VALUES (:id, :id_viagem, :id_embarcacao, :data_viagem, :data_operacao, :horario_operacao, :sentido, :modalidade, :imagem, :status, :contrato, :num_ficha)";
	$stmt = $conn->prepare ($sql);
