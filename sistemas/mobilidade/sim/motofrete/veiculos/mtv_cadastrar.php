...
$sql = "SELECT id FROM sim.motofrete_veiculos WHERE id=(select max(id) from sim.motofrete_veiculos)";
...
$query_03 = "SELECT * FROM sim.motofrete_veiculos where id_cadastro = '$id_cadastro'";
...
if ($count03 != 0) {
    ...
    INSERT INTO sim.motofrete_veiculos(
        id, 
        veiculo_placa, 
        veiculo_renavam, 
        proprietario, 
    ...
    $sql = 'INSERT INTO sim.motofrete_veiculos
		(
            veiculo_placa, 
            veiculo_renavam, 
            proprietario, 
    ...
    $query_02 = "SELECT * FROM sim.motofrete_veiculos where data_criado = '$data_criado' ";
