...
<div class="container" theme-showcase" role="main">
		...
		foreach($linhas as $linha){
			if($primeira_linha == false){
                ...
                $operadora= $linha->getElementsByTagName("Data")->item(0)->nodeValue;
                $numordem= $linha->getElementsByTagName("Data")->item(1)->nodeValue;
                ...
                $stmt->bindValue(':numordem',$numordem);
