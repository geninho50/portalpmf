...
<body>
    <div class="container" role="main">
        ...
        <div class="container border rounded border-primary" role="main">
            ...
            <!-- Formulário  !-->
            <form method="post" id="formuser" action="envia01.php" enctype="multipart/form-data">
                    ...
                    <div class="col col-md-12">
                        <div class="custom-control custom-radio">
                            ...
                            <div class="col">
                                ...
                                <label class="custom-control-label" for="radio4">Costa -> Lagoa</label>
                            </div>
                            <br>
                            <div class="col">
                                <input class="custom-control-input" type="radio" name="sentido" id="radio5" value="VOLTA" checked>
                                <label class="custom-control-label" for="radio5">Lagoa -> Costa</label>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group ">
                <h5><strong><label class="text-muted">Justificar viagem se necessário</label></strong></h5>

                                            <textarea class="form-control" name="justificativa" id="justificativa" size="60"  rows="5"></textarea>
                                        </div>
