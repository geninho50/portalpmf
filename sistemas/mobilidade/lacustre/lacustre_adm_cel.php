    ...
    <div class="container" theme-showcase" role="main">
        ...
        <div class="container" role="main">
            ...
            <!-- Fim imagem cabeçalho -->
					...
					<form method="POST" action="" enctype="multipart/form-data">
                            ...
                            <a href="form01.php" class="btn btn-primary btn-lg btn-block">Cadastrar Viagem</a>
                            <input type="text" class="input-search btn btn-outline-secondary btn-lg btn-block" alt="lista-clientes" placeholder="Buscar nesta lista" />


							<div class="btn-group btn btn-block">
								<input type="date" name="data" class="btn btn-outline-secondary large" id="" value="<?php echo $data ?>" placeholder="<?php echo $data ?>">
								<button class="btn btn-outline-secondary btn-lg btn-block fa fa-search-plus" type="submit"></button>
        ...
        <div class="row">
            <?php while ($row = $resultado_02->fetch()) { ?>
                <?php if (date('d-m-Y', strtotime($row['data_operacao'])) != $data_ant) { ?>
                    <br> <strong>
                        <h3><?php echo date('d-m-Y', strtotime($row['data_operacao'])) . ' <br>  Total de Viagens : ' . $total_01; ?> </h3>
                    </strong>
        </div>
        <table id="dtBasicExample" class="sortable lista-clientes table table-striped table-hover table-sm" cellspacing="0" width="100%">
            <tr class="table-primary">
                ...
                <td><b><a class="text-default">Modalidade<br>Sentido</a></b></td>
        ...
        <?php
                ...
                $data_operacao = date('d-m', strtotime($row['data_operacao']));
                $viagens_dia = $viagens_dia + 1;
        ?>
        <tr>
            <td width=5%><?php echo $row['id']; ?></td>
            <td width=auto><?php echo $data_operacao ?></td>
            <td width=10%><?php echo $horario_operacao ?></td>
            <td width=10%><?php echo $row['modalidade']; ?><br> <?php echo $row['sentido']; ?></td>
            <td width=auto>
