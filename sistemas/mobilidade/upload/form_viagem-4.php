    ...
    <div class="container" role="main">
        ...
        <div class="container border rounded border-primary" role="main">
            ...
            <form method="post" id="formuser" action="envia.php" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="id_veiculo">
                                <?php while ($row3 = $resultado_03->fetch()) { ?>
                                    <option value="<?php echo $row3['id'] ?>"><?php echo $row3['inscricao'] ?> - <?php echo $row3['nome'] ?> </option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                ...
                <div class="col-sm-12">
                    <img id="blah" src="pix.png" style="width: 150px; height: 150px;" alt="" />
                </div>
                <br><br>
    ...
    <script>
        ...
        function validar() {
            ...
            $("#confirm").html('<br><h5><strong>Data da Viagem: </strong> ' + data +
                ...
                '<br><br> <input class="custom-control-input" type="text" name="confirmarfoco" id="confirmarfoco" value="VOLTA"></input><button type="submit" value="Cadastrar" class="btn btn-success">Confirmar o cadastro de viagem</button>');
