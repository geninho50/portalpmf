...
<body>
    <div class="container" role="main">
        ...
        <div class="container border rounded border-primary" role="main">
            ...
            <br>
            <!-- Formulário  !-->
            <form method="post" id="formuser" action="envia-3.php?id_viagem=<?php echo $id_viagem ?>&id=<?php echo $id ?>&pontos=<?php echo $pontos?>" enctype="multipart/form-data">
                ...
                <a href="form_viagem-7.php?id_viagem=<?php echo $id_viagem ?>&id=<?php echo $id ?>&pontos=<?php echo $pontos?>" class="btn btn-warning btn-lg btn-block" align=center>Limpar</a>
                <br><br>
        </div>
        <br>
        </form>
