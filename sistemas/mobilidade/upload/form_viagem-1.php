...
<body>
    ...
    <div class="container" role="main">
        ...
        <div class="container border rounded border-primary" role="main">
            ...
            <form method="post" id="formuser" action="envia.php" onsubmit="return validate(this);" enctype="multipart/form-data">
                ...
                <br>
                <button class="btn btn-success" onclick="return validar()">Cadastrar</button>
...
function validate(form) {
        ...
        function validar() {
            ...
            '<br><br><button type="submit" value="Cadastrar" class="btn btn-success">Confirmar o cadastro de viagem</button>');
            alert("<br><br><button type=\"submit\" value=\"Cadastrar\" class=\"btn btn-success\">Confirmar o cadastro de viagem</button>Eu sou um alert!" + data );
