    ...
    <div class="container" role="main">
        ...
        <div class="container border rounded border-primary" role="main">
            ...
            <form method="post" id="formuser" action="envia.php" enctype="multipart/form-data">
                ...
                <button type="button" class="btn btn-outline-danger" data-toggle="modal" data-target="#meuModal">kkk</button>
                ...
                <br>
                    ...
                    <div id="meuModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
