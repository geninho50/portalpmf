...
<body>
    ...
    <form id="testform">
        <fieldset class="form-group" id="cadastro_contratantes">
            ...
            <span id="msg-error-contratantes_nome"></span>
            ...
            <span id="msg-error-contratantes_logradouro"></span>
            <div class="form-group">
            ...
            <span id="msg-error-contratantes_bairro"></span>
            <div class="form-group">
            ...
            <span id="msg-error-contratantes_cidade"></span>
            <div class="form-group">
            ...
            <span id="msg-error-contratantes_estado"></span>
            <div class="form-group">
            ...
            <span id="msg-error-contratantes_pais"></span>
            <div class="form-group">
            ...
            <span id="msg-error-contratantes_documento"></span>
            <div class="form-group">
            ...
            <span id="msg-error-contratantes_email"></span>
            <div class="form-group">
    ...
    <!-- michel -->
        ...
        <hr>
            <input type="button" id="driver1" value="test form" onclick="validar()">
        <hr>
        ...
        <fieldset class="form-group" id="envia">
            ...
            <!-- <br>
            <input type="button" id="driver1" value="test form" onclick="return validar()"/> -->
