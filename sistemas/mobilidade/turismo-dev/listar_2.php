                    ...
                    <tbody>
                        <?php 
                            ...
                            <tr>
                                ...
                                <a href="ficha.php?cod_registro=<?php echo $row_usuario['cod_registro'];?>&contratantes_email=<?php echo $row_usuario['contratantes_email'];?>" class="view" title="View" data-toggle="tooltip"><i class="material-icons" >&#xE417;</i></a>
