<!--**
 	*  SMPU - BASE DE DADOS VERSUL ROTATIVO
...
$query_01 = "SELECT *,'R'||saldo::text::money AS saldo_brl, 'R'||valor::text::money AS valor_brl FROM rotativo.database_versul";
...
$query_02 = "SELECT *,'R'||saldo::text::money AS saldo_brl, 'R'||valor::text::money AS valor_brl FROM rotativo.database_versul LIMIT $numresultados OFFSET $inicio";
...
<body>
	...
	<div class="container" theme-showcase" role="main">
		...
		<tr class="table-primary">
					...
					<td><b><a class="text-default">CPF_CPNJ</a></b></td>
					<td><b><a class="text-default">Saldo</a></b></td>
					<td><b><a class="text-default">Valor da Última Recarga</a></b></td>
					<td><b><a class="text-default">Data ùltima Recarga</a></b></td>
		...
		<tr>
					<td width=3%><?php echo $row['id']; ?></td>
						...
						<td width=10%><?php echo $row['cpf_cnpj']; ?></td>
						<td width=10%><?php echo $row['saldo']; ?></td>
						<td width=10%><?php echo $row['valor']; ?></td>
						<td width=17%><?php echo $row['data_ultima_recarga']; ?></td>
						<td width=auto><?php echo $row['pagamento_origem']; ?></td>
					</tr>
					...
					<nav class="text-center" aria-label="Paginador_quantidade">
						<ul class="pagination justify-content-left">
							<li class="page-item <?php if ($numresultados == 50) echo 'active';
								...
								<a class="page-link" href="db_versul.php?numresultados=50&pagina=<?php echo $pagina; ?>"> 50</a>
							</li>
							<li class="page-item <?php if ($numresultados == 50) echo 'active';
													else echo ''; ?>">
								<a class="page-link" href="db_versul.php?numresultados=100&pagina=<?php echo $pagina; ?>">100</a>
							</li>
							<li class="page-item <?php if ($numresultados == 5000) echo 'active';
													else echo ''; ?>">
								<a class="page-link" href="db_versul.php?numresultados=1000&pagina=<?php echo $pagina; ?>">1000 de <?php echo $total_01; ?></a>
							</li>
						</ul>
					</nav>
				</div> <!-- paginador -->
				...
				<div class="col-sm">
					<nav class="text-left" aria-label="Paginador_pagina">
						<ul class="pagination justify-content-right">
							<li class="page-item">
								<a class="page-link" href="db_versul.php?pagina=1&numresultados=<?php echo $numresultados; ?>">Primeira</a>
							</li>
							...
							for ($i = $pagina - 2, $limiteDeLinks = $i + 4; $i <= $limiteDeLinks; $i++) {
								...
								if ($i == $pagina) { ?>
									...
									<li class="page-item active">
										<a class="page-link" href="db_versul.php?pagina=<?php echo $i; ?>&numresultados=<?php echo $numresultados; ?>"><?php echo $i; ?></a>
									</li>
							...
							<li class="page-item ">
								<a class="page-link" href="db_versul.php?pagina=<?php echo $quantidadeDeLinks; ?>&numresultados=<?php echo $numresultados; ?>">Última</a>
							</li>
						</ul>
					</nav>
				</div>
