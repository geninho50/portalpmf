...
include("../../bas/pdf/mpdf60/mpdf.php");
...
if ($resultado_02_count != 0) {
    ...
    // 1. GERA cabeçalho da ficha 
        ...
        <table style=\"height:200px\" width=\"100%\">
            <tr valign=\"bottom\">
            <td width=\"30%\"><img src=\"../../bas/img/PMFSMPU.jpg\" ></td>
            <td width=\"30%\"></td>
            <td width=\"15%\"><img align=\"right\" src=\"../../bas/img/REMOB_COR.jpg\" width=\"50%\"></td>
            </tr>
        </table>
        <br>
        ";
    ...
    // 2. GERA dados gerais do cadastro a serem impressos na ficha 
        ...
        <img src=\"../../bas/img/form/quadrado_round.png\" width=\"15\" height=\"15\"> Cópia do Documento de identidade com foto<br>
        <img src=\"../../bas/img/form/quadrado_round.png\"  width=\"15\" height=\"15\"> Comprovante de residência<br>
        ";
    ...
    // 4. GERA de compleemento de acordo com a categoria e respectiva validade
        ...
        elseif ($row['categoria'] == "Estudante") {
           ...
           <h3>Documentos para cadastro Estudante:</h3>
            <img src=\"../../bas/img/form/quadrado_round.png\"  width=\"15\" height=\"15\"> Atestado de matrícula atualizada com validade até " . date ( "d/m/Y", strtotime( $row['data_validade_especial'] )). " 
            </fieldset>
            ";
        ...
        elseif ($row['categoria'] == "PCD com acompanhante") {
            ...
            <img src=\"../../bas/img/form/quadrado_round.png\"  width=\"15\" height=\"15\"> Atestado médico que comprove a deficiência permanente, obrigatoriamente contendo número da Classificação Internacional de Doenças-CID
            </fieldset>
            ";
        ...
        elseif ($row['categoria'] == "Gestante") {
            ...
            <img src=\"../../bas/img/form/quadrado_round.png\"  width=\"15\" height=\"15\"> Atestado médico informando a data final do pré-natal
            </fieldset>
            ";
        ...
        elseif ($row['categoria'] == "Idoso") {
            ...
            <img src=\"../../bas/img/form/quadrado_round.png\"  width=\"15\" height=\"15\"> Aferi, conforme a data de nascimento que tem mais de 65 anos.
            </fieldset>
            ";
        ...
        elseif ($row['categoria'] == "Acompanhante Aluno Infantil") {
            ...
            <img src=\"../../bas/img/form/quadrado_round.png\"  width=\"15\" height=\"15\"> Atestado de matrícula do filho matriculado em escola do Ensino Infantil Municipal com vigência até 31 de dezembro do ano corrente
            </fieldset>
            ";
    ...
    // 6. GERA o arquivo PDF encadeando as partes definidas       
        ...
        $css = file_get_contents("../../bas/pdf/css/mpdfestilo.css");
