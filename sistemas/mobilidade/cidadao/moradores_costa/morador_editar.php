...
<head>
    ...
    <script>
        $(document).ready(function() {
            ...
            var categoria1 = formuser.categoria.value;

            if (categoria1 == "Gestante") {
                document.getElementById("upload_gestante").style.display = "block";
                return false;
            }

            if (categoria1 == "Estudante") {
    ...
    <div class="container" theme-showcase" role="main">
        ...
        if (($resultado_02_count != 0)) {
            while ($row = $resultado_02->fetch()) {
                ...
                //        $validade_estudante_show = "block";
                //        $validade_gestante_show = "none";

                //} elseif ($row['categoria'] == "Gestante") {
                //         $validade_gestante_show = "block";
                //         $validade_estudante_show = "none";
                ...
                //          }
        ?>
                <form method="post" id="formuser" autocomplete="off" action="morador_editardb.php">

                    <div class="container border rounded border-primary" role="main" id="div_form" style="display:block">
                        <h3 align=center>Editar Registro : <?php echo $row['id_cadastro']; ?> - <?php echo $row['categoria']; ?>
                        </h3>
                        ...
                        <div class="form-row">
                            <div class="form-group col-6">
                                ...
                                <input name="nome" type="text" id="nome" style="text-transform: uppercase;" class="form-control" size="70" autocomplete="off" placeholder="NOME COMPLETO" value="<?php echo $row['nome_passageiro']; ?>" />
                            </div>
                            <div class="form-group col-3">
                                <label class="col-form-label" for="categoria">Categoria</label>
                                <select class="form-control" id="id_categoria" name="categoria" readonly>
                            ...
                            <div class="col-3" id="upload_estudante" style="display:none">
                                <label class="col-form-label">Validade da matrícula</label>
                                <input name="validade1" type="date" id="validade_estudante" class="form-control" value="<?php echo $row['data_validade_especial']; ?>" />
                            </div>
                            <div class="col-3" id="upload_gestante" style="display:none">
                                <label class="col-form-label">Data final Pré-natal</label>
                                <input name="validade2" type="date" id="validade_gestante" class="form-control" autocomplete="off" value="<?php echo $row['data_validade_especial']; ?>" />
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="form-group col-3">
                                ...
                                <input name="rg" type="text" id="rg" class="rg form-control" size="15" placeholder="RG (numeros)" autocomplete="off" value="<?php echo $rg; ?>" />
                            </div>
                            <div class="form-group col-2">
                                <label class="col-form-label">Emissor </label>
                                <input name="rg_orgao" type="text" id="rg_orgao" class="form-control" size="8" style="text-transform: uppercase;" placeholder="" autocomplete="off" value="<?php echo $rg_orgao; ?>" />
                            </div>
                            <div class="form-group col-3">
    ...
    <script>
        ...
        function form_type() {
            ...
            if (x == "Estudante") {
                document.getElementById("div_form").style.display = "block";
                document.getElementById("upload_estudante").style.display = "block";
                $("#msg-error").html('<div class="alert alert-danger" role="alert">A categoria e estudamte</div>');
