...
<body>
    ...
    $query_02 = "SELECT * FROM sim.moradores_costa WHERE status != 0 ORDER BY id DESC ";
    ...
    if (($resultado_02_count != 0)) { ?>
        ...
        <script>
            function validar_pendencia() {
                var nome1 = formuser.nome.value;
                var nome1 = nome1.trim();
                var cpf1 = formuser.cpf.value;
                var cep1 = formuser.cep.value;
                var strCPF1 = formuser.cpf.value;
                strCPF1 = strCPF1.replace(/[_\W]+/g, "");
                $("#msg-error").html('');
