...
$query_02 = "SELECT * FROM sim.moradores_costa where id_cadastro  = '$id_cadastro' AND codigo_registro  = '$codigo_registro' ";
...
<body>
            ...
            if (($resultado_02_count != 0)) {
                ...
                $sql = "UPDATE sim.moradores_costa SET status = :status WHERE id_cadastro=:id_cadastro";
