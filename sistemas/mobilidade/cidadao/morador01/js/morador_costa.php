                    ...
                    <tr>
                        ...
                        <td width=10%>
                            ...
                            elseif ($row['status'] == '22') {
                                $status = "Indeferido";
                            ?>
                                <a class="btn btn-secondary btn-sm" href="morador_ficha.php?id_cadastro=<?php echo $row['id_cadastro'] ?>" role="button"><?php echo $status ?></a>
                            <?php  }
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" id="formuser" autocomplete="off" action="morador_costa_cadastrar.php">
                            ...
                            <div id="div_form" style="display:none">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" value="Cadastrar" class="btn btn-secondary" onclick="return validar_pendencia()">Cadastrar com pendencia</button>
                        ...
                        <div class="row" id="upload_incompleto" style="display:none">

                        <form method="get" id="formincompleto" autocomplete="off" action="morador_costa_desautorizar_cadastro.php?">
                                <input name="id_cadastro" type="hidden" value="<?php echo $row['id_cadastro'] ?>">
                                <div class="btn-toolbar mb-3" role="toolbar" aria-label="Toolbar with button groups">
                                    <div class="input-group">
                                              <button type="submit" value="Cadastrar" class="btn btn-secondary">Cadastro Incompleto</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
