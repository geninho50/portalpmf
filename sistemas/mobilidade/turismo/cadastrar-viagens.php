                    ...
                    <div id="informacoes_viagem_show" style="display:block">
                        ...
                        <div class="input-block grid grid-tree">
                            <div class="select-block">
                                ...
                                <select class="form-control" name="pais_origem" id="pais_origem">
                    ...
                    <div class="input-block motoristas-global-scope"  id="cadastro_motoristas_show" style="display: block;">
                        <div class="input-block motoristas-local-scope">
                            <div class="input-block grid grid-tree">         
                                ...
                                <div class="input-block">
                                    <label for="cadastro_motorista_nome">Motorista </label>
                                    <input type="text" class="verificar_motoristas form-control " name="motoristas_nome[]" id="motoristas_nome" placeholder="Nome">
                                </div>               
                                <div class="input-block">
                                    <label for="cadastro_motorista_telefone_ddd">Telefone (DDD + DDI)</label>
                                    <input type="text" class="verificar_motoristas form-control" name="motoristas_telefone_ddd[]" id="motoristas_telefone_ddd" placeholder="Telefone com DDD">                               
                                </div>             
                                <div class="input-block">
                                    <label for="cadastro_motorista_documento_habilitacao">Habilitação</label>
                                    <input type="text" class="verificar_motoristas form-control" name="motoristas_documento_habilitacao[]" id="motoristas_documento_habilitacao"> 
                                </div>
                        ...
                        <div class="grid">
                            <div class="grid grid-tree-rota">
                                <div class="input-block">
                                    ...
                                    <input class="verificar_rotas form-control" type="date" name="rota_endereco_destino[]">
                                </div>
                                <div class="select-block">
                                    <label for="time_from">Local de partida</label>
                                    <select class="verificar_rotas form-control" name="rota_endereco_partida[]" id="rota_endereco_partida" aria-describedby="rota_partida_helpid">
                                ...
                                <div class="select-block">
                                    ...
                                    <select class="verificar_rotas form-control" name="rota_endereco_chegada[]" id="rota_endereco_chegada">
                                        <option disabled selected value>Selecione uma opção</option>
                                        <option value="Abraão">Abraão</option>
                                        <option value="Agronômica">Agronômica</option>
                                        <option value="Balneário">Balneário</option>
