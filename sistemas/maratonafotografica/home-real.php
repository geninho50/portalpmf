			...
			<!-- Main -->
				<section id="main">
							...
							<div class="inner">
									...
									$iphone = strpos($_SERVER['HTTP_USER_AGENT'],"iPhone");
											...
											if ($iphone || $ipad || $android || $palmpre || $ipod || $berry || $symbian == true){
                                                ...
                                                <p class="autor">Foto: Juan Alonso</p>';
											}else{
                                                ...
                                                <p class="autor2">Foto: Juan Alonso</p>';
											};
                            ...
                            <div class="flex-parent">
                                <div class="input-flex-container">
                                    ...
                                    <div class="input active">
                                        <span data-year="28" data-info="28º Edição"></span>
                                    </div>
                                ...
                                <div class="description-flex-container">
                                    ...
                                    <div class="gallery active">
                                        <div class="content">
                                            <div class="media">
                                                <a href="img/fulls/28/Alessandra_de_Souza_Quase ninguem_ve__Prêmio Melhores_Fotografias.jpg"><img src="img/fulls/28/Alessandra_de_Souza_Quase ninguem_ve__Prêmio Melhores_Fotografias.jpg" alt="" title="Quase ninguém vê - Prêmio Melhores Fotografias"/>Alessandra de Souza</a>
                                            </div>
                                            <div class="media">
                                                <a href="img/fulls/28/Gabrielle_Pires_Claro_e_escuro.jpg"><img src="img/fulls/28/Gabrielle_Pires_Claro_e_escuro.jpg" alt="" title="Claro e escuro - 1º Prêmio Conjunto Digital Mobile"/>Gabrielle Pires</a>
                                            </div>
                                            <div class="media">
                                                <a href="img/fulls/28/ERIK_BAYER_a_beira_mar.jpg"><img src="img/fulls/28/ERIK_BAYER_a_beira_mar.jpg" alt="" title="À beira-mar - Prêmio Conjunto Infantojuvenil 06 a 09 anos"/>Erik Bayer</a>
                                            </div>
                                            <div class="media">
                                                <a href="img/fulls/28/Arthur_Daros_Mercados_e_feiras.jpg"><img src="img/fulls/28/Arthur_Daros_Mercados_e_feiras.jpg" alt="" title="Mercados e feiras - 2º Prêmio Conjunto Câmera Digital"/>Arthur Daros</a>
                                            </div>
                                            <div class="media">
                                                <a href="img/fulls/28/Natureza_em_detalhe_Fabiana_Martins.jpg"><img src="img/fulls/28/Natureza_em_detalhe_Fabiana_Martins.jpg" alt="" title="Natureza em detalhe - Prêmio Melhores Fotografias"/>Fabiana Martins</a>
                                            </div>
                                            <div class="media">
                                                <a href="img/fulls/28/Rafaela_de_Oliveira_Mutaçoes_geograficas.jpg"><img src="img/fulls/28/Rafaela_de_Oliveira_Mutaçoes_geograficas.jpg" alt="" title="Mutações geográficas - Prêmio Melhores Fotografias"/>Rafaela de Oliveira</a>
                                            </div>
                                            <div class="media">
                                                <a href="img/fulls/28/Miguel_Etges_Rodrigues_Natureza_em_detalhe.jpg"><img src="img/fulls/28/Miguel_Etges_Rodrigues_Natureza_em_detalhe.jpg" alt="" title="Natureza em detalhe - Prêmio Melhores Fotografias"/>Miguel Etges Rodrigues</a>
                                            </div>
                                            <div class="media">
                                                <a href="img/fulls/28/Ricardo_Pinho_E_outono.jpg"><img src="img/fulls/28/Ricardo_Pinho_E_outono.jpg" alt="" title="É outono - Prêmio Melhores Fotografias"/>Ricardo Pinho</a>
                                            </div>
                                        ...
                                        <footer>
                                            <h2><a href="pdf/CATÁLOGO 28 MARATONA FOTOGRÁFICA-web.pdf" target="_blank">Catálogo da 28ª Maratona Fotográfica de Florianópolis</a></h2>
                                        </footer>
                                        <?php }; ?>
                                    </div>    
					...
					<!-- Contact -->
						<section id="contact">
							<!-- Social -->
								<div class="social column">
                                    ...
                                    <p>A edição contará com as modalidades Analógica e Digital e Infantojuvenil. Todavia, houve mudança em relação às últimas edições na modalidade Digital, agora passa a ter duas categorias - Digital Categoria Câmeras (câmeras com lentes intercambiáveis ou lentes fixas) e Digital Mobile (aparelhos celulares ou tablets).</p>
									...
									<p>O concurso é totalmente gratuito e ocorrerá nos dias <strong>26 e 27 de abril de 2025</strong>. Serão disponibilizadas <strong>500 vagas</strong>, distribuídas conforme Edital e Regulamento. </p>

									<p>As inscrições ocorrerão até <strong>22 de abril</strong> e as vagas serão preenchidas conforme recebimento das inscrições. Também serão reservadas vagas para inscrição no dia da abertura do concurso (sábado)</p>
							...
							<!-- Form -->
								...
								<div class="column" id="incricao">
                                    ...
                                    <p>Infantojuvenil é subdividida nas faixas etárias: 6 a 9 anos, 10 a 12 anos, 13 a 15 anos, 16 a 17 anos.</p>
                                    ...
                                    <p>Analógica, Digital Categoria Câmeras e Digital Mobile - para participantes adultos.</p>

                                    <!-- <p style="color: red;font-size:20px;"><strong>Todas as vagas para adultos já foram preenchidas.</strong></p>
                                    <p style="color: red;font-size:14px;"><strong>Serão disponibilizadas algumas vagas no sábado (Ver item 4.6, 4.7, 4.8 e 4.9 do edital)</strong></p> -->
						...
						<p>A Secretaria de Cultura, Esporte e Lazer junto com a Fundação Cultural de Florianópolis Franklin Cascaes agradecem pelo interesse em participar da 28ª Maratona Fotográfica de Florianópolis.</p>
						<p>Lembramos que é obrigatória a entrega do Termo de Responsabilidade, no dia da largada da Maratona Fotográfica, dia 26 de abril (sábado), das 9h às 12h, em local sinalizado no Largo da Alfândega, onde ocorrerá também a abertura e largada do concurso.</p>
						<p>Neste mesmo dia e local será retirado o Pen Drive ou rolo de filme. </p>
						<p>OBS: Caso o Termo não tenha sido gerado, favor baixar o modelo no link: <a target="_blank" href="pdf/termoinscricaoadulto2025.pdf" class="button">Analógica e Digital</a> ou <a target="_blank" href="pdf/termoinscricaocrianca2025.pdf" class="button">Infantojuvenil</a></p>
