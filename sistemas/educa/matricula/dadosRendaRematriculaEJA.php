...
include_once 'fnc/buscaDadosRendaEJA.php';
$dados = buscaDadosRendaEJA($_SESSION['id']);

$_SESSION['renda']['empresa'] = $dados[1];
$_SESSION['renda']['funcao'] = $dados[2];
$_SESSION['renda']['carteira'] = $dados[3];
if($_SESSION['renda']['carteira'] == 1){
    $_SESSION['renda']['carteira'] = 'sim';
} else {
    $_SESSION['renda']['carteira'] = 'nao';
}
$_SESSION['renda']['jaCarteira'] = $dados[4];
if($_SESSION['renda']['jaCarteira'] == 1){
    $_SESSION['renda']['jaCarteira'] = 'sim';
} else {
    $_SESSION['renda']['jaCarteira'] = 'nao';
}
$_SESSION['renda']['estagio'] = $dados[5];
if($_SESSION['renda']['estagio'] == 1){
    $_SESSION['renda']['estagio'] = 'sim';
} else {
    $_SESSION['renda']['estagio'] = 'nao';
}
$_SESSION['renda']['procuraEmprego'] = $dados[6];
if($_SESSION['renda']['procuraEmprego'] == 1){
    $_SESSION['renda']['procuraEmprego'] = 'sim';
} else {
    $_SESSION['renda']['procuraEmprego'] = 'nao';
}
$_SESSION['renda']['pretensao'] = $dados[7];
$_SESSION['renda']['voluntario'] = $dados[8];
if($_SESSION['renda']['voluntario'] == 1){
    $_SESSION['renda']['voluntario'] = 'sim';
} else {
    $_SESSION['renda']['voluntario'] = 'nao';
}
$_SESSION['renda']['localVoluntario'] = $dados[9];
$_SESSION['renda']['recebeAjuda'] = $dados[10];
if($_SESSION['renda']['recebeAjuda'] == 1){
    $_SESSION['renda']['recebeAjuda'] = 'sim';
} else {
    $_SESSION['renda']['recebeAjuda'] = 'nao';
}
$_SESSION['renda']['numeroFilhos'] = $dados[11];
$_SESSION['renda']['numeroDependentes'] = $dados[12];
$_SESSION['renda']['numeroDependentesTrabalham'] = $dados[13];
$_SESSION['renda']['moraFamilia'] = $dados[14];
if($_SESSION['renda']['moraFamilia'] == 1){
    $_SESSION['renda']['moraFamilia'] = 'sim';
} else {
    $_SESSION['renda']['moraFamilia'] = 'nao';
}
$_SESSION['renda']['numeroHabitantes'] = $dados[15];
$_SESSION['renda']['habmot'] = $dados[16];
$_SESSION['renda']['comQuemDeixara'] = $dados[17];
$_SESSION['renda']['rendaPropria'] = $dados[18];
$_SESSION['renda']['rendaFamiliar'] = $dados[19];
...
if (count($_POST) > 0) {
    if(!isset($erro)){
        ...
        header("Location: salvaInfoRematriculaEJA.php");
    }
                ...
                <div class='row-fluid' style='text-align: center;'>
                    ...
                    <div class="span8 folha" style='display: none;' id='conteudo'>
                        ...
                        <form class="form-horizontal" method="post" onsubmit="">
                            ...
                            <br>
                            <a class='btn' href='dadosPaisRematriculaEJA.php'>Voltar</a>
