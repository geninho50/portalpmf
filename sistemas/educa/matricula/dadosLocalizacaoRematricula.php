...
if (count($_POST) > 0) {
    ...
    if (!isset($erro)) {
        ...
        $escola = (buscaEscolaRematricula($_SESSION['id']));
        $_SESSION['escola']['id'] = $escola[7];

        header("Location: salvaInfoRematricula.php");
    }
}
                ...
                <div class='row-fluid' style='text-align: center;'>
                    ...
                    <div class="span8 folha" style='display: none;' id='conteudo'>
                        ...
                        <form class="form-horizontal" method="post" onsubmit="$('#inputLogradouro').removeAttr('disabled');
                            ...
                            <br>
                            <a class='btn' href='dadosSaudeRematricula.php'>Voltar</a>
