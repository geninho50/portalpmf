...
<head>
    ...
    <title>SGE &middot; Nova Intenção</title>
            ...
            <div class='conteudo'>
                ...
                <div class='row-fluid' style='text-align: center;'>
                    ...
                    <div class="span8 folha">
                        ...
                        <form action="novaIntencaoConfirmacao.php">
                        ...
                        <div class="control-group" style='margin-bottom: 5px;'>
                            ...
                            <div class="controls" style='line-height: 20px'>                
                                ...
                                if (isset($_POST['escolaNova'])) {
                                    if (isset($_POST['anoNova'])) {
                                        include_once 'fnc/listaDeAnos.php';
                        ...
                        <br>
                        <button class='btn btn-primary' href="novaIntencaoConfirmacao.php">Registrar intenção</button>
                    </form>
                    <hr>
                    <a class='btn btn-warning' href="limpaSessao.php">Finalizar sem registrar intenção</a>
                </div>   
            </div>
        </div>
