...
if (!isset($_SESSION['renda'])) {
    header("Location: dadosRendaRematriculaEJA.php");
}
                ...
                <div class='row-fluid' style='text-align: center;'>
                    ...
                    <div class="span8 folha">
                        ...
                        <form class="form-horizontal" method="post">
                            ...
                            <a class='btn-info btn'  href="relatorios/emitirFormRematriculaEJA.php"><i class='icon-print icon-white'></i>Salvar inscrição e Emitir comprovante</a>                         
                            <br>                            
                            <br>
