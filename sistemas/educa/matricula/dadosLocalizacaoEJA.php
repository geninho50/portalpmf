...
if (!isset($erro)) {
  ...
  header("Location: dadosEscolaresEJA.php");
}
}
...
<div class="controls">
  <input name='numero' type="text" id="inputNumero" onkeypress='verificaDigitos("#inputNumero");' onkeyup='verificaDigitos("#inputNumero");'
  <?php
  if (isset($_POST['numero'])) {
...
<div class="controls">
  <select name='municipio' id="inputMunicipio" disabled>
   ...
   include 'fnc/listaDeMunicipios.php';
                                ...
                                <br>
                                <a class='btn' href='outrosDadosEJA.php'>Voltar</a>
