...
//cep
    ...
    if (!isset($erro)) {
        ...
        $_SESSION['responsavel']['telefone'] = $_POST['ufTelefone'] . $_POST['telefone'];
        $_SESSION['responsavel']['celular'] = $_POST['ufCelular'] . $_POST['celular'];
        $_SESSION['responsavel']['comercial'] = $_POST['ufComercial'] . $_POST['comercial'];
        ...
        $_SESSION['responsavel']['turnos'] = $_POST['turnos'];

        if ($_SESSION['dados_pessoais']['quem_acompanha'] == 'outro') {
...
if (isset($_SESSION['responsavel']['turnos'])) {
    $_POST['turnos'] = $_SESSION['responsavel']['turnos'];
}
...
if (isset($_SESSION['responsavel']['telefone'])) {
    $_POST['ufTelefone'] = substr($_SESSION['responsavel']['telefone'], 0, 2);
    $_POST['telefone'] = substr($_SESSION['responsavel']['telefone'], 2);
}
if (isset($_SESSION['responsavel']['comercial'])) {
    $_POST['ufComercial'] = substr($_SESSION['responsavel']['comercial'], 0, 2);
    $_POST['comercial'] = substr($_SESSION['responsavel']['comercial'], 2);
}
if (isset($_SESSION['responsavel']['celular'])) {
    $_POST['ufCelular'] = substr($_SESSION['responsavel']['celular'], 0, 2);
    $_POST['celular'] = substr($_SESSION['responsavel']['celular'], 2);
}
...
if(isset($_POST['nome'])){
    if($_POST['nome'] == ''){
        if(isset($_SESSION['identificacao']['nome_resp'])){
            $_POST['nome'] == $_SESSION['identificacao']['nome_resp'];
        }
    }
}
?>
...
<a class='btn' href='dadosPai.php'>Voltar</a>
<a class='btn btn-warning' href='dadosPai.php' <?php
if ($moraComAluno) {
    echo 'style="display: none;"';
}
?>>Pular</a>
