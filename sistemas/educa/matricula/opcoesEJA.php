        ...
        <div class="container">
            ...
            <div class='conteudo'>
                ...
                <div class='row-fluid' style='text-align: center;'>
                    ...
                    include 'fnc/verificaAlunoPossuiRematriculaEJA.php';
                    $possui = verificaAlunoPossuiRematriculaEJA($_SESSION['id']);

                    if($possui == true) {
                        ?>
                        <div>
                            <a class="botaoGrande" href='dadosPessoaisAlunoRematriculaEJA.php?curso=3&ano=2014&periodo=1&tipoMatricula=1'>Realizar Rematrícula - EJA</a>
                        </div>
                        <?php } else { ?>
                            <h4>Aluno não possui vaga de rematricula para a EJA.
                        <?php } ?>
                        <br>
                        <br>
<!--                    <div>
