...
include_once 'fnc/buscaDadosPaisEJA.php';

$dados = buscaDadosPaisEJA($_SESSION['id']);

$_SESSION['pais']['nomeMae'] = $dados[0];
$_SESSION['pais']['escolaridadeMae'] = $dados[1];
$_SESSION['pais']['nomePai'] = $dados[2];
$_SESSION['pais']['escolaridadePai'] = $dados[3];
$_SESSION['pais']['nomeResp'] = $dados[4];
$_SESSION['pais']['escolaridadeResp'] = $dados[5];
                ...
                <div class='row-fluid' style='text-align: center;'>
                    ...
                    <div class="span8 folha" style='display: none;' id='conteudo'>
                        ...
                        <form class="form-horizontal" method="post" onsubmit="">
                            ...
                            <br>
                            <a class='btn' href='dadosEscolaresRematriculaEJA.php'>Voltar</a>
