...
function inserirResponsavelInfantil($dados, $id, $parentesco, $aluno) {
...
//cria pessoa
        ...
        if ($dados['nacionalidade'] == 30) {
            $sql2 = sprintf("INSERT INTO `matricula`.`pessoa_fisica`
                    ...
                    , mysql_real_escape_string($dados['naturalidade'])
