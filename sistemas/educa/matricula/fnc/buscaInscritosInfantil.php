...
function buscaInscritosInfantilIAF($id_escola, $ano, $fase, $curso) {
    ...
    $sql = sprintf("select id_aluno, id_escolha, Lista_Fase_Periodo_Escola_Pessoa_Juridica_Pessoa_id_pessoa, Lista_Fase_Periodo_Fase_id_ano_serie, b.ds_nome, c.id_inscricao
