...
function inserirDadosSaude($saude, $id_pessoa) {
    ...
    if ($saude['outros']['alergia'] == 'sim') {
        $alergia = 1;
    } else {
        if ($saude['outros']['alergia'] == 'nao') {
            $alergia = 0;
        } else {
            $alergia = 2;
        }
    ...
    if(isset($saude['outros']['desAlergia'])){
        $desAlergia = $saude['outros']['desAlergia'];
    } else {
        $desAlergia = '';
    }
    
    if ($saude['outros']['encaminha'] == 'sim') {
        $encaminha = 1;
    } else {
        if ($saude['outros']['encaminha'] == 'nao') {
            $encaminha = 0;
        } else {
            $encaminha = 2;
        }
    ...
    if ($saude['outros']['utilizaOculos'] == 'sim') {
        $oculos = 1;
    } else {
        if ($saude['outros']['utilizaOculos'] == 'nao') {
            $oculos = 0;
        } else {
            $oculos = 2;
        }
...
, mysql_real_escape_string($oculos)
, mysql_real_escape_string($alergia)
, mysql_real_escape_string($encaminha)
, mysql_real_escape_string($desAlergia));
