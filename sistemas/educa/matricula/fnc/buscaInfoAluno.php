...
function buscaInfoAluno($id_aluno) {
    ...
    $sql = sprintf("select r.ds_sexo, r.Etnia_id_etnia, r.id_nacionalidade, r.id_naturalidade, l.Estado_id_estado from matricula.pessoa_fisica r, matricula.localidade l
