        ...
        if ($_POST['dataNascimento'] == '') {
            ...
            if ($_POST['dataNascimento'] == '__/__/____') {
                ...
                if (!verificaDataPassado($_POST['dataNascimento'])) {
                    ...
                    $datatemp1 = explode('/', $_POST['dataNascimento']);
                    if($datatemp1[2] > 2003){
                        $erro['nasc_invalido'];
                    }
                }
...
//cep
    ...
    if (!isset($erro)) {
        ...
        if (!isset($_SESSION['preenchido']['mae'])) {
            (inserirResponsavel($_SESSION['mae'], null, 'mae', $_SESSION['aluno']['id']));
            $_SESSION['preenchido']['mae'] = true;
        } else {
            if ($_SESSION['preenchido']['mae'] != true) {
                (inserirResponsavel($_SESSION['mae'], $_SESSION['mae']['id'], 'mae', $_SESSION['aluno']['id']));
                $_SESSION['preenchido']['mae'] = true;
            } else {
                include 'fnc/atualizarResponsavel.php';
                (atualizarResponsavel($_SESSION['mae'], $_SESSION['mae']['id'], 'mae', $_SESSION['aluno']['id']));
            }
        }

        header("Location: dadosPai.php");
    }
}
                ...
                <div class='row-fluid' style='text-align: center;'>
                    ...
                    <div class="span8 folha" style='display: none;' id='conteudo'>
                        ...
                        <div class="control-group">
                            ...
                            <div class="erro">
                                <strong>Erro!</strong> Preencha um CPF Válido.
                            </div>
                            <?php } ?>
