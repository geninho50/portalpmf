...
if (isset($_SESSION['dados_pessoais']['com_quem_mora'])) {
    $moraComAluno = in_array('outro', $_SESSION['dados_pessoais']['com_quem_mora']);
} else {
    $moraComAluno = false;
}

if($moraComAluno == false){
    header('Location: dadosRendaRematricula.php');
}

include 'fnc/buscaDadosResponsavel.php';
$responsavel = (buscaDadosResponsavel($_SESSION['id']));


if (isset($_SESSION['identificacao']['nome_responsavel'])) {
    $_SESSION['responsavel']['nome'] = $_SESSION['identificacao']['nome_responsavel'];
}

if ($responsavel != false) {
    $_SESSION['responsavel']['nome'] = $responsavel[9];
    $data = explode('-', $responsavel[10]);
    $_SESSION['responsavel']['data_nascimento'] = $data[2] . '/' . $data[1] . '/' . $data[0];
    $_SESSION['responsavel']['cpf'] = substr($responsavel[11], 0, 3) . '.' . substr($responsavel[11], 3, 3) . '.' . substr($responsavel[11], 6, 3) . '-' . substr($responsavel[11], 9, 2);
    $_SESSION['responsavel']['sexo'] = strtolower($responsavel[8]);
    $_SESSION['responsavel']['estado_civil'] = ($responsavel[4]);
    $_SESSION['responsavel']['etnia'] = ($responsavel[1]);
    $_SESSION['responsavel']['escolaridade'] = ($responsavel[7]);
    $_SESSION['responsavel']['profissao'] = ($responsavel[3]);
    $_SESSION['responsavel']['religiao'] = ($responsavel[2]);
    $_SESSION['responsavel']['nacionalidade'] = ($responsavel[5]);
    $_SESSION['responsavel']['naturalidade'] = ($responsavel[12]);
    $_SESSION['responsavel']['naturalidade_municipio'] = ($responsavel[6]);

    include 'fnc/buscaTel.php';
    $telefones = buscaTel($responsavel[0]);
    if (isset($telefones[1])) {
        $_SESSION['responsavel']['celular'] = '(' . $telefones[1][3] . ')' . substr($telefones[1][4], 0, 4) . '-' . substr($telefones[1][4], 4, 4);
    }
    if (isset($telefones[2])) {
        $_SESSION['responsavel']['telefone'] = '(' . $telefones[2][3] . ')' . substr($telefones[2][4], 0, 4) . '-' . substr($telefones[2][4], 4, 4);
    }
    if (isset($telefones[3])) {
        $_SESSION['responsavel']['comercial'] = '(' . $telefones[3][3] . ')' . substr($telefones[3][4], 0, 4) . '-' . substr($telefones[3][4], 4, 4);
    }

    include 'fnc/buscaEmail.php';
    $email = buscaEmail($responsavel[0]);
    if ($email != false) {
        $_SESSION['responsavel']['email'] = $email[0];
    }

    include 'fnc/buscaAlunoEndereco.php';
    $end = buscaAlunoEndereco($responsavel[0]);

    $_SESSION['responsavel']['cep'] = substr($end[11], 0, 2) . '.' . substr($end[11], 2, 3) . '-' . substr($end[11], 5, 3);
    $_SESSION['responsavel']['logradouro'] = $end[6];
    $_SESSION['responsavel']['numero'] = $end[7];
    $_SESSION['responsavel']['complemento'] = $end[8];
    $_SESSION['responsavel']['bairro'] = $end[3];
    $_SESSION['responsavel']['estado'] = $end[5];
    $_SESSION['responsavel']['municipio'] = $end[4];

    $end = buscaTrabalhoEndereco($responsavel[0]);
    if ($end != false) {
        $_SESSION['responsavel']['cep_trabalho'] = substr($end[11], 0, 2) . '.' . substr($end[11], 2, 3) . '-' . substr($end[11], 5, 3);
        $_SESSION['responsavel']['logradouro_trabalho'] = $end[6];
        $_SESSION['responsavel']['numero_trabalho'] = $end[7];
        $_SESSION['responsavel']['complemento_trabalho'] = $end[8];
        $_SESSION['responsavel']['bairro_trabalho'] = $end[3];
        $_SESSION['responsavel']['estado_trabalho'] = $end[5];
        $_SESSION['responsavel']['municipio_trabalho'] = $end[4];
    }
...
//cep
    ...
    if (!isset($erro)) {
        $_SESSION['responsavel']['nome'] = $_POST['nome'];
        $_SESSION['responsavel']['data_nascimento'] = $_POST['dataNascimento'];
        $_SESSION['responsavel']['cpf'] = $_POST['cpf'];
        $_SESSION['responsavel']['sexo'] = $_POST['sexo'];
        $_SESSION['responsavel']['estado_civil'] = $_POST['estadoCivil'];
        $_SESSION['responsavel']['etnia'] = $_POST['etnia'];
        $_SESSION['responsavel']['escolaridade'] = $_POST['escolaridade'];
        $_SESSION['responsavel']['profissao'] = $_POST['profissao'];
        $_SESSION['responsavel']['religiao'] = $_POST['religiao'];
        $_SESSION['responsavel']['nacionalidade'] = $_POST['nacionalidade'];
        $_SESSION['responsavel']['naturalidade'] = $_POST['naturalidade'];
        $_SESSION['responsavel']['naturalidade_municipio'] = $_POST['naturalidadeM'];
        $_SESSION['responsavel']['telefone'] = $_POST['telefone'];
        $_SESSION['responsavel']['celular'] = $_POST['celular'];
        $_SESSION['responsavel']['comercial'] = $_POST['comercial'];
        $_SESSION['responsavel']['email'] = $_POST['email'];
        $_SESSION['responsavel']['cep_trabalho'] = $_POST['cepTrabalho'];
        $_SESSION['responsavel']['logradouro_trabalho'] = $_POST['logradouroTrabalho'];
        $_SESSION['responsavel']['numero_trabalho'] = $_POST['numeroTrabalho'];
        $_SESSION['responsavel']['complemento_trabalho'] = $_POST['complementoTrabalho'];
        $_SESSION['responsavel']['bairro_trabalho'] = $_POST['bairroTrabalho'];
        $_SESSION['responsavel']['estado_trabalho'] = $_POST['estadoTrabalho'];
        $_SESSION['responsavel']['municipio_trabalho'] = $_POST['municipioTrabalho'];
        $_SESSION['responsavel']['cep'] = $_POST['cep'];
        $_SESSION['responsavel']['logradouro'] = $_POST['logradouro'];
        $_SESSION['responsavel']['numero'] = $_POST['numero'];
        $_SESSION['responsavel']['complemento'] = $_POST['complemento'];
        $_SESSION['responsavel']['bairro'] = $_POST['bairro'];
        $_SESSION['responsavel']['estado'] = $_POST['estado'];
        $_SESSION['responsavel']['municipio'] = $_POST['municipio'];
        $_SESSION['responsavel']['mora_aluno'] = $moraComAluno;

        if ($_SESSION['dados_pessoais']['quem_acompanha'] == 'responsavel') {
            $_SESSION['responsavel']['quem_acompanha'] = true;
        } else {
            $_SESSION['responsavel']['quem_acompanha'] = false;
        }
           include 'fnc/inserirResponsavel.php';
                    include 'fnc/atualizarResponsavel.php';
        if(isset($responsavel[0])){
            if($responsavel[0] != ''){
                (atualizarResponsavel($_SESSION['responsavel'], $responsavel[0], 'responsavel', $_SESSION['id']));
            }
        } else {
            if (!isset($_SESSION['preenchido']['responsavel'])) {
                (inserirResponsavel($_SESSION['responsavel'], null, 'responsavel', $_SESSION['id']));
                $_SESSION['preenchido']['responsavel'] = true;
            } else {
                if ($_SESSION['preenchido']['responsavel'] != true) {
                    (inserirResponsavel($_SESSION['responsavel'], $_SESSION['responsavel']['id'], 'responsavel', $_SESSION['id']));
                    $_SESSION['preenchido']['responsavel'] = true;
                }
            }
        }
...
if (isset($_SESSION['responsavel']['nome'])) {
    $_POST['nome'] = $_SESSION['responsavel']['nome'];
}
if (isset($_SESSION['responsavel']['data_nascimento'])) {
    $_POST['dataNascimento'] = $_SESSION['responsavel']['data_nascimento'];
}
if (isset($_SESSION['responsavel']['cpf'])) {
    $_POST['cpf'] = $_SESSION['responsavel']['cpf'];
}
if (isset($_SESSION['responsavel']['sexo'])) {
    $_POST['sexo'] = $_SESSION['responsavel']['sexo'];
}
if (isset($_SESSION['responsavel']['estado_civil'])) {
    $_POST['estadoCivil'] = $_SESSION['responsavel']['estado_civil'];
}
if (isset($_SESSION['responsavel']['etnia'])) {
    $_POST['etnia'] = $_SESSION['responsavel']['etnia'];
}
if (isset($_SESSION['responsavel']['escolaridade'])) {
    $_POST['escolaridade'] = $_SESSION['responsavel']['escolaridade'];
}
if (isset($_SESSION['responsavel']['profissao'])) {
    $_POST['profissao'] = $_SESSION['responsavel']['profissao'];
}
if (isset($_SESSION['responsavel']['religiao'])) {
    $_POST['religiao'] = $_SESSION['responsavel']['religiao'];
}
if (isset($_SESSION['responsavel']['nacionalidade'])) {
    $_POST['nacionalidade'] = $_SESSION['responsavel']['nacionalidade'];
}
if (isset($_SESSION['responsavel']['telefone'])) {
    $_POST['telefone'] = $_SESSION['responsavel']['telefone'];
}
if (isset($_SESSION['responsavel']['celular'])) {
    $_POST['celular'] = $_SESSION['responsavel']['celular'];
}
if (isset($_SESSION['responsavel']['comercial'])) {
    $_POST['comercial'] = $_SESSION['responsavel']['comercial'];
}
if (isset($_SESSION['responsavel']['email'])) {
    $_POST['email'] = $_SESSION['responsavel']['email'];
}
if (isset($_SESSION['responsavel']['cep_trabalho'])) {
    $_POST['cepTrabalho'] = $_SESSION['responsavel']['cep_trabalho'];
}
if (isset($_SESSION['responsavel']['logradouro_trabalho'])) {
    $_POST['logradouroTrabalho'] = $_SESSION['responsavel']['logradouro_trabalho'];
}
if (isset($_SESSION['responsavel']['numero_trabalho'])) {
    $_POST['numeroTrabalho'] = $_SESSION['responsavel']['numero_trabalho'];
}
if (isset($_SESSION['responsavel']['complemento_trabalho'])) {
    $_POST['complementoTrabalho'] = $_SESSION['responsavel']['complemento_trabalho'];
}
if (isset($_SESSION['responsavel']['bairro_trabalho'])) {
    $_POST['bairroTrabalho'] = $_SESSION['responsavel']['bairro_trabalho'];
}
if (isset($_SESSION['responsavel']['estado_trabalho'])) {
    $_POST['estadoTrabalho'] = $_SESSION['responsavel']['estado_trabalho'];
}
if (isset($_SESSION['responsavel']['municipio_trabalho'])) {
    $_POST['municipioTrabalho'] = $_SESSION['responsavel']['municipio_trabalho'];
}
if (isset($_SESSION['responsavel']['cep'])) {
    $_POST['cep'] = $_SESSION['responsavel']['cep'];
}
if (isset($_SESSION['responsavel']['logradouro'])) {
    $_POST['logradouro'] = $_SESSION['responsavel']['logradouro'];
}
if (isset($_SESSION['responsavel']['numero'])) {
    $_POST['numero'] = $_SESSION['responsavel']['numero'];
}
if (isset($_SESSION['responsavel']['complemento'])) {
    $_POST['complemento'] = $_SESSION['responsavel']['complemento'];
}
if (isset($_SESSION['responsavel']['bairro'])) {
    $_POST['bairro'] = $_SESSION['responsavel']['bairro'];
}
if (isset($_SESSION['responsavel']['estado'])) {
    $_POST['estado'] = $_SESSION['responsavel']['estado'];
}
if (isset($_SESSION['responsavel']['municipio'])) {
    $_POST['municipio'] = $_SESSION['responsavel']['municipio'];
}
if (isset($_SESSION['responsavel']['naturalidade'])) {
    $_POST['naturalidade'] = $_SESSION['responsavel']['naturalidade'];
}
if (isset($_SESSION['responsavel']['naturalidade_municipio'])) {
    $_POST['naturalidadeM'] = $_SESSION['responsavel']['naturalidade_municipio'];
}

if($_POST['nome'] == ''){
    $_POST['nome'] == $_SESSION['identificacao']['nome_responsavel'];
}
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="span8 folha" style='display: none;' id='conteudo'>
                        ...
                        <form class="form-horizontal" method="post" 
                            ...
                            <?php } ?>
                                ...
                                <div class="controls">
                                    <input name='cep' type="text" id="inputCEP" data-mask='99.999-999' onchange='buscaEndereco($(this).val(), "inputLogradouro", "inputBairro", "inputMunicipio", "inputEstado");'
                                    <?php
                                    if (isset($_POST['cep'])) {
                                ...
                                ?>>
                                    ...
                                    <div class="controls">
                                        <input name='cepTrabalho' type="text" id="inputCEPTrabalho" data-mask='99.999-999' onchange='buscaEndereco($(this).val(), "inputLogradouroTrabalho", "inputBairroTrabalho", "inputMunicipioTrabalho", "inputEstadoTrabalho");'
                                        <?php
                                        if (isset($_POST['cepTrabalho'])) {
                                    ...
                                    <label class="control-label" for="inputBairroTrabalho">Bairro</label>
                                    <div class="controls">
                                ...
                                <a class='btn' href='dadosPaiRematricula.php'>Voltar</a>
