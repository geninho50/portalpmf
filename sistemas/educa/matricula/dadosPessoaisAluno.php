...
if (!$_SESSION['preenchido']['identificacao']) {
    header("Location: identificacaoAluno.php");
}
                ...
                <div class = 'row-fluid' style = 'text-align: center;'>
                    ...
                    <div class = "span8 folha" style='display: none;' id='conteudo'>
                        ...
                        <div class = "control-group">
                            ...
                            <div class="controls">
                                <input name='rg' type='text'  maxlength="20" placeholder='RG' style='margin-top: 5px;' value='<?php
                                if (isset($_POST['rg'])) {
                                    echo $_POST['rg'];
                                }
                                ?>'/>
                    ...
                    <?php if (isset($erro['termo'])) { ?>
                    <div class="erro">
                        <strong>Erro!</strong> Este campo deve ser preenchido.
                    </div>
                    <?php } ?>
                    ...
                    <?php if (isset($erro['folha']) or isset($erro['livro'])) { ?>
                    <div class="erro">
                        <strong>Erro!</strong> Estes campos devem ser preenchidos.
                    </div>
                    <?php } ?>                 
...
<?php } ?>
<a class='btn' href='identificacaoAluno.php'>Voltar</a>
