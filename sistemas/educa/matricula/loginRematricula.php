    ...
    if (isset($_POST['senha'])) {
        ...
        if ($resultado != FALSE) {
            ...
            if ($_SESSION['perfil'] == 2) {
                $_SESSION['autenticado_rematricula'] = true;
            ...
            <div class='conteudo'>
                <div class='row-fluid' style='text-align: center; height: 90px;'>
                    <div style='text-align: center; padding-top: 15px;'>
                        <h3>Login &middot Rematrícula</h3>
                ...
                <div class='row-fluid' style='text-align: center;'>
                    <form method='post'>
                        <label>
                            ...
                            <input name="usuario" type='text' maxlength="11" required style='width: 150px; text-align: center;'>
                        </label>
                        <label>
