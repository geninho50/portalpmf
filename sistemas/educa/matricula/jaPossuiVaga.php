...
<html lang="en">
    <head>
        ...
        <title>SGE &middot; Aluno com Vaga</title>
                ...
                <div class='row-fluid' style='text-align: center;'>
                    ...
                    <div class="span8 folha">
                        <img src="img/canto.png" style="position: relative; left: -238px; top: -10px;">
                            <h4>Você já possui uma vaga na Rede Municipal de Ensino de Florianópolis. Deseja fazer uma intenção para outra escola?</h4>
                            <h5>Seu número de inscrição: <?php echo buscaInscricao($_SESSION['aluno']['id'])[0]; ?></h5>
                            <h5>Ao realizar uma nova intenção e já possuir uma intenção, a nova escolha irá substituir a escolha anterior.</h5>
                            <br>                            
                            <br>
                            <a class='btn btn-primary' href="novaIntencao.php">Sim</a>
                            <a class='btn btn-warning' href="limpaSessao.php">Não</a>
                    </div>   
                </div>
            </div>
