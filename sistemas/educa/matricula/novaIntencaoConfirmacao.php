...
if(!isset($_GET['escolaNova'])){
    header("Location: novaIntencao.php");
}
if(!isset($_GET['anoNova'])){
    header("Location: novaIntencao.php");
}

if (!isset($_SESSION['intencao'])) {
    include 'fnc/registrarIntencao.php';
    removerIntencao($_SESSION['aluno']['id']);
    $resultado = registrarIntencao($_SESSION['aluno']['id'], $_GET['escolaNova'], 1, $_GET['anoNova'], 2014, 1, 'null');
...
$escola = buscaEscola($_GET['escolaNova'])[$_GET['escolaNova']][1];
$_SESSION['escola']['novaEscola']['id_escola'] = $_GET['escolaNova'];
$_SESSION['escola']['novaEscola']['ano'] = $_GET['anoNova'];
...
<head>
    ...
    <title>SGE &middot; Nova Intenção - Confirma&ccedil;&atilde;o</title>
            ...
            <div class='conteudo'>
                <div class='row-fluid' style='text-align: center; height: 90px;'>
                    <div style='text-align: center; padding-top: 15px;'>
                        <h3>Nova Intenção - Confirma&ccedil;&atilde;o</h3>
                ...
                <div class='row-fluid' style='text-align: center;'>
                    ...
                    <div class="span8 folha">
                        ...
                        <h5>Seu número de inscrição: <?php echo buscaInscricao($_SESSION['aluno']['id'])[0]; ?></h5>
                        <h5>Intenção realizada na unidade: <?php echo $escola;?></h5>

                        <br>
                        <a class='btn btn-info' href="relatorios/emitirFormIntenComVaga.php">Salvar e imprimir comprovante</a>
                        <hr>
                        <a class='btn btn-warning' href="limpaSessao.php">Salvar e Finalizar</a>
                    </div>   
                </div>
            </div>
