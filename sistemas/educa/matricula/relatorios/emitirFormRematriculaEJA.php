...
// Put a hyperlink
    ...
    function DadosEscola($unidadeInscricao) {
        $this->SetFont('Arial', 'BU', 14);
        $this->Cell(53, 5, iconv('utf-8', 'iso-8859-1', 'Dados de Rematrícula:'), 0, 0, 'C');
        $this->SetFont('Arial', 'B', 11);
        $this->SetFont('Arial', 'B', 11);
        $this->Ln(6);
...
// Arial bold 15
$pdf->SetFont('Arial', 'B', 12);
$pdf->Cell(0, 0, iconv('utf-8', 'iso-8859-1', 'Formulário de Rematrícula de Aluno - Educação de Jovens e Adultos'), 0, 0, 'C');
$pdf->Ln(10);
// Line break
