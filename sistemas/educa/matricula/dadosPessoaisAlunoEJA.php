...
if (count($_POST) > 0) {
    if (!isset($erro)) {
        ...
        header("Location: outrosDadosEJA.php");
    }
}

if(isset($_SESSION['dados_pessoais']['nome_aluno'])){
    if($_SESSION['dados_pessoais']['nome_aluno'] == ''){
        if(isset($_POST['nome'])){
            $_SESSION['dados_pessoais']['nome_aluno'] = $_POST['nome'];
        }
    }
...
if(isset($_SESSION['dados_pessoais']['data_nascimento'])){
    if($_SESSION['dados_pessoais']['data_nascimento'] == ''){
        if(isset($_POST['dataNascimento'])){
            $_SESSION['dados_pessoais']['data_nascimento'] = $_POST['dataNascimento'];
        }
    }
...
if(isset($_SESSION['dados_pessoais']['nome_aluno'])){
    $_POST['nome'] = $_SESSION['dados_pessoais']['nome_aluno'];
}

if(isset($_SESSION['dados_pessoais']['data_nascimento'])){
    $_POST['dataNascimento'] = $_SESSION['dados_pessoais']['data_nascimento'];
}
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class = 'conteudo'>
                ...
                <div class = 'row-fluid' style = 'text-align: center;'>
                    ...
                    <div class = "span8 folha" style='display: none;' id='conteudo'>
                        ...
                        <div class = "control-group">
                            ...
                            <div class = "controls">
                                <input onkeypress='verificaCaracteres("#inputNome");' onkeyup='verificaCaracteres("#inputNome");'  name = 'nome' type = "text" id = "inputNome" placeholder = "Nome Completo do Aluno" value = '<?php
                            ...
                            <?php if (isset($erro['nasc_invalido']) or isset($erro['nasc_vazio'])) { ?>
                            <div class="erro">
                                <strong>Erro!</strong> Data inválida, preencha uma data válida.
                            </div>
                            <?php } ?>
                            ...
                            <div class="controls">
                                <input name='rg' type='text' placeholder='RG' maxlength="20" style='margin-top: 5px;' value='<?php
                                if (isset($_POST['rg'])) {
                                    echo $_POST['rg'];
                                }
                                ?>'/>
                ...
                <div class="controls">
                    <input name='novaCertidao' onkeypress='verificaDigitos("#inputNovaCertidao");' onkeyup='verificaDigitos("#inputNovaCertidao");'
                    value='<?php
                    if (isset($_POST['novaCertidao'])) {
