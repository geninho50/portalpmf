...
//     header('Location: dadosPessoaisAlunoRematriculaEJA.php');
// }
...
$utilizouTransporte = buscaUtilizouTransporte($_SESSION['id']);
include 'fnc/buscaOutrosDados.php';
$outrosDados = buscaOutrosDados($_SESSION['id']);
...
if (isset($outrosDados)) {
    if (isset($outrosDados[1])) {
        if ($outrosDados[1] == 0) {
            $_SESSION['outrosDados']['precisara_transporte'] = 'nao';
        } else {
            if ($outrosDados[1] == 1) {
                $_SESSION['outrosDados']['precisara_transporte'] = 'sim';
            }
        }
    }
...
<head>
    ...
    <?php } ?>     
    <br>
    <a class='btn' href="dadosPessoaisAlunoRematriculaEJA.php">Voltar</a>
