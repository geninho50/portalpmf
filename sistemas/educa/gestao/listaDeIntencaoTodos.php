...
$fasesF = buscaFases(1);
        ...
        if (isset($_GET['fase'])) {
            ...
            $intencao = buscaIntencaoTodos(1, 2014, $_GET['fase']);
        }
...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>SGE &middot; Lista de Intenção - Todas Escolas</title>
...
<?php include 'shared/topo.php'; ?>
            ...
            <div class='conteudo' style='min-height: 500px;'>
                <div class='row-fluid' style='text-align: center; padding-top: 20px;'>
                    <h2 style='font-size:30px;'>Lista de Intenção - Todas Escolas</h1>
                </div>
                <hr>
                <div class="row-fluid">
