...
if (isset($_SESSION['novo_aluno_infantil']['dados_pessoais']['com_quem_mora'])) {
    $moraComAluno = in_array('pai', $_SESSION['novo_aluno_infantil']['dados_pessoais']['com_quem_mora']);
} else {
    $moraComAluno = false;
}
...
//cep
    ...
    if (!isset($erro)) {
        $_SESSION['novo_aluno_infantil']['pai']['nome'] = $_POST['nome'];
        $_SESSION['novo_aluno_infantil']['pai']['data_nascimento'] = $_POST['dataNascimento'];
        $_SESSION['novo_aluno_infantil']['pai']['cpf'] = $_POST['cpf'];
        $_SESSION['novo_aluno_infantil']['pai']['sexo'] = $_POST['sexo'];
        $_SESSION['novo_aluno_infantil']['pai']['estado_civil'] = $_POST['estadoCivil'];
        $_SESSION['novo_aluno_infantil']['pai']['etnia'] = $_POST['etnia'];
        $_SESSION['novo_aluno_infantil']['pai']['escolaridade'] = $_POST['escolaridade'];
        $_SESSION['novo_aluno_infantil']['pai']['profissao'] = $_POST['profissao'];
        $_SESSION['novo_aluno_infantil']['pai']['religiao'] = $_POST['religiao'];
        $_SESSION['novo_aluno_infantil']['pai']['nacionalidade'] = $_POST['nacionalidade'];
        $_SESSION['novo_aluno_infantil']['pai']['naturalidade'] = $_POST['naturalidade'];
        $_SESSION['novo_aluno_infantil']['pai']['naturalidade_municipio'] = $_POST['naturalidadeM'];
        $_SESSION['novo_aluno_infantil']['pai']['telefone'] = $_POST['ufTelefone'] . $_POST['telefone'];
        $_SESSION['novo_aluno_infantil']['pai']['celular'] = $_POST['ufCelular'] . $_POST['celular'];
        $_SESSION['novo_aluno_infantil']['pai']['comercial'] = $_POST['ufComercial'] . $_POST['comercial'];
        $_SESSION['novo_aluno_infantil']['pai']['email'] = $_POST['email'];
        $_SESSION['novo_aluno_infantil']['pai']['cep_trabalho'] = $_POST['cepTrabalho'];
        $_SESSION['novo_aluno_infantil']['pai']['logradouro_trabalho'] = $_POST['logradouroTrabalho'];
        $_SESSION['novo_aluno_infantil']['pai']['numero_trabalho'] = $_POST['numeroTrabalho'];
        $_SESSION['novo_aluno_infantil']['pai']['complemento_trabalho'] = $_POST['complementoTrabalho'];
        $_SESSION['novo_aluno_infantil']['pai']['bairro_trabalho'] = $_POST['bairroTrabalho'];
        $_SESSION['novo_aluno_infantil']['pai']['estado_trabalho'] = $_POST['estadoTrabalho'];
        $_SESSION['novo_aluno_infantil']['pai']['municipio_trabalho'] = $_POST['municipioTrabalho'];
        $_SESSION['novo_aluno_infantil']['pai']['cep'] = $_POST['cep'];
        $_SESSION['novo_aluno_infantil']['pai']['logradouro'] = $_POST['logradouro'];
        $_SESSION['novo_aluno_infantil']['pai']['numero'] = $_POST['numero'];
        $_SESSION['novo_aluno_infantil']['pai']['complemento'] = $_POST['complemento'];
        $_SESSION['novo_aluno_infantil']['pai']['bairro'] = $_POST['bairro'];
        $_SESSION['novo_aluno_infantil']['pai']['estado'] = $_POST['estado'];
        $_SESSION['novo_aluno_infantil']['pai']['municipio'] = $_POST['municipio'];
        $_SESSION['novo_aluno_infantil']['pai']['mora_aluno'] = $moraComAluno;
        $_SESSION['novo_aluno_infantil']['pai']['turnos'] = $_POST['turnos'];

        if ($_SESSION['novo_aluno_infantil']['dados_pessoais']['quem_acompanha'] == 'pai') {
            $_SESSION['novo_aluno_infantil']['pai']['quem_acompanha'] = true;
        }

        include 'fnc/inserirResponsavel.php';
        if (!isset($_SESSION['novo_aluno_infantil']['preenchido']['pai'])) {
            (inserirResponsavel($_SESSION['pai'], null, 'pai', $_SESSION['aluno']['id']));
            $_SESSION['novo_aluno_infantil']['preenchido']['pai'] = true;
        } else {
            if ($_SESSION['novo_aluno_infantil']['preenchido']['pai'] != true) {
        ...
        header("Location: dadosResponsavelInfantil.php");
    }
}
...
if (isset($_SESSION['novo_aluno_infantil']['pai']['turnos'])) {
    $_POST['turnos'] = $_SESSION['novo_aluno_infantil']['pai']['turnos'];
}
if (isset($_SESSION['novo_aluno_infantil']['pai']['nome'])) {
    $_POST['nome'] = $_SESSION['novo_aluno_infantil']['pai']['nome'];
}
if (isset($_SESSION['novo_aluno_infantil']['pai']['data_nascimento'])) {
    $_POST['dataNascimento'] = $_SESSION['novo_aluno_infantil']['pai']['data_nascimento'];
}
if (isset($_SESSION['novo_aluno_infantil']['pai']['cpf'])) {
    $_POST['cpf'] = $_SESSION['novo_aluno_infantil']['pai']['cpf'];
}
if (isset($_SESSION['novo_aluno_infantil']['pai']['sexo'])) {
    $_POST['sexo'] = $_SESSION['novo_aluno_infantil']['pai']['sexo'];
}
if (isset($_SESSION['novo_aluno_infantil']['pai']['estado_civil'])) {
    $_POST['estadoCivil'] = $_SESSION['novo_aluno_infantil']['pai']['estado_civil'];
}
if (isset($_SESSION['novo_aluno_infantil']['pai']['etnia'])) {
    $_POST['etnia'] = $_SESSION['novo_aluno_infantil']['pai']['etnia'];
}
if (isset($_SESSION['novo_aluno_infantil']['pai']['escolaridade'])) {
    $_POST['escolaridade'] = $_SESSION['novo_aluno_infantil']['pai']['escolaridade'];
}
if (isset($_SESSION['novo_aluno_infantil']['pai']['profissao'])) {
    $_POST['profissao'] = $_SESSION['novo_aluno_infantil']['pai']['profissao'];
}
if (isset($_SESSION['novo_aluno_infantil']['pai']['religiao'])) {
    $_POST['religiao'] = $_SESSION['novo_aluno_infantil']['pai']['religiao'];
}
if (isset($_SESSION['novo_aluno_infantil']['pai']['nacionalidade'])) {
    $_POST['nacionalidade'] = $_SESSION['novo_aluno_infantil']['pai']['nacionalidade'];
}
if (isset($_SESSION['novo_aluno_infantil']['pai']['telefone'])) {
    $_POST['ufTelefone'] = substr($_SESSION['novo_aluno_infantil']['pai']['telefone'], 0, 2);
    $_POST['telefone'] = substr($_SESSION['novo_aluno_infantil']['pai']['telefone'], 2);
}
if (isset($_SESSION['novo_aluno_infantil']['pai']['comercial'])) {
    $_POST['ufComercial'] = substr($_SESSION['novo_aluno_infantil']['pai']['comercial'], 0, 2);
    $_POST['comercial'] = substr($_SESSION['novo_aluno_infantil']['pai']['comercial'], 2);
}
if (isset($_SESSION['novo_aluno_infantil']['pai']['celular'])) {
    $_POST['ufCelular'] = substr($_SESSION['novo_aluno_infantil']['pai']['celular'], 0, 2);
    $_POST['celular'] = substr($_SESSION['novo_aluno_infantil']['pai']['celular'], 2);
}
if (isset($_SESSION['novo_aluno_infantil']['pai']['email'])) {
    $_POST['email'] = $_SESSION['novo_aluno_infantil']['pai']['email'];
}
if (isset($_SESSION['novo_aluno_infantil']['pai']['cep_trabalho'])) {
    $_POST['cepTrabalho'] = $_SESSION['novo_aluno_infantil']['pai']['cep_trabalho'];
}
if (isset($_SESSION['novo_aluno_infantil']['pai']['logradouro_trabalho'])) {
    $_POST['logradouroTrabalho'] = $_SESSION['novo_aluno_infantil']['pai']['logradouro_trabalho'];
}
if (isset($_SESSION['novo_aluno_infantil']['pai']['numero_trabalho'])) {
    $_POST['numeroTrabalho'] = $_SESSION['novo_aluno_infantil']['pai']['numero_trabalho'];
}
if (isset($_SESSION['novo_aluno_infantil']['pai']['complemento_trabalho'])) {
    $_POST['complementoTrabalho'] = $_SESSION['novo_aluno_infantil']['pai']['complemento_trabalho'];
}
if (isset($_SESSION['novo_aluno_infantil']['pai']['bairro_trabalho'])) {
    $_POST['bairroTrabalho'] = $_SESSION['novo_aluno_infantil']['pai']['bairro_trabalho'];
}
if (isset($_SESSION['novo_aluno_infantil']['pai']['estado_trabalho'])) {
    $_POST['estadoTrabalho'] = $_SESSION['novo_aluno_infantil']['pai']['estado_trabalho'];
}
if (isset($_SESSION['novo_aluno_infantil']['pai']['municipio_trabalho'])) {
    $_POST['municipioTrabalho'] = $_SESSION['novo_aluno_infantil']['pai']['municipio_trabalho'];
}
if (isset($_SESSION['novo_aluno_infantil']['pai']['cep'])) {
    $_POST['cep'] = $_SESSION['novo_aluno_infantil']['pai']['cep'];
}
if (isset($_SESSION['novo_aluno_infantil']['pai']['logradouro'])) {
    $_POST['logradouro'] = $_SESSION['novo_aluno_infantil']['pai']['logradouro'];
}
if (isset($_SESSION['novo_aluno_infantil']['pai']['numero'])) {
    $_POST['numero'] = $_SESSION['novo_aluno_infantil']['pai']['numero'];
}
if (isset($_SESSION['novo_aluno_infantil']['pai']['complemento'])) {
    $_POST['complemento'] = $_SESSION['novo_aluno_infantil']['pai']['complemento'];
}
if (isset($_SESSION['novo_aluno_infantil']['pai']['bairro'])) {
    $_POST['bairro'] = $_SESSION['novo_aluno_infantil']['pai']['bairro'];
}
if (isset($_SESSION['novo_aluno_infantil']['pai']['estado'])) {
    $_POST['estado'] = $_SESSION['novo_aluno_infantil']['pai']['estado'];
}
if (isset($_SESSION['novo_aluno_infantil']['pai']['municipio'])) {
    $_POST['municipio'] = $_SESSION['novo_aluno_infantil']['pai']['municipio'];
}
if (isset($_SESSION['novo_aluno_infantil']['pai']['naturalidade'])) {
    $_POST['naturalidade'] = $_SESSION['novo_aluno_infantil']['pai']['naturalidade'];
}
if (isset($_SESSION['novo_aluno_infantil']['pai']['naturalidade_municipio'])) {
    $_POST['naturalidadeM'] = $_SESSION['novo_aluno_infantil']['pai']['naturalidade_municipio'];
}
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="span8 folha">
                        ...
                        <form class="form-horizontal" method="post" 
                            ...
                            <div class="control-group">
                                ...
                                <a class='btn btn-warning' href='dadosResponsavelInfantil.php' <?php
                                if ($moraComAluno) {
                                    echo 'style="display: none;"';
                                }
                                ?>>Pular</a>
