...
if (count($_POST) > 0) {
    if (isset($_SESSION['renda']['pessoasFund'])) {
        ...
        inserirRenda($_SESSION['renda']['pessoasFund'], $_GET['idAluno']);
        ...
        if (!isset($erro)) {
            ...
            include_once 'fnc/insereAuditoriaEditarRendaFundamental.php';
            insereAuditoriaEditarRendaFundamentalOutras(0, $_GET['idAluno'], $_SESSION['usuario']['id'], 99);
            insereAuditoriaEditarRendaFundamental($_SESSION['renda']['pessoasFund'], $_GET['idAluno'], $_SESSION['usuario']['id']);
            insereAuditoriaEditarRendaFundamentalOutras($_POST['pensao'], $_GET['idAluno'], $_SESSION['usuario']['id'], 2);
            insereAuditoriaEditarRendaFundamentalOutras($_POST['bolsa'], $_GET['idAluno'], $_SESSION['usuario']['id'], 3);
            $sucesso = true;
        }
    }
}
                    ...
                    <div class="row-fluid">
                        <div class="span12" style='padding: 20px; padding-top: 0px;'>
                            ...
                            <div class="span11" style="position:relative; left: -5px; display: none; text-align: center;" id='conteudo'>
                                ...
                                <?php
                                if (isset($_SESSION['renda']['pessoasFund'])) {
                                    if (count($_SESSION['renda']['pessoasFund']) > 0) {
                                        ?>
                                        <table class="table" style='margin-left: 5px; border: 1px solid #9a9aff; border-radius: 5px; font-size: 13px;'>
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th title="Parentesco">Parentesco</th>
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($_SESSION['renda']['pessoasFund'] as $key => $value) {
                                                    $soma = $soma + $value[2];
                                                    $temp = $value[0];
                                                    if (strlen($temp) > 20) {
                                                    ...
                                                    echo '<td style="text-align:center;"><a href="removePessoaEditarRendaFundamental.php?numero=' . $key . '&idAluno='.$_GET['idAluno'].'"><i class="iconic-x" style="color:red; font-size: 16px;
                                ...
                                <form id='form1' class="form-horizontal" method='post' action="adicionarPessoaEditarRendaFundamental.php?idAluno=<?php echo $_GET['idAluno']; ?>">
