...
<head>
    <meta charset="utf-8">
    <title>SGE &middot; Relatório de Crianças em Intenção sem Vaga com Endereço - Infantil</title>
        ...
        <div class="container">
            ...
            <div class='conteudo' style='min-height: 500px;'>
                <div class='row-fluid' style='text-align: center; padding-top: 20px;'>
                    <h2 style='font-size:30px;'>Relatório de Crianças em Intenção sem Vaga com Endereço - Infantil</h1>
                    </div>
                    <hr>
                    <div class="row-fluid">
                        <div class="span12" style='padding: 20px; padding-top: 0px;'>
                            <form action="relatorios/geraRelatorioAlunosIntencaoInfantilSemVagaEndereco.php">
