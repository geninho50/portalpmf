...
include 'fnc/buscaAlunosRematriculaEJA.php';
$matriculados = buscaAlunosRematriculaEJA();
...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>SGE &middot; Lista de Alunos para Rematricula - EJA</title>
...
<?php include 'shared/topo.php'; ?>
            ...
            <div class='conteudo' style='min-height: 500px;'>
                <div class='row-fluid' style='text-align: center; padding-top: 20px;'>
                    <h2 style='font-size:30px;'> Lista de Alunos para Rematricula - EJA</h1>
                </div>
                <hr>
                <div class="row-fluid">
