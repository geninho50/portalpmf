...
include 'fnc/buscaAlunosExcluidosFund.php';

$matriculados = buscaAlunosExcluidosFund();
...
<head>
    <meta charset="utf-8">
    <title>SGE &middot; Lista de Vagas Excluídas - Fundamental</title>
        ...
        <div class="container">
            ...
            <div class='conteudo' style='min-height: 500px;'>
                <div class='row-fluid' style='text-align: center; padding-top: 20px;'>
                    <h2 style='font-size:30px;'>Lista de Vagas Excluídas - Fundamental</h2>
                    </div>
                    <hr>
                    <div class="row-fluid">
                        <div class="span12" style='padding: 20px; padding-top: 0px;'>
                            ...
                            <div id='matriculados' style='display: inherit;'>
                                <table class='table table-striped table-bordered' id='tabela' style='font-size: 10px;'>
                                    <thead>
                                        <tr>
