...
//cep
    ...
    if (!isset($erro)) {
        ...
        $sucesso = $resultado;
        if($sucesso == true){
            include_once 'fnc/insereAuditoriaEditarDadosMaeFundamental.php';
            insereAuditoriaEditarDadosMaeFundamental($dadosPessoais, $_GET['idAluno'], $_SESSION['usuario']['id']);
        }
    }
}
...
<head>
    <meta charset="utf-8">
    <title>SGE &middot; Dados do Mãe do Aluno</title>
                        ...
                        <div class="span12" style='padding: 20px; padding-top: 0px;'>
                            ...
                            if(isset($sucesso)){
                                if($sucesso){
                                    ?>
                                    <div class="sucesso">
                                        <strong>Sucesso!</strong> Dados do Mãe atualizados!
                                    </div>
                                    <?php
                                } else {
                                    ?>
