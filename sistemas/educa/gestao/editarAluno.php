            ...
            <div class='conteudo' style='min-height: 500px;'>
                ...
                <div class="row-fluid">
                    <div class="span12" style='padding: 20px; padding-top: 0px;'>
                        <a class='btn btn-primary' style="line-height: 40px;" href='dadosPessoaisAluno.php?idAluno=<?php echo $_GET['idAluno']; ?>'>Dados Pessoais</a>
                        <a class='btn btn-primary disabled' style="line-height: 40px;">Dados de Saúde</a>
                        <a class='btn btn-primary disabled' style="line-height: 40px;">Dados de Localização</a>
                        <a class='btn btn-primary disabled' style="line-height: 40px;">Dados dos Pais</a>
                        <hr>
