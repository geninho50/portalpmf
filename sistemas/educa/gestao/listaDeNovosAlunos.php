...
include 'fnc/buscaNovosAlunos.php';
if (isset($_GET['escola'])) {
    if (isset($_GET['ano'])) {
        if (isset($_GET['fase'])) {
            if (($_GET['escola'] == 0) && ($_GET['ano'] == 0) && ($_GET['fase'] == 0)) {
                $matriculados = buscaNovosAlunos(1);
            } else {
                if (($_GET['escola'] == 0) && ($_GET['ano'] != 0) && ($_GET['fase'] != 0)) {
                    $matriculados = buscaNovosAlunosAF($_GET['ano'], $_GET['fase'], 1);
                } else {
                    if (($_GET['escola'] != 0) && ($_GET['ano'] == 0) && ($_GET['fase'] != 0)) {
                        $matriculados = buscaNovosAlunosIF($_GET['escola'], $_GET['fase'], 1);
                    } else {
                        if (($_GET['escola'] != 0) && ($_GET['ano'] != 0) && ($_GET['fase'] == 0)) {
                            $matriculados = buscaNovosAlunosIA($_GET['escola'], $_GET['ano'], 1);
                        } else {
                            if (($_GET['escola'] != 0) && ($_GET['ano'] == 0) && ($_GET['fase'] == 0)) {
                                $matriculados = buscaNovosAlunosI($_GET['escola'], 1);
                            } else {
                                if (($_GET['escola'] == 0) && ($_GET['ano'] != 0) && ($_GET['fase'] == 0)) {
                                    $matriculados = buscaNovosAlunosA($_GET['ano'], 1);
                                } else {
                                    if (($_GET['escola'] == 0) && ($_GET['ano'] == 0) && ($_GET['fase'] != 0)) {
                                        $matriculados = buscaNovosAlunosF($_GET['fase'], 1);
                                    } else {
                                        if (($_GET['escola'] != 0) && ($_GET['ano'] != 0) && ($_GET['fase'] != 0)) {
                                            $matriculados = buscaNovosAlunosIAF($_GET['escola'], $_GET['ano'], $_GET['fase'], 1);
                                        }
                                    }
                                }
                            }
...
<head>
    <meta charset="utf-8">
    <title>SGE &middot; Lista de Novos Alunos</title>
        ...
        <div class="container">
            ...
            <div class='conteudo' style='min-height: 500px;'>
                <div class='row-fluid' style='text-align: center; padding-top: 20px;'>
                    <h2 style='font-size:30px;'>Lista de Novos Alunos</h1>
                    </div>
                    <hr>
                    <div class="row-fluid">
                                ...
                                <table class='table table-striped table-bordered' id='tabela'>
                                    <thead>
                                        <tr>
                                            ...
                                            <td style='width: 50px; font-size:10px;'>Escola</td>
...
//                                                echo '</td>';
                                                    echo '<a title="Imprimir Cadastro" href="emitirCadastroFundamental.php?inscricao=' .
                                                    $value[0] . '"><i class="iconic-document-alt-stroke"></i></a>';
                                                    echo '</td>';
                                                    echo '</tr>';
                                                }
                                            }
