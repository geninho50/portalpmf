...
if($_SESSION['usuario']['permissoes'][11][1] != 1){
    header('Location: index.php');
}
?>
<!DOCTYPE html>
...
<?php include 'shared/topo.php'; ?>
  ...
  <div class='conteudo' style='min-height: 500px;'>
      <div class='row-fluid' style='text-align: center; padding-top: 20px;'>
        <h2 style='font-size:30px;'>Quadro de Vagas</h1>
        </div>
        <hr>
        <div class="row-fluid">
            ...
            <div>
              <div class="tab-pane" id="tabEndereco">
                <div style='display: inherit;'>
                    <a class='btn btn-primary' style='line-height: 40px;' href='listaDeVagas.php'>Lista de Vagas</a>
                    <a class='btn btn-primary' style='line-height: 40px;' href='definirVagas.php'>Definir Vagas</a>
                    <hr>
                    <a href="opcoes.php" class="btn pull-right">Voltar</a>
                </div>
            </div>
