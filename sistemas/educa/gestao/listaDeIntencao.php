...
<head>
    <meta charset="utf-8">
    <title>SGE &middot; Lista de Intenção</title>
                            ...
                            if ($intencao != false) {
                                ...
                                foreach ($intencao as $key => $value) {
                                    ...
                                    //                 echo '&nbsp;';
                                        ...
                                        echo '<a href="visualizarSituacao.php?idPessoa='.$value[1].'"><i class="iconic-magnifying-glass" style="color: blue"></i></a>';
                                        echo '&nbsp;';
                                        ...
                                        if(($_SESSION['usuario']['permissoes'][12][1] == 1)){
                                            ...
                                            echo '&nbsp;';    
                                             ...
                                             if(($_SESSION['usuario']['perfil'] == 5)OR($_SESSION['usuario']['perfil'] == 7)OR($_SESSION['usuario']['perfil'] == 9)OR($_SESSION['usuario']['perfil'] == 10)){
                                                 if($i == 2){
                                                   echo '<a title="Atender" href="#modalAtender" role="button" data-toggle="modal"
                                                     onclick="passarInfo(' . $value[3] . ', ' . $aspa . $value[2] . $aspa . ', ' . $value[1] . ');"
                                                     ><i class="iconic-check" style="color: green"></i></a>';
