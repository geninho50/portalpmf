        ...
        <div class="container">
            ...
            <div class='conteudo' style='min-height: 500px;'>
                <div class='row-fluid' style='text-align: center; padding-top: 20px;'>
                    <h2 style='font-size:30px;'>Editar Escola</h1>
                        <h4><?php echo ($escola[1][1]); ?></h4>
                </div>
                <hr>
                <div class="row-fluid">
                    <div class="span12" style='padding: 20px; padding-top: 0px;'>
                        <a class='btn btn-primary' style='line-height: 40px;' href='alterarEnderecoEscola.php?idEscola=<?php echo $_GET['idEscola']; ?>'>Alterar Endereço</a>
                        <a class='btn btn-primary' style='line-height: 40px;' href='adicionarFaseEscola.php?idEscola=<?php echo $_GET['idEscola']; ?>'>Adicionar Fase</a>
                        <hr>
