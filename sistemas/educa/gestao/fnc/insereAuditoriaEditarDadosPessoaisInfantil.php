...
function insereAuditoriaEditarDadosPessoaisInfantil($dadosPessoais, $id_pessoa, $id_usuario) {
    ...
    $sql = sprintf("INSERT INTO `matricula`.`auditoria_dados_pessoais_infantil`
        (`id_aluno`,
            `id_etnia`,
            `id_naturalidade`,
            `ds_sexo`,
