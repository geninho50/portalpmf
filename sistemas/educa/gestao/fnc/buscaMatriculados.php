...
function buscaMatriculadosIAF($id_escola, $ano, $fase, $curso) {
    ...
    $sql = sprintf("SELECT b.id_inscricao, 
            ...
            if(a.Tipo_Vaga_id_tipo_vaga = 1, 'Novo Aluno', if(a.Tipo_Vaga_id_tipo_vaga = 3, 'Reserva', 'Rematrícula')),
...
function buscaMatriculadosEJA() {
    ...
    $sql = sprintf("SELECT b.id_inscricao, 
            ...
            a.Fase_Periodo_Escola_Pessoa_Juridica_Pessoa_id_pessoa,
            d.id_nucleo
            FROM matricula.vaga a, matricula.aluno b, matricula.pessoa_fisica c, matricula.aluno_eja d
            where a.Aluno_Pessoa_Fisica_Pessoa_id_pessoa is not null
            and a.Fase_Periodo_Fase_Curso_id_curso = 3
            and id_nucleo is not null
            and a.Aluno_Pessoa_Fisica_Pessoa_id_pessoa = d.id_pessoa
            and a.Aluno_Pessoa_Fisica_Pessoa_id_pessoa = b.Pessoa_Fisica_Pessoa_id_pessoa
            and a.Aluno_Pessoa_Fisica_Pessoa_id_pessoa = c.Pessoa_id_pessoa"
            , mysql_real_escape_string('%d/%m/%Y'));
