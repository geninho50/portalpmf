...
function buscaNovosAlunosIAF($id_escola, $ano, $fase, $curso) {
    ...
    $sql = sprintf("SELECT b.id_inscricao, 
            ...
            if(a.Tipo_Vaga_id_tipo_vaga = 1, 'Novo Aluno', 'Reserva'),
...
function buscaNovosAlunosIA($id_escola, $ano, $fase, $curso) {
...
function buscaNovosAlunosAF($ano, $fase, $curso) {
...
function buscaNovosAlunosIF($id_escola, $fase, $curso) {
...
function buscaNovosAlunosI($id_escola, $curso) {
...
function buscaNovosAlunosA($ano, $curso) {
...
function buscaNovosAlunosF($fase, $curso) {
...
function buscaNovosAlunos($curso) {
