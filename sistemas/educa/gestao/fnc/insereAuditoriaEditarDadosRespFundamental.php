...
function insereAuditoriaEditarDadosRespFundamental($dadosPessoais, $id_pessoa, $id_usuario) {
    ...
    if(!isset($dadosPessoais['naturalidade_municipio'])){
        ...
        if($dadosPessoais['naturalidade_municipio'] == ''){
            $dadosPessoais['naturalidade_municipio'] = 'null';
        }
    }
    ...
    $sql = sprintf("INSERT INTO `matricula`.`auditoria_dados_resp_fundamental`
        (`id_aluno`,
            `id_etnia`,
            `id_religiao`,
            `id_profissao`,
