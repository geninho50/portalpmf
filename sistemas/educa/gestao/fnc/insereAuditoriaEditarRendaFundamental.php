...
function insereAuditoriaEditarRendaFundamental($renda, $id_pessoa, $id_usuario) {
    ...
    foreach ($renda as $key => $value) {
        ...
        $sql = sprintf("INSERT INTO `matricula`.`auditoria_renda_fundamental`
            (`id_aluno`,
                `tipo_renda`,
                `comprovacao`,
...
function insereAuditoriaEditarRendaFundamentalOutras($renda, $id_pessoa, $id_usuario, $tipo) {
