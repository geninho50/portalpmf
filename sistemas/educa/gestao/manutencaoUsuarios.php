...
<?php include 'shared/topo.php'; ?>
            ...
            <div class='conteudo' style='min-height: 500px;'>
                <div class='row-fluid' style='text-align: center; padding-top: 20px;'>
                    <h2 style='font-size:30px;'>Manutenção de Usuários</h1>
                    </div>
                    <hr>
                    <div class="row-fluid">
                        <div class="span12" style='padding: 20px; padding-top: 0px;'>
                            <div id="opcoes" style="height: 350px;">
                                <?php if($_SESSION['usuario']['permissoes'][10][1] == 1){ ?>
                                <a class='btn btn-primary' href="listaDeUsuarios.php" style='line-height: 40px;'>Lista de Usuários</a>
                                <?php } ?>
                                <a class='btn btn-primary' href="adicionarUsuario.php" style='line-height: 40px;'>Adicionar Usuário</a>
                                <hr>
