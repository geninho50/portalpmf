    ...
    if (count($_POST) > 0) {
        ...
        //ATUALIZAR COM QUEM MORA, QUEM ACOMPANHA
            if($inseriuDados == true){
                $sucesso = true;
                include_once 'fnc/insereAuditoriaEditarDadosPessoaisFundamental.php';
                insereAuditoriaEditarDadosPessoaisFundamental($dadosAluno['dados_pessoais'], $_GET['idAluno'], $_SESSION['usuario']['id']);
            } else {
                $sucesso = false;
            }
        }
