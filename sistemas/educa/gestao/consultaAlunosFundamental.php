...
if(isset($_GET['nome']) || isset($_GET['inscricao'])){
    ...
    $alunos = consultaAlunoFundamental($_GET['nome'], $_GET['inscricao']);
}
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="container">
            ...
            <div class='conteudo' style='min-height: 500px;'>
                <div class='row-fluid' style='text-align: center; padding-top: 20px;'>
                    <h2 style='font-size:30px;'>Consulta de Alunos</h2>
                                        ...
                                        if (isset($alunos)) {
                                            if ($alunos != false) {
                                                foreach ($alunos as $key => $value) {
                                                    ...
                                                    echo '&nbsp;';
                                                    echo '<a href="relatorios/emitirFormCadastroFundamental.php?idAluno='.$value[0].'"><i class="iconic-document-alt-stroke" style="color: green"></i></a>';
                                                    echo '&nbsp;'; 
