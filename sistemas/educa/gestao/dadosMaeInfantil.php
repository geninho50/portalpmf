...
if (!$_SESSION['novo_aluno_infantil']['preenchido']['saude']) {
...
if (isset($_SESSION['novo_aluno_infantil']['dados_pessoais']['com_quem_mora'])) {
    $moraComAluno = in_array('mae', $_SESSION['novo_aluno_infantil']['dados_pessoais']['com_quem_mora']);
} else {
    $moraComAluno = false;
}
...
//cep
    ...
    if (!isset($erro)) {
        $_SESSION['novo_aluno_infantil']['mae']['nome'] = $_POST['nome'];
        $_SESSION['novo_aluno_infantil']['mae']['data_nascimento'] = $_POST['dataNascimento'];
        $_SESSION['novo_aluno_infantil']['mae']['cpf'] = $_POST['cpf'];
        $_SESSION['novo_aluno_infantil']['mae']['sexo'] = $_POST['sexo'];
        $_SESSION['novo_aluno_infantil']['mae']['estado_civil'] = $_POST['estadoCivil'];
        $_SESSION['novo_aluno_infantil']['mae']['etnia'] = $_POST['etnia'];
        $_SESSION['novo_aluno_infantil']['mae']['escolaridade'] = $_POST['escolaridade'];
        $_SESSION['novo_aluno_infantil']['mae']['profissao'] = $_POST['profissao'];
        $_SESSION['novo_aluno_infantil']['mae']['religiao'] = $_POST['religiao'];
        $_SESSION['novo_aluno_infantil']['mae']['nacionalidade'] = $_POST['nacionalidade'];
        $_SESSION['novo_aluno_infantil']['mae']['naturalidade'] = $_POST['naturalidade'];
        $_SESSION['novo_aluno_infantil']['mae']['naturalidade_municipio'] = $_POST['naturalidadeM'];
        $_SESSION['novo_aluno_infantil']['mae']['telefone'] = $_POST['ufTelefone'] . $_POST['telefone'];
        $_SESSION['novo_aluno_infantil']['mae']['celular'] = $_POST['ufCelular'] . $_POST['celular'];
        $_SESSION['novo_aluno_infantil']['mae']['comercial'] = $_POST['ufComercial'] . $_POST['comercial'];
        $_SESSION['novo_aluno_infantil']['mae']['email'] = $_POST['email'];
        $_SESSION['novo_aluno_infantil']['mae']['cep_trabalho'] = $_POST['cepTrabalho'];
        $_SESSION['novo_aluno_infantil']['mae']['logradouro_trabalho'] = $_POST['logradouroTrabalho'];
        $_SESSION['novo_aluno_infantil']['mae']['numero_trabalho'] = $_POST['numeroTrabalho'];
        $_SESSION['novo_aluno_infantil']['mae']['complemento_trabalho'] = $_POST['complementoTrabalho'];
        $_SESSION['novo_aluno_infantil']['mae']['bairro_trabalho'] = $_POST['bairroTrabalho'];
        $_SESSION['novo_aluno_infantil']['mae']['estado_trabalho'] = $_POST['estadoTrabalho'];
        $_SESSION['novo_aluno_infantil']['mae']['municipio_trabalho'] = $_POST['municipioTrabalho'];
        $_SESSION['novo_aluno_infantil']['mae']['cep'] = $_POST['cep'];
        $_SESSION['novo_aluno_infantil']['mae']['logradouro'] = $_POST['logradouro'];
        $_SESSION['novo_aluno_infantil']['mae']['numero'] = $_POST['numero'];
        $_SESSION['novo_aluno_infantil']['mae']['complemento'] = $_POST['complemento'];
        $_SESSION['novo_aluno_infantil']['mae']['bairro'] = $_POST['bairro'];
        $_SESSION['novo_aluno_infantil']['mae']['estado'] = $_POST['estado'];
        $_SESSION['novo_aluno_infantil']['mae']['municipio'] = $_POST['municipio'];
        $_SESSION['novo_aluno_infantil']['mae']['mora_aluno'] = $moraComAluno;
        $_SESSION['novo_aluno_infantil']['mae']['turnos'] = $_POST['turnos'];

        if ($_SESSION['novo_aluno_infantil']['dados_pessoais']['quem_acompanha'] == 'pai') {
            $_SESSION['novo_aluno_infantil']['mae']['quem_acompanha'] = true;
        }

        include 'fnc/inserirResponsavel.php';
        if (!isset($_SESSION['novo_aluno_infantil']['preenchido']['mae'])) {
            (inserirResponsavel($_SESSION['mae'], null, 'pai', $_SESSION['aluno']['id']));
            $_SESSION['novo_aluno_infantil']['preenchido']['mae'] = true;
        } else {
            if ($_SESSION['novo_aluno_infantil']['preenchido']['mae'] != true) {
                (inserirResponsavel($_SESSION['mae'], $_SESSION['mae']['id'], 'pai', $_SESSION['aluno']['id']));
                $_SESSION['novo_aluno_infantil']['preenchido']['mae'] = true;
            } else {
                include 'fnc/atualizarResponsavel.php';
                (atualizarResponsavel($_SESSION['mae'], $_SESSION['mae']['id'], 'pai', $_SESSION['aluno']['id']));
            }
        }
        header("Location: dadosPaiInfantil.php");
    }
}
...
if (isset($_SESSION['novo_aluno_infantil']['mae']['turnos'])) {
    $_POST['turnos'] = $_SESSION['novo_aluno_infantil']['mae']['turnos'];
}
if (isset($_SESSION['novo_aluno_infantil']['mae']['nome'])) {
    $_POST['nome'] = $_SESSION['novo_aluno_infantil']['mae']['nome'];
}
if (isset($_SESSION['novo_aluno_infantil']['mae']['data_nascimento'])) {
    $_POST['dataNascimento'] = $_SESSION['novo_aluno_infantil']['mae']['data_nascimento'];
}
if (isset($_SESSION['novo_aluno_infantil']['mae']['cpf'])) {
    $_POST['cpf'] = $_SESSION['novo_aluno_infantil']['mae']['cpf'];
}
if (isset($_SESSION['novo_aluno_infantil']['mae']['sexo'])) {
    $_POST['sexo'] = $_SESSION['novo_aluno_infantil']['mae']['sexo'];
}
if (isset($_SESSION['novo_aluno_infantil']['mae']['estado_civil'])) {
    $_POST['estadoCivil'] = $_SESSION['novo_aluno_infantil']['mae']['estado_civil'];
}
if (isset($_SESSION['novo_aluno_infantil']['mae']['etnia'])) {
    $_POST['etnia'] = $_SESSION['novo_aluno_infantil']['mae']['etnia'];
}
if (isset($_SESSION['novo_aluno_infantil']['mae']['escolaridade'])) {
    $_POST['escolaridade'] = $_SESSION['novo_aluno_infantil']['mae']['escolaridade'];
}
if (isset($_SESSION['novo_aluno_infantil']['mae']['profissao'])) {
    $_POST['profissao'] = $_SESSION['novo_aluno_infantil']['mae']['profissao'];
}
if (isset($_SESSION['novo_aluno_infantil']['mae']['religiao'])) {
    $_POST['religiao'] = $_SESSION['novo_aluno_infantil']['mae']['religiao'];
}
if (isset($_SESSION['novo_aluno_infantil']['mae']['nacionalidade'])) {
    $_POST['nacionalidade'] = $_SESSION['novo_aluno_infantil']['mae']['nacionalidade'];
}
if (isset($_SESSION['novo_aluno_infantil']['mae']['telefone'])) {
    $_POST['ufTelefone'] = substr($_SESSION['novo_aluno_infantil']['mae']['telefone'], 0, 2);
    $_POST['telefone'] = substr($_SESSION['novo_aluno_infantil']['mae']['telefone'], 2);
}
if (isset($_SESSION['novo_aluno_infantil']['mae']['comercial'])) {
    $_POST['ufComercial'] = substr($_SESSION['novo_aluno_infantil']['mae']['comercial'], 0, 2);
    $_POST['comercial'] = substr($_SESSION['novo_aluno_infantil']['mae']['comercial'], 2);
}
if (isset($_SESSION['novo_aluno_infantil']['mae']['celular'])) {
    $_POST['ufCelular'] = substr($_SESSION['novo_aluno_infantil']['mae']['celular'], 0, 2);
    $_POST['celular'] = substr($_SESSION['novo_aluno_infantil']['mae']['celular'], 2);
}
if (isset($_SESSION['novo_aluno_infantil']['mae']['email'])) {
    $_POST['email'] = $_SESSION['novo_aluno_infantil']['mae']['email'];
}
if (isset($_SESSION['novo_aluno_infantil']['mae']['cep_trabalho'])) {
    $_POST['cepTrabalho'] = $_SESSION['novo_aluno_infantil']['mae']['cep_trabalho'];
}
if (isset($_SESSION['novo_aluno_infantil']['mae']['logradouro_trabalho'])) {
    $_POST['logradouroTrabalho'] = $_SESSION['novo_aluno_infantil']['mae']['logradouro_trabalho'];
}
if (isset($_SESSION['novo_aluno_infantil']['mae']['numero_trabalho'])) {
    $_POST['numeroTrabalho'] = $_SESSION['novo_aluno_infantil']['mae']['numero_trabalho'];
}
if (isset($_SESSION['novo_aluno_infantil']['mae']['complemento_trabalho'])) {
    $_POST['complementoTrabalho'] = $_SESSION['novo_aluno_infantil']['mae']['complemento_trabalho'];
}
if (isset($_SESSION['novo_aluno_infantil']['mae']['bairro_trabalho'])) {
    $_POST['bairroTrabalho'] = $_SESSION['novo_aluno_infantil']['mae']['bairro_trabalho'];
}
if (isset($_SESSION['novo_aluno_infantil']['mae']['estado_trabalho'])) {
    $_POST['estadoTrabalho'] = $_SESSION['novo_aluno_infantil']['mae']['estado_trabalho'];
}
if (isset($_SESSION['novo_aluno_infantil']['mae']['municipio_trabalho'])) {
    $_POST['municipioTrabalho'] = $_SESSION['novo_aluno_infantil']['mae']['municipio_trabalho'];
}
if (isset($_SESSION['novo_aluno_infantil']['mae']['cep'])) {
    $_POST['cep'] = $_SESSION['novo_aluno_infantil']['mae']['cep'];
}
if (isset($_SESSION['novo_aluno_infantil']['mae']['logradouro'])) {
    $_POST['logradouro'] = $_SESSION['novo_aluno_infantil']['mae']['logradouro'];
}
if (isset($_SESSION['novo_aluno_infantil']['mae']['numero'])) {
    $_POST['numero'] = $_SESSION['novo_aluno_infantil']['mae']['numero'];
}
if (isset($_SESSION['novo_aluno_infantil']['mae']['complemento'])) {
    $_POST['complemento'] = $_SESSION['novo_aluno_infantil']['mae']['complemento'];
}
if (isset($_SESSION['novo_aluno_infantil']['mae']['bairro'])) {
    $_POST['bairro'] = $_SESSION['novo_aluno_infantil']['mae']['bairro'];
}
if (isset($_SESSION['novo_aluno_infantil']['mae']['estado'])) {
    $_POST['estado'] = $_SESSION['novo_aluno_infantil']['mae']['estado'];
}
if (isset($_SESSION['novo_aluno_infantil']['mae']['municipio'])) {
    $_POST['municipio'] = $_SESSION['novo_aluno_infantil']['mae']['municipio'];
}
if (isset($_SESSION['novo_aluno_infantil']['mae']['naturalidade'])) {
    $_POST['naturalidade'] = $_SESSION['novo_aluno_infantil']['mae']['naturalidade'];
}
if (isset($_SESSION['novo_aluno_infantil']['mae']['naturalidade_municipio'])) {
    $_POST['naturalidadeM'] = $_SESSION['novo_aluno_infantil']['mae']['naturalidade_municipio'];
}
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="span8 folha">
                        ...
                        <form class="form-horizontal" method="post" 
                            ...
                            <div class="control-group">
                                ...
                                <a class="btn" href="dadosSaudeInfantil.php">Voltar</a>
                                <a class='btn btn-warning' href='dadosPaiInfantil.php' <?php
                                if ($moraComAluno) {
                                    echo 'style="display: none;"';
                                }
                                ?>>Pular</a>
