...
$pdf->Ln(6);
$pdf->Cell(0, 10, utf8_decode('Relatório - Crianças Atendidas com Endereço'),0,0,'C');
...
//GRUPO 1
    $sql = sprintf("select p.id_inscricao, k.ds_nome, concat_ws(', ',ds_logradouro, ds_numero), l.ds_nome from (select a.Aluno_Pessoa_Fisica_Pessoa_id_pessoa, b.ds_nome, c.ds_logradouro, c.ds_numero, c.Bairro_id_bairro from matricula.vaga a, matricula.pessoa_fisica b 
        ...
        and a.Fase_Periodo_Fase_id_ano_serie = 10
        and a.Aluno_Pessoa_Fisica_Pessoa_id_pessoa = b.Pessoa_id_pessoa) k, matricula.bairro l, matricula.aluno p
    where k.Bairro_id_bairro = l.id_bairro
    and p.Pessoa_Fisica_Pessoa_id_pessoa = k.Aluno_Pessoa_Fisica_Pessoa_id_pessoa
...
//GRUPO 1
    $sql = sprintf("select p.id_inscricao, k.ds_nome, concat_ws(', ',ds_logradouro, ds_numero), l.ds_nome from (select a.Aluno_Pessoa_Fisica_Pessoa_id_pessoa, b.ds_nome, c.ds_logradouro, c.ds_numero, c.Bairro_id_bairro from matricula.vaga a, matricula.pessoa_fisica b 
        ...
        and a.Fase_Periodo_Fase_Curso_id_curso = 2
        and a.Fase_Periodo_Escola_Pessoa_Juridica_Pessoa_id_pessoa = %s
        and a.Fase_Periodo_Fase_id_ano_serie = 11
        and a.Aluno_Pessoa_Fisica_Pessoa_id_pessoa = b.Pessoa_id_pessoa) k, matricula.bairro l, matricula.aluno p
    where k.Bairro_id_bairro = l.id_bairro
    and p.Pessoa_Fisica_Pessoa_id_pessoa = k.Aluno_Pessoa_Fisica_Pessoa_id_pessoa
    order by k.ds_nome", mysql_real_escape_string($_GET['idEscola']));
...
//GRUPO 1
    $sql = sprintf("select p.id_inscricao, k.ds_nome, concat_ws(', ',ds_logradouro, ds_numero), l.ds_nome from (select a.Aluno_Pessoa_Fisica_Pessoa_id_pessoa, b.ds_nome, c.ds_logradouro, c.ds_numero, c.Bairro_id_bairro from matricula.vaga a, matricula.pessoa_fisica b 
        ...
        and a.Fase_Periodo_Fase_Curso_id_curso = 2
        and a.Fase_Periodo_Escola_Pessoa_Juridica_Pessoa_id_pessoa = %s
        and a.Fase_Periodo_Fase_id_ano_serie = 12
        and a.Aluno_Pessoa_Fisica_Pessoa_id_pessoa = b.Pessoa_id_pessoa) k, matricula.bairro l, matricula.aluno p
    where k.Bairro_id_bairro = l.id_bairro
    and p.Pessoa_Fisica_Pessoa_id_pessoa = k.Aluno_Pessoa_Fisica_Pessoa_id_pessoa
    order by k.ds_nome", mysql_real_escape_string($_GET['idEscola']));
...
//GRUPO 1
    $sql = sprintf("select p.id_inscricao, k.ds_nome, concat_ws(', ',ds_logradouro, ds_numero), l.ds_nome from (select a.Aluno_Pessoa_Fisica_Pessoa_id_pessoa, b.ds_nome, c.ds_logradouro, c.ds_numero, c.Bairro_id_bairro from matricula.vaga a, matricula.pessoa_fisica b 
        ...
        and a.Fase_Periodo_Fase_Curso_id_curso = 2
        and a.Fase_Periodo_Escola_Pessoa_Juridica_Pessoa_id_pessoa = %s
        and a.Fase_Periodo_Fase_id_ano_serie = 13
        and a.Aluno_Pessoa_Fisica_Pessoa_id_pessoa = b.Pessoa_id_pessoa) k, matricula.bairro l, matricula.aluno p
    where k.Bairro_id_bairro = l.id_bairro
    and p.Pessoa_Fisica_Pessoa_id_pessoa = k.Aluno_Pessoa_Fisica_Pessoa_id_pessoa
    order by k.ds_nome", mysql_real_escape_string($_GET['idEscola']));
...
//GRUPO 1
    $sql = sprintf("select p.id_inscricao, k.ds_nome, concat_ws(', ',ds_logradouro, ds_numero), l.ds_nome from (select a.Aluno_Pessoa_Fisica_Pessoa_id_pessoa, b.ds_nome, c.ds_logradouro, c.ds_numero, c.Bairro_id_bairro from matricula.vaga a, matricula.pessoa_fisica b 
        ...
        and a.Fase_Periodo_Fase_Curso_id_curso = 2
        and a.Fase_Periodo_Escola_Pessoa_Juridica_Pessoa_id_pessoa = %s
        and a.Fase_Periodo_Fase_id_ano_serie = 14
        and a.Aluno_Pessoa_Fisica_Pessoa_id_pessoa = b.Pessoa_id_pessoa) k, matricula.bairro l, matricula.aluno p
    where k.Bairro_id_bairro = l.id_bairro
    and p.Pessoa_Fisica_Pessoa_id_pessoa = k.Aluno_Pessoa_Fisica_Pessoa_id_pessoa
    order by k.ds_nome", mysql_real_escape_string($_GET['idEscola']));
...
//GRUPO 1
    $sql = sprintf("select p.id_inscricao, k.ds_nome, concat_ws(', ',ds_logradouro, ds_numero), l.ds_nome from (select a.Aluno_Pessoa_Fisica_Pessoa_id_pessoa, b.ds_nome, c.ds_logradouro, c.ds_numero, c.Bairro_id_bairro from matricula.vaga a, matricula.pessoa_fisica b 
        ...
        and a.Fase_Periodo_Fase_Curso_id_curso = 2
        and a.Fase_Periodo_Escola_Pessoa_Juridica_Pessoa_id_pessoa = %s
        and a.Fase_Periodo_Fase_id_ano_serie = 15
        and a.Aluno_Pessoa_Fisica_Pessoa_id_pessoa = b.Pessoa_id_pessoa) k, matricula.bairro l, matricula.aluno p
    where k.Bairro_id_bairro = l.id_bairro
    and p.Pessoa_Fisica_Pessoa_id_pessoa = k.Aluno_Pessoa_Fisica_Pessoa_id_pessoa
    order by k.ds_nome", mysql_real_escape_string($_GET['idEscola']));
