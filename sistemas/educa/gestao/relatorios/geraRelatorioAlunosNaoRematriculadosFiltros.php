...
// Page footer
    ...
    // Data
        ...
        foreach($data as $row)
        {
            ...
            $this->Cell($w[3],5, utf8_decode(buscaEscola($row[3])[1][1]),'LR',0,'C',$fill);
...
$sql = sprintf("select b.id_inscricao, 
    ...
    where a.Fase_Periodo_Fase_id_ano_serie = %s
...
$pdf->Cell(0, 10, utf8_decode(buscaEscola($_GET['escola'])[1][1]),0,0,'C');
$pdf->Ln(6);
