...
if (!isset($_SESSION['novo_aluno_infantil'])) {
    header("Location: ../index.php");
}
...
// Data
        ...
        foreach ($data as $row) {
            ...
            $this->Cell($w[5], 6, utf8_decode($row[5]), 'LR', 0, 'R', $fill);
            $this->Ln();
            $fill = !$fill;
        }
// Closing line
...
// Put a hyperlink
    ...
    function DadosPai($nome, $sexo, $dataNasc, $etnia, $estadoCivil, $escolaridade, $religiao, $profissao, $cpf) {
        ...
        $this->Cell(26, 5, iconv('utf-8', 'iso-8859-1', 'Profissão*: '), 0, 0, 'C');
        $this->SetFont('Arial', '', 11);
        $this->Cell(40, 5, iconv('utf-8', 'iso-8859-1', $profissao), 1, 0, 'C');
        $this->SetFont('Arial', 'B', 11);
        $this->Cell(26, 5, iconv('utf-8', 'iso-8859-1', 'CPF*: '), 0, 0, 'C');
        $this->SetFont('Arial', '', 11);
        $this->Cell(30, 5, iconv('utf-8', 'iso-8859-1', $cpf), 1, 0, 'C');
    ...
    function DadosEscola($priOpcao, $segOpcao, $unidadeInscricao, $nomePessoa, $grupo) {
        ...
        $this->SetFont('Arial', '', 11);
        $this->Cell(100, 5, utf8_decode($unidadeInscricao[1][1]), 1, 0, 'C');
        $this->Ln(6);
        $this->SetFont('Arial', 'B', 11);
    ...
    function Comprovante($priOpcao, $segOpcao, $unidadeInscricao, $nomePessoa, $grupo) {
        $this->Ln(5);
        $this->SetFont('Arial', 'BU', 13);
        ...
        $this->SetFont('Arial', '', 11);
        $this->Cell(150, 5, iconv('utf-8', 'iso-8859-1', $_SESSION['novo_aluno_infantil']['dados_pessoais']['nome']), 1, 0, 'C');
        $this->Ln(6);
        $this->Cell(35, 5, iconv('utf-8', 'iso-8859-1', 'Grupo:'), 0, 0, 'C');
        $this->SetFont('Arial', '', 11);
        $this->Cell(150, 5, iconv('utf-8', 'iso-8859-1', $grupo), 1, 0, 'C');
...
$nome = $_SESSION['novo_aluno_infantil']['dados_pessoais']['nome'];
if ($_SESSION['novo_aluno_infantil']['dados_pessoais']['sexo'] == 'm') {
    $sexo = 'Masculino';
} else {
    $sexo = 'Feminino';
}
$dataNasc = $_SESSION['novo_aluno_infantil']['dados_pessoais']['data_nascimento'];
include '../fnc/buscaEtnia.php';
$etnia = buscaEtnia($_SESSION['novo_aluno_infantil']['dados_pessoais']['etnia'])[1];
$rg = '';
$orgao = '';
$uf_rg = '';
$dt_rg = '';
if ($_SESSION['novo_aluno_infantil']['dados_pessoais']['rg']['possui'] == 'sim') {
    $rg = $_SESSION['novo_aluno_infantil']['dados_pessoais']['rg']['numero'];
    $orgao = $_SESSION['novo_aluno_infantil']['dados_pessoais']['rg']['orgao_rg'];
    $uf_rg = $_SESSION['novo_aluno_infantil']['dados_pessoais']['rg']['uf_rg'];
    $dt_rg = $_SESSION['novo_aluno_infantil']['dados_pessoais']['rg']['data_rg'];
}
$termo = '';
$folha = '';
$livro = '';
...
if ($_SESSION['novo_aluno_infantil']['dados_pessoais']['certidao']['tipo_certidao'] == 'antigo') {
    $termo = $_SESSION['novo_aluno_infantil']['dados_pessoais']['certidao']['termo'];
    $folha = $_SESSION['novo_aluno_infantil']['dados_pessoais']['certidao']['folha'];
    $livro = $_SESSION['novo_aluno_infantil']['dados_pessoais']['certidao']['livro'];
    $cartorio = $_SESSION['novo_aluno_infantil']['dados_pessoais']['certidao']['cartorio'];
    $uf_cart = $_SESSION['novo_aluno_infantil']['dados_pessoais']['certidao']['uf_cart'];
} else {
    if ($_SESSION['novo_aluno_infantil']['dados_pessoais']['certidao']['tipo_certidao'] == 'novo') {
        $numero = $_SESSION['novo_aluno_infantil']['dados_pessoais']['certidao']['numero'];
    }
}

include '../fnc/buscaNacionalidade.php';
$pais = buscaNacionalidade($_SESSION['novo_aluno_infantil']['dados_pessoais']['nacionalidade'])[1][1];
include '../fnc/buscaMunicipio.php';
include '../fnc/buscaEstado.php';
if ($pais == 'Brasil') {
    $cidade = buscaMunicipio($_SESSION['novo_aluno_infantil']['dados_pessoais']['naturalidade']['municipio'])[1][1];
    $estado = buscaNomeEstado($_SESSION['novo_aluno_infantil']['dados_pessoais']['naturalidade']['uf'])[2];
}

if (in_array('mae', $_SESSION['novo_aluno_infantil']['dados_pessoais']['com_quem_mora'])) {
    $cqmMae = 'X';
} else {
    $cqmMae = '';
}
if (in_array('pai', $_SESSION['novo_aluno_infantil']['dados_pessoais']['com_quem_mora'])) {
    $cqmPai = 'X';
} else {
    $cqmPai = '';
}
if (in_array('outro', $_SESSION['novo_aluno_infantil']['dados_pessoais']['com_quem_mora'])) {
    $cqmResp = 'X';
} else {
    $cqmResp = '';
}
...
if ($_SESSION['novo_aluno_infantil']['dados_pessoais']['quem_acompanha'] == 'mae') {
    $qaMae = 'X';
    $qaPai = '';
    $qaResp = '';
} else {
...
if (isset($_SESSION['novo_aluno_infantil']['dados_pessoais']['telefones']['residencial'])) {
    $residencialAluno = '(' .
        substr($_SESSION['novo_aluno_infantil']['dados_pessoais']['telefones']['residencial'], 0, 2) . ')' .
substr($_SESSION['novo_aluno_infantil']['dados_pessoais']['telefones']['residencial'], 2);
}
if (isset($_SESSION['novo_aluno_infantil']['dados_pessoais']['telefones']['comercial'])) {
    $comercialAluno = '(' .
        substr($_SESSION['novo_aluno_infantil']['dados_pessoais']['telefones']['comercial'], 0, 2) . ')' .
substr($_SESSION['novo_aluno_infantil']['dados_pessoais']['telefones']['comercial'], 2);
}
if (isset($_SESSION['novo_aluno_infantil']['dados_pessoais']['telefones']['celular'])) {
    $celularAluno = '(' .
        substr($_SESSION['novo_aluno_infantil']['dados_pessoais']['telefones']['celular'], 0, 2) . ')' .
substr($_SESSION['novo_aluno_infantil']['dados_pessoais']['telefones']['celular'], 2);
}
$cep = $_SESSION['novo_aluno_infantil']['localizacao']['cep'];
$logradouro = $_SESSION['novo_aluno_infantil']['localizacao']['logradouro'];
$numeroEnd = $_SESSION['novo_aluno_infantil']['localizacao']['numero'];
$complemento = $_SESSION['novo_aluno_infantil']['localizacao']['complemento'];
include '../fnc/buscaBairro.php';
if ($_SESSION['novo_aluno_infantil']['localizacao']['bairro']) {
    if ($_SESSION['novo_aluno_infantil']['localizacao']['bairro'] != '') {
        $id = ($_SESSION['novo_aluno_infantil']['localizacao']['bairro']);
        $bairro = buscaBairro($_SESSION['novo_aluno_infantil']['localizacao']['bairro'])[$id][1];
    }
}
$urbana = '';
$rural = '';
if ($_SESSION['novo_aluno_infantil']['outrosDados']['zona_moradia'] == 'urbana') {
    $urbana = 'X';
    $rural = '';
} else {
    $urbana = '';
...
if ($_SESSION['novo_aluno_infantil']['outrosDados']['autoriza_uso'] == 'sim') {
    $autorizaUso = true;
} else {
    $autorizaUso = false;
}
if ($_SESSION['novo_aluno_infantil']['outrosDados']['tempo_residencia'] < 5) {
    $tempoResidencia = true;
} else {
    $tempoResidencia = false;
}
$contraTurno = $_SESSION['novo_aluno_infantil']['outrosDados']['local_permanencia'];
$anemia = $_SESSION['novo_aluno_infantil']['saude']['outros']['anemia'];
$diabetes = $_SESSION['novo_aluno_infantil']['saude']['outros']['diabetes'];
$lactose = $_SESSION['novo_aluno_infantil']['saude']['outros']['intoleranciaLactose'];
$gluten = $_SESSION['novo_aluno_infantil']['saude']['outros']['intoleranciaGluten'];
$refluxo = $_SESSION['novo_aluno_infantil']['saude']['outros']['refluxo'];
$deficiencias = $_SESSION['novo_aluno_infantil']['saude']['deficiencias'];
$recursos = $_SESSION['novo_aluno_infantil']['saude']['recursos'];
$moradia = $_SESSION['novo_aluno_infantil']['outrosDados']['moradia'];
if ($_SESSION['novo_aluno_infantil']['outrosDados']['bolsa_familia'] == 'sim') {
    $bolsaFamilia = true;
} else {
    $bolsaFamilia = false;
}
if ($_SESSION['novo_aluno_infantil']['outrosDados']['possui_computador'] == 'sim') {
    $possuiComputador = true;
} else {
    $possuiComputador = false;
}
if ($_SESSION['novo_aluno_infantil']['outrosDados']['carro'] == 'sim') {
    $carro = true;
} else {
    $carro = false;
}
$localAcesso = strtolower($_SESSION['novo_aluno_infantil']['outrosDados']['acesso_internet']);
...
if (isset($_SESSION['novo_aluno_infantil']['mae'])) {
    $nomeMae = $_SESSION['novo_aluno_infantil']['mae']['nome'];
    $dataNascMae = $_SESSION['novo_aluno_infantil']['mae']['data_nascimento'];
    if ($_SESSION['novo_aluno_infantil']['mae']['sexo'] == 'm') {
        $sexoMae = 'Masculino';
    } else {
        $sexoMae = 'Feminino';
    }
    $etniaMae = buscaEtnia($_SESSION['novo_aluno_infantil']['mae']['etnia'])[1];
    $religiaoMae = buscaReligiao($_SESSION['novo_aluno_infantil']['mae']['religiao'])[1];
    $profissaoMae = buscaProfissao($_SESSION['novo_aluno_infantil']['mae']['profissao'])[1];
    $cpfMae = $_SESSION['novo_aluno_infantil']['mae']['cpf'];

    $estadoCivilMae = $_SESSION['novo_aluno_infantil']['mae']['estado_civil'];
    $escolaridadeMae = $_SESSION['novo_aluno_infantil']['mae']['escolaridade'];
    $cepMae = $_SESSION['novo_aluno_infantil']['mae']['cep'];
    $logradouroMae = $_SESSION['novo_aluno_infantil']['mae']['logradouro'];
    $numeroEndMae = $_SESSION['novo_aluno_infantil']['mae']['numero'];
    $complementoMae = $_SESSION['novo_aluno_infantil']['mae']['complemento'];
    $bairroMae = $_SESSION['novo_aluno_infantil']['mae']['bairro'];
    $cidadeMae = buscaMunicipio($_SESSION['novo_aluno_infantil']['mae']['municipio'])[1][1];
    $ufMae = buscaNomeEstado($_SESSION['novo_aluno_infantil']['mae']['estado'])[2];

    if ($_SESSION['novo_aluno_infantil']['mae']['cep_trabalho']) {
        $cepTrabalhoMae = $_SESSION['novo_aluno_infantil']['mae']['cep_trabalho'];
        $logradouroTrabalhoMae = $_SESSION['novo_aluno_infantil']['mae']['logradouro_trabalho'];
        $numeroEndTrabalhoMae = $_SESSION['novo_aluno_infantil']['mae']['numero_trabalho'];
        $complementoTrabalhoMae = $_SESSION['novo_aluno_infantil']['mae']['complemento_trabalho'];
        $bairroTrabalhoMae = $_SESSION['novo_aluno_infantil']['mae']['bairro_trabalho'];
        $cidadeTrabalhoMae = buscaMunicipio($_SESSION['novo_aluno_infantil']['mae']['municipio_trabalho'])[1][1];
        $ufTrabalhoMae = buscaNomeEstado($_SESSION['novo_aluno_infantil']['mae']['estado_trabalho'])[2];
    } else {
        $cepTrabalhoMae = '';
    ...
    $comercialMae = '';
    $celularMae = '';
    if (isset($_SESSION['novo_aluno_infantil']['mae']['telefone'])) {
        $residencialMae = '(' .
            substr($_SESSION['novo_aluno_infantil']['mae']['telefone'], 0, 2) . ')' .
substr($_SESSION['novo_aluno_infantil']['mae']['telefone'], 2);
} else {
    $residencialMae = '';
}
if (isset($_SESSION['novo_aluno_infantil']['mae']['comercial'])) {
    $comercialMae = '(' .
        substr($_SESSION['novo_aluno_infantil']['mae']['comercial'], 0, 2) . ')' .
substr($_SESSION['novo_aluno_infantil']['mae']['comercial'], 2);
} else {
    $comercialMae = '';
}
if (isset($_SESSION['novo_aluno_infantil']['mae']['celular'])) {
    $celularMae = '(' .
        substr($_SESSION['novo_aluno_infantil']['mae']['celular'], 0, 2) . ')' .
substr($_SESSION['novo_aluno_infantil']['mae']['celular'], 2);
} else {
    $celularMae = '';
}
$turnosMae = $_SESSION['novo_aluno_infantil']['mae']['turnos'];
} else {
    $nomeMae = '';
    $dataNascMae = '';
    $sexoMae = '';
...
if (isset($_SESSION['novo_aluno_infantil']['pai'])) {
    $nomePai = $_SESSION['novo_aluno_infantil']['pai']['nome'];
    $dataNascPai = $_SESSION['novo_aluno_infantil']['pai']['data_nascimento'];
    if ($_SESSION['novo_aluno_infantil']['pai']['sexo'] == 'm') {
        $sexoPai = 'Masculino';
    } else {
        $sexoPai = 'Feminino';
    }
    $etniaPai = buscaEtnia($_SESSION['novo_aluno_infantil']['pai']['etnia'])[1];
    $religiaoPai = buscaReligiao($_SESSION['novo_aluno_infantil']['pai']['religiao'])[1];
    $profissaoPai = buscaProfissao($_SESSION['novo_aluno_infantil']['pai']['profissao'])[1];
    $cpfPai = $_SESSION['novo_aluno_infantil']['pai']['cpf'];

    $estadoCivilPai = $_SESSION['novo_aluno_infantil']['pai']['estado_civil'];
    $escolaridadePai = $_SESSION['novo_aluno_infantil']['pai']['escolaridade'];
    $cepPai = $_SESSION['novo_aluno_infantil']['pai']['cep'];
    $logradouroPai = $_SESSION['novo_aluno_infantil']['pai']['logradouro'];
    $numeroEndPai = $_SESSION['novo_aluno_infantil']['pai']['numero'];
    $complementoPai = $_SESSION['novo_aluno_infantil']['pai']['complemento'];
    $bairroPai = $_SESSION['novo_aluno_infantil']['pai']['bairro'];
    $cidadePai = buscaMunicipio($_SESSION['novo_aluno_infantil']['pai']['municipio'])[1][1];
    $ufPai = buscaNomeEstado($_SESSION['novo_aluno_infantil']['pai']['estado'])[2];

    if (isset($_SESSION['novo_aluno_infantil']['pai']['cep_trabalho'])) {
        if($_SESSION['novo_aluno_infantil']['pai']['cep_trabalho'] != ''){
            $cepTrabalhoPai = $_SESSION['novo_aluno_infantil']['pai']['cep_trabalho'];
            $logradouroTrabalhoPai = $_SESSION['novo_aluno_infantil']['pai']['logradouro_trabalho'];
            $numeroEndTrabalhoPai = $_SESSION['novo_aluno_infantil']['pai']['numero_trabalho'];
            $complementoTrabalhoPai = $_SESSION['novo_aluno_infantil']['pai']['complemento_trabalho'];
            $bairroTrabalhoPai = $_SESSION['novo_aluno_infantil']['pai']['bairro_trabalho'];
            $cidadeTrabalhoPai = buscaMunicipio($_SESSION['novo_aluno_infantil']['pai']['municipio_trabalho'])[1][1];
            $ufTrabalhoPai = buscaNomeEstado($_SESSION['novo_aluno_infantil']['pai']['estado_trabalho'])[2];
        } else {
            $cepTrabalhoPai = '';
    ...
    $comercialPai = '';
    $celularPai = '';
    if (isset($_SESSION['novo_aluno_infantil']['pai']['telefone'])) {
        $residencialPai = '(' .
            substr($_SESSION['novo_aluno_infantil']['pai']['telefone'], 0, 2) . ')' .
substr($_SESSION['novo_aluno_infantil']['pai']['telefone'], 2);
} else {
    $residencialPai = '';
}
if (isset($_SESSION['novo_aluno_infantil']['pai']['comercial'])) {
    $comercialPai = '(' .
        substr($_SESSION['novo_aluno_infantil']['pai']['comercial'], 0, 2) . ')' .
substr($_SESSION['novo_aluno_infantil']['pai']['comercial'], 2);
} else {
    $comercialPai = '';
}
if (isset($_SESSION['novo_aluno_infantil']['pai']['celular'])) {
    $celularPai = '(' .
        substr($_SESSION['novo_aluno_infantil']['pai']['celular'], 0, 2) . ')' .
substr($_SESSION['novo_aluno_infantil']['pai']['celular'], 2);
} else {
    $celularPai = '';
}
$turnosPai = $_SESSION['novo_aluno_infantil']['pai']['turnos'];
} else {
    $nomePai = '';
    $dataNascPai = '';
    $sexoPai = '';
...
if (isset($_SESSION['novo_aluno_infantil']['responsavel'])) {
    $nomeResp = $_SESSION['novo_aluno_infantil']['responsavel']['nome'];
    $dataNascResp = $_SESSION['novo_aluno_infantil']['responsavel']['data_nascimento'];
    if ($_SESSION['novo_aluno_infantil']['responsavel']['sexo'] == 'm') {
        $sexoResp = 'Masculino';
    } else {
        $sexoResp = 'Feminino';
    }
    $etniaResp = buscaEtnia($_SESSION['novo_aluno_infantil']['responsavel']['etnia'])[1];
    $religiaoResp = buscaReligiao($_SESSION['novo_aluno_infantil']['responsavel']['religiao'])[1];
    $profissaoResp = buscaProfissao($_SESSION['novo_aluno_infantil']['responsavel']['profissao'])[1];
    $cpfResp = $_SESSION['novo_aluno_infantil']['responsavel']['cpf'];

    $estadoCivilResp = $_SESSION['novo_aluno_infantil']['responsavel']['estado_civil'];
    $escolaridadeResp = $_SESSION['novo_aluno_infantil']['responsavel']['escolaridade'];

    if (isset($_SESSION['novo_aluno_infantil']['responsavel']['cep_trabalho'])) {
        $cepTrabalhoResp = $_SESSION['novo_aluno_infantil']['responsavel']['cep_trabalho'];
        $logradouroTrabalhoResp = $_SESSION['novo_aluno_infantil']['responsavel']['logradouro_trabalho'];
        $numeroEndTrabalhoResp = $_SESSION['novo_aluno_infantil']['responsavel']['numero_trabalho'];
        $complementoTrabalhoResp = $_SESSION['novo_aluno_infantil']['responsavel']['complemento_trabalho'];
        $bairroTrabalhoResp = $_SESSION['novo_aluno_infantil']['responsavel']['bairro_trabalho'];
    } else {
        $cepTrabalhoResp = '';
    ...
    $comercialResp = '';
    $celularResp = '';
    if (isset($_SESSION['novo_aluno_infantil']['responsavel']['telefone'])) {
        $residencialResp = '(' .
            substr($_SESSION['novo_aluno_infantil']['responsavel']['telefone'], 0, 2) . ')' .
substr($_SESSION['novo_aluno_infantil']['responsavel']['telefone'], 2);
} else {
    $residencialResp = '';
}
if (isset($_SESSION['novo_aluno_infantil']['responsavel']['comercial'])) {
    $comercialResp = '(' .
        substr($_SESSION['novo_aluno_infantil']['responsavel']['comercial'], 0, 2) . ')' .
substr($_SESSION['novo_aluno_infantil']['responsavel']['comercial'], 2);
} else {
    $comercialResp = '';
}
if (isset($_SESSION['novo_aluno_infantil']['responsavel']['celular'])) {
    $celularResp = '(' .
        substr($_SESSION['novo_aluno_infantil']['responsavel']['celular'], 0, 2) . ')' .
substr($_SESSION['novo_aluno_infantil']['responsavel']['celular'], 2);
} else {
    $celularResp = '';
}

$cidadeTrabalhoResp = buscaMunicipio($_SESSION['novo_aluno_infantil']['responsavel']['municipio_trabalho'])[1][1];
$ufTrabalhoResp = buscaNomeEstado($_SESSION['novo_aluno_infantil']['responsavel']['estado_trabalho'])[2];
$turnosResp = $_SESSION['novo_aluno_infantil']['responsavel']['turnos'];
} else {
    $nomeResp = '';
    $dataNascResp = '';
    $sexoResp = '';
...
foreach ($_SESSION['novo_aluno_infantil']['renda']['pessoas'] as $key => $value) {
    $data[$key] = [$value[0], buscaSituacaoOcupacional($value[1])[1], ($value[4]), $value[3], $value[2], buscaComprovacao($value[5])[1]];
}
...
$pdf->Cell(45, 5, iconv('utf-8', 'iso-8859-1', $_SESSION['novo_aluno_infantil']['renda']['pensao']), 1, 0, 'C');
$pdf->SetFont('Arial', 'B', 11);
$pdf->Cell(45, 5, iconv('utf-8', 'iso-8859-1', 'Valor Bolsa Família*: '), 0, 0, 'C');
$pdf->SetFont('Arial', '', 11);
$pdf->Cell(45, 5, iconv('utf-8', 'iso-8859-1', $_SESSION['novo_aluno_infantil']['renda']['bolsa']), 1, 0, 'C');

if($_SESSION['novo_aluno_infantil']['escola']['grupo'] == 10){
    $grupo = 'Grupo 1';
}
if($_SESSION['novo_aluno_infantil']['escola']['grupo'] == 11){
    $grupo = 'Grupo 2';
}
if($_SESSION['novo_aluno_infantil']['escola']['grupo'] == 12){
    $grupo = 'Grupo 3';
}
if($_SESSION['novo_aluno_infantil']['escola']['grupo'] == 13){
    $grupo = 'Grupo 4';
}
if($_SESSION['novo_aluno_infantil']['escola']['grupo'] == 14){
    $grupo = 'Grupo 5';
}
if($_SESSION['novo_aluno_infantil']['escola']['grupo'] == 15){
    $grupo = 'Grupo 6';
}
$pdf->Ln(6);
$pdf->DadosEscola($priOpcao, $segOpcao, $unidadeInscricao, $nomePessoa, $grupo);
...
$pdf->Comprovante($priOpcao, $segOpcao, $unidadeInscricao, $nomePessoa, $grupo);
