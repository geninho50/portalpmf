...
$pdf->Cell(0, 10, utf8_decode('Ensino Fundamental'),0,0,'C');
$pdf->Ln(6);
$pdf->Cell(0, 10, utf8_decode('Relatório - Crianças em Intenção com Endereço sem Vaga'),0,0,'C');
...
$pdf->Cell(0, 10, $buscaEscola[1][1],0,0,'C');
...
from matricula.lista_aluno a, matricula.pessoa_fisica b 
        ...
        and a.Lista_Fase_Periodo_Fase_id_ano_serie = 1
        and a.id_aluno = b.Pessoa_id_pessoa
and a.id_aluno not in (select distinct y.Aluno_Pessoa_Fisica_Pessoa_id_pessoa from matricula.vaga y
where y.Fase_Periodo_Fase_Curso_id_curso = 1
and y.Aluno_Pessoa_Fisica_Pessoa_id_pessoa is not null)
) k, matricula.bairro l, matricula.aluno p
...
$pdf->Ln();
$pdf->Cell(0, 10, utf8_decode('1º Ano'),0,0,'C');
...
from matricula.lista_aluno a, matricula.pessoa_fisica b 
        ...
        and a.Lista_Fase_Periodo_Fase_Curso_id_curso = 1
        and a.Lista_Fase_Periodo_Escola_Pessoa_Juridica_Pessoa_id_pessoa = %s
        and a.Lista_Fase_Periodo_Fase_id_ano_serie = 2
        and a.id_aluno = b.Pessoa_id_pessoa
and a.id_aluno not in (select distinct y.Aluno_Pessoa_Fisica_Pessoa_id_pessoa from matricula.vaga y
where y.Fase_Periodo_Fase_Curso_id_curso = 1
and y.Aluno_Pessoa_Fisica_Pessoa_id_pessoa is not null)
...
$pdf->SetFont('Arial','',12);
$pdf->Ln();
$pdf->Cell(0, 10, utf8_decode('2º Ano'),0,0,'C'); 
...
from matricula.lista_aluno a, matricula.pessoa_fisica b 
        ...
        and a.Lista_Fase_Periodo_Fase_Curso_id_curso = 1
        and a.Lista_Fase_Periodo_Escola_Pessoa_Juridica_Pessoa_id_pessoa = %s
        and a.Lista_Fase_Periodo_Fase_id_ano_serie = 3
        and a.id_aluno = b.Pessoa_id_pessoa
and a.id_aluno not in (select distinct y.Aluno_Pessoa_Fisica_Pessoa_id_pessoa from matricula.vaga y
where y.Fase_Periodo_Fase_Curso_id_curso = 1
and y.Aluno_Pessoa_Fisica_Pessoa_id_pessoa is not null)
...
$pdf->SetFont('Arial','',12);
$pdf->Ln();
$pdf->Cell(0, 10, utf8_decode('3º Ano'),0,0,'C');
...
from matricula.lista_aluno a, matricula.pessoa_fisica b 
        ...
        and a.Lista_Fase_Periodo_Fase_Curso_id_curso = 1
        and a.Lista_Fase_Periodo_Escola_Pessoa_Juridica_Pessoa_id_pessoa = %s
        and a.Lista_Fase_Periodo_Fase_id_ano_serie = 4
        and a.id_aluno = b.Pessoa_id_pessoa
and a.id_aluno not in (select distinct y.Aluno_Pessoa_Fisica_Pessoa_id_pessoa from matricula.vaga y
where y.Fase_Periodo_Fase_Curso_id_curso = 1
and y.Aluno_Pessoa_Fisica_Pessoa_id_pessoa is not null)
...
$pdf->SetFont('Arial','',12);
$pdf->Ln();
$pdf->Cell(0, 10, utf8_decode('4º Ano'),0,0,'C');
...
from matricula.lista_aluno a, matricula.pessoa_fisica b 
        ...
        and a.Lista_Fase_Periodo_Fase_Curso_id_curso = 1
        and a.Lista_Fase_Periodo_Escola_Pessoa_Juridica_Pessoa_id_pessoa = %s
        and a.Lista_Fase_Periodo_Fase_id_ano_serie = 5
        and a.id_aluno = b.Pessoa_id_pessoa
and a.id_aluno not in (select distinct y.Aluno_Pessoa_Fisica_Pessoa_id_pessoa from matricula.vaga y
where y.Fase_Periodo_Fase_Curso_id_curso = 1
and y.Aluno_Pessoa_Fisica_Pessoa_id_pessoa is not null)
...
$pdf->SetFont('Arial','',12);
$pdf->Ln();
$pdf->Cell(0, 10, utf8_decode('5º Ano'),0,0,'C');
...
from matricula.lista_aluno a, matricula.pessoa_fisica b 
        ...
        and a.Lista_Fase_Periodo_Fase_Curso_id_curso = 1
        and a.Lista_Fase_Periodo_Escola_Pessoa_Juridica_Pessoa_id_pessoa = %s
        and a.Lista_Fase_Periodo_Fase_id_ano_serie = 6
        and a.id_aluno = b.Pessoa_id_pessoa
and a.id_aluno not in (select distinct y.Aluno_Pessoa_Fisica_Pessoa_id_pessoa from matricula.vaga y
where y.Fase_Periodo_Fase_Curso_id_curso = 1
and y.Aluno_Pessoa_Fisica_Pessoa_id_pessoa is not null)
...
$pdf->SetFont('Arial','',12);
$pdf->Ln();
$pdf->Cell(0, 10, utf8_decode('6º Ano'),0,0,'C');
...
from matricula.lista_aluno a, matricula.pessoa_fisica b 
        ...
        and a.Lista_Fase_Periodo_Fase_Curso_id_curso = 1
        and a.Lista_Fase_Periodo_Escola_Pessoa_Juridica_Pessoa_id_pessoa = %s
        and a.Lista_Fase_Periodo_Fase_id_ano_serie = 7
        and a.id_aluno = b.Pessoa_id_pessoa
and a.id_aluno not in (select distinct y.Aluno_Pessoa_Fisica_Pessoa_id_pessoa from matricula.vaga y
where y.Fase_Periodo_Fase_Curso_id_curso = 1
and y.Aluno_Pessoa_Fisica_Pessoa_id_pessoa is not null)
...
$pdf->SetFont('Arial','',12);
$pdf->Ln();
$pdf->Cell(0, 10, utf8_decode('7º Ano'),0,0,'C');
...
from matricula.lista_aluno a, matricula.pessoa_fisica b 
        ...
        and a.Lista_Fase_Periodo_Fase_Curso_id_curso = 1
        and a.Lista_Fase_Periodo_Escola_Pessoa_Juridica_Pessoa_id_pessoa = %s
        and a.Lista_Fase_Periodo_Fase_id_ano_serie = 8
        and a.id_aluno = b.Pessoa_id_pessoa
and a.id_aluno not in (select distinct y.Aluno_Pessoa_Fisica_Pessoa_id_pessoa from matricula.vaga y
where y.Fase_Periodo_Fase_Curso_id_curso = 1
and y.Aluno_Pessoa_Fisica_Pessoa_id_pessoa is not null)
...
$pdf->SetFont('Arial','',12);
$pdf->Ln();
$pdf->Cell(0, 10, utf8_decode('8º Ano'),0,0,'C');
...
from matricula.lista_aluno a, matricula.pessoa_fisica b 
        ...
        and a.Lista_Fase_Periodo_Fase_Curso_id_curso = 1
        and a.Lista_Fase_Periodo_Escola_Pessoa_Juridica_Pessoa_id_pessoa = %s
        and a.Lista_Fase_Periodo_Fase_id_ano_serie = 9
        and a.id_aluno = b.Pessoa_id_pessoa
and a.id_aluno not in (select distinct y.Aluno_Pessoa_Fisica_Pessoa_id_pessoa from matricula.vaga y
where y.Fase_Periodo_Fase_Curso_id_curso = 1
and y.Aluno_Pessoa_Fisica_Pessoa_id_pessoa is not null)
...
$pdf->SetFont('Arial','',12);
$pdf->Ln();
$pdf->Cell(0, 10, utf8_decode('9º Ano'),0,0,'C');
