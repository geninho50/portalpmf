...
$classificacao = buscaClassificacaoListaIntencaoInfantil('INFANTIL - 2013', $_GET['idEscola'], 10);
...
$classificacao = buscaClassificacaoListaIntencaoInfantil('INFANTIL - 2013', $_GET['idEscola'], 11);
...
$classificacao = buscaClassificacaoListaIntencaoInfantil('INFANTIL - 2013', $_GET['idEscola'], 12);
...
$classificacao = buscaClassificacaoListaIntencaoInfantil('INFANTIL - 2013', $_GET['idEscola'], 13);
...
$classificacao = buscaClassificacaoListaIntencaoInfantil('INFANTIL - 2013', $_GET['idEscola'], 14);
...
$classificacao = buscaClassificacaoListaIntencaoInfantil('INFANTIL - 2013', $_GET['idEscola'], 15);
