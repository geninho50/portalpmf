...
// Put a hyperlink
    ...
    function CertidaoVelha($termo, $folha, $livro, $cartorio, $uf_cart) {
        ...
        if ($uf_cart > 1) {
            if ($uf_cart < 28) {
            	$uf_cart = buscaNomeEstado($uf_cart);
                $uf_cart = $uf_cart[2];
            }
        }
    ...
    function DadosEscola($unidadeInscricao) {
        $this->SetFont('Arial', 'BU', 14);
        $this->Cell(53, 5, iconv('utf-8', 'iso-8859-1', 'Dados de Matrícula:'), 0, 0, 'C');
        $this->SetFont('Arial', 'B', 11);
        $this->SetFont('Arial', 'B', 11);
        $this->Ln(6);
        ...
        $this->Cell(80, 5, iconv('utf-8', 'iso-8859-1', 'Etapa de Matrícula:'), 0, 0, 'C');
        $this->SetFont('Arial', '', 11);
        
        $this->Cell(100, 5, $ano, 1, 0, 'C');
        $this->Ln(6);

        if ($_SESSION['dados_escolares']['nucleo'] == 1) {
            $nucleo = 'Centro 1 - Escola Silveira de Souza';
        } else {
            if ($_SESSION['dados_escolares']['nucleo'] == 2) {
                $nucleo = 'Centro 2 - EB Donícia Maria da Costa';
            } else {
                if ($_SESSION['dados_escolares']['nucleo'] == 3) {
                    $nucleo = 'Sul 1 - EB Anísio Teixeira';
                } else {
                    if ($_SESSION['dados_escolares']['nucleo'] == 4) {
                        $nucleo = 'Sul 2 - EB Batista Pereira';
                    } else {
                        if ($_SESSION['dados_escolares']['nucleo'] == 5) {
                            $nucleo = 'Norte 1 - EB Profª Herondina Medeiros Zeferino';
                        } else {
                            if ($_SESSION['dados_escolares']['nucleo'] == 6) {
                                $nucleo = 'Norte 2 - EB Osmar Cunha';
                            } else {
                                if ($_SESSION['dados_escolares']['nucleo'] == 7) {
                                    $nucleo = 'Leste 1 - EB João Gonçalves Pinheiro';
                                } else {
                                    if ($_SESSION['dados_escolares']['nucleo'] == 8) {
                                        $nucleo = 'Leste 3 - EB Maria Conceição Nunes';
                                    } else {
                                        if ($_SESSION['dados_escolares']['nucleo'] == 9) {
                                            $nucleo = 'Continente 1 - EB Almirante Carvalhal';
                                        }
                                    }
                                }
                            }
        ...
        $this->Cell(80, 5, iconv('utf-8', 'iso-8859-1', 'Núcleo:'), 0, 0, 'C');
        $this->SetFont('Arial', '', 11);
        
        $this->Cell(100, 5, utf8_decode($nucleo), 1, 0, 'C');
        $this->Ln(6);
        ...
        $this->Ln(6);
        $this->Cell(50, 5, iconv('utf-8', 'iso-8859-1', ''), 0, 0, 'C');
        $this->Cell(80, 5, iconv('utf-8', 'iso-8859-1', '               Assinatura do Aluno     '), 0, 0, 'C');
        $this->Ln(6);
    }
    ...
    function Comprovante($priOpcao, $segOpcao, $unidadeInscricao, $nomePessoa) {
        ...
        $this->Ln(2);
        $this->SetFont('Arial', 'B', 11);
        $this->Cell(35, 5, iconv('utf-8', 'iso-8859-1', 'Nome do Aluno:'), 0, 0, 'C');
        $this->SetFont('Arial', '', 11);
    ...
    function DadosRendaEJA($moraFamilia, $nFilhos, $nDependentes, $nDepTrabalham, $nHabitantes, $rendaPropria, $rendaFamiliar, $recebeAjuda, $carteira, $jaCarteira, $procuraEmprego, $pretensao, $estagio, $voluntario, $localVoluntario, $habmot, $empresa, $funcao, $cqd) {
        $this->SetFont('Arial', 'BU', 13);
        $this->Cell(38, 5, iconv('utf-8', 'iso-8859-1', 'Dados de Renda:'), 0, 0, 'C');
        $this->SetFont('Arial', '', 11);
        $this->Ln(6);
        $this->Cell(40, 5, iconv('utf-8', 'iso-8859-1', 'Mora com Família:'), 0, 0, 'C');
        $this->SetFont('Arial', '', 11);
        if ($moraFamilia == 'sim') {
            $moraFamilia = '';
        } else {
        ...
        $this->Cell(10, 5, iconv('utf-8', 'iso-8859-1', $moraFamilia), 1, 0, 'C');
        $this->SetFont('Arial', '', 11);
        $this->Cell(40, 5, iconv('utf-8', 'iso-8859-1', 'Número de Filhos:'), 0, 0, 'C');
        $this->SetFont('Arial', '', 11);
        $this->Cell(10, 5, iconv('utf-8', 'iso-8859-1', $nFilhos), 1, 0, 'C');
        $this->Cell(50, 5, iconv('utf-8', 'iso-8859-1', 'Número de Dependentes:'), 0, 0, 'C');
        $this->SetFont('Arial', '', 11);
        $this->Cell(10, 5, iconv('utf-8', 'iso-8859-1', $nDependentes), 1, 0, 'C');
        $this->Ln(6);
        $this->Cell(48, 5, iconv('utf-8', 'iso-8859-1', 'Número de Habitantes:'), 0, 0, 'C');
        $this->SetFont('Arial', '', 11);
        $this->Cell(10, 5, iconv('utf-8', 'iso-8859-1', $nHabitantes), 1, 0, 'C');
        $this->Cell(40, 5, iconv('utf-8', 'iso-8859-1', 'Renda Própria:'), 0, 0, 'C');
        $this->SetFont('Arial', '', 11);
        $this->Cell(20, 5, iconv('utf-8', 'iso-8859-1', $rendaPropria), 1, 0, 'C');
        $this->Cell(40, 5, iconv('utf-8', 'iso-8859-1', 'Renda Familiar:'), 0, 0, 'C');
        $this->SetFont('Arial', '', 11);
        $this->Cell(20, 5, iconv('utf-8', 'iso-8859-1', $rendaFamiliar), 1, 0, 'C');
        $this->SetFont('Arial', '', 11);
        $this->Ln(6);
        $this->Cell(81, 5, iconv('utf-8', 'iso-8859-1', 'Alguém da casa recebe ajuda do governo:'), 0, 0, 'C');
        $this->SetFont('Arial', '', 11);
        if ($recebeAjuda == 'sim') {
            $recebeAjuda = '';
        } else {
        ...
        $this->Cell(10, 5, iconv('utf-8', 'iso-8859-1', $recebeAjuda), 1, 0, 'C');
        $this->Cell(40, 5, iconv('utf-8', 'iso-8859-1', 'Carteira Assinada:'), 0, 0, 'C');
        $this->SetFont('Arial', '', 11);
        if ($carteira == 'sim') {
            $carteira = '';
        } else {
        ...
        $this->Cell(20, 5, iconv('utf-8', 'iso-8859-1', $carteira), 1, 0, 'C');
        $this->Ln(6);
        $this->Cell(69, 5, iconv('utf-8', 'iso-8859-1', 'Já trabalhou com carteira assinada:'), 0, 0, 'C');
        $this->SetFont('Arial', '', 11);
        if ($jaCarteira == 'sim') {
            $jaCarteira = '';
        } else {
        ...
        $this->Cell(10, 5, iconv('utf-8', 'iso-8859-1', $jaCarteira), 1, 0, 'C');
        $this->Cell(40, 5, iconv('utf-8', 'iso-8859-1', 'Procura Emprego:'), 0, 0, 'C');
        $this->SetFont('Arial', '', 11);
        if ($procuraEmprego == 'sim') {
            $procuraEmprego = '';
        } else {
            $procuraEmprego = '';
        }
        $this->Cell(20, 5, iconv('utf-8', 'iso-8859-1', $procuraEmprego), 1, 0, 'C');
        $this->Ln(6);
        $this->Cell(48, 5, iconv('utf-8', 'iso-8859-1', 'Empresa que trabalha:'), 0, 0, 'C');
        $this->SetFont('Arial', '', 11);
        $this->Cell(120, 5, iconv('utf-8', 'iso-8859-1', $empresa), 1, 0, 'C');
        $this->Ln(6);
        $this->Cell(25, 5, iconv('utf-8', 'iso-8859-1', 'Função:'), 0, 0, 'C');
        $this->SetFont('Arial', '', 11);
        $this->Cell(120, 5, iconv('utf-8', 'iso-8859-1', $funcao), 1, 0, 'C');
        $this->Ln(6);
        $this->Cell(75, 5, iconv('utf-8', 'iso-8859-1', 'Com quem deixará filhos pra estudar:'), 0, 0, 'C');
        $this->SetFont('Arial', '', 11);
        $this->Cell(110, 5, iconv('utf-8', 'iso-8859-1', $cqd), 1, 0, 'C');
        $this->Ln(6);
        $this->Cell(54, 5, iconv('utf-8', 'iso-8859-1', 'Já fez estágio remunerado:'), 0, 0, 'C');
        $this->SetFont('Arial', '', 11);
        if ($estagio == 'sim') {
            $estagio = '';
        } else {
        ...
        $this->Cell(10, 5, iconv('utf-8', 'iso-8859-1', $estagio), 1, 0, 'C');
        $this->Cell(40, 5, iconv('utf-8', 'iso-8859-1', 'Habilidade Motora:'), 0, 0, 'C');
        $this->SetFont('Arial', '', 11);
        if ($habmot == 0) {
            $habmot = '';
        } else {
        ...
        $this->Cell(40, 5, iconv('utf-8', 'iso-8859-1', $habmot), 1, 0, 'C');
        $this->Ln(6);
        $this->Cell(47, 5, iconv('utf-8', 'iso-8859-1', 'Pretensão Profissional:'), 0, 0, 'C');
        $this->SetFont('Arial', '', 11);
        $this->Cell(120, 5, iconv('utf-8', 'iso-8859-1', $pretensao), 1, 0, 'C');
        $this->Ln(6);
        $this->Cell(60, 5, iconv('utf-8', 'iso-8859-1', 'Já exerceu trabalho voluntário:'), 0, 0, 'C');
        $this->SetFont('Arial', '', 11);
        if ($voluntario == 'sim') {
            $voluntario = '';
        } else {
        ...
        $this->Cell(10, 5, iconv('utf-8', 'iso-8859-1', $voluntario), 1, 0, 'C');
        $this->Ln(6);
        $this->Cell(65, 5, iconv('utf-8', 'iso-8859-1', 'Onde realizou trabalho voluntário:'), 0, 0, 'C');
        $this->SetFont('Arial', '', 11);
        $this->Cell(120, 5, iconv('utf-8', 'iso-8859-1', $localVoluntario), 1, 0, 'C');
        $this->Ln(6);
        $this->Ln(6);
    }
...
$etnia = buscaEtnia($_SESSION['dados_pessoais']['etnia']);
$etnia = $etnia[1];
$rg = '';
$orgao = '';
$uf_rg = '';
...
$pais = buscaNacionalidade($_SESSION['dados_pessoais']['nacionalidade']);
$pais = $pais[1][1];
include '../fnc/buscaMunicipio.php';
include '../fnc/buscaEstado.php';
if ($pais == 'Brasil') {
	$cidade = buscaMunicipio($_SESSION['dados_pessoais']['naturalidade']['municipio']);
    $cidade = $cidade[1][1];
	$estado = buscaNomeEstado($_SESSION['dados_pessoais']['naturalidade']['uf']);
    $estado = $estado[2];
}
...
if ($_SESSION['localizacao']['bairro']) {
    if ($_SESSION['localizacao']['bairro'] != '') {
		...
		$bairro = buscaBairro($_SESSION['localizacao']['bairro']);
        $bairro = $bairro[$id][1];
    }
}
$urbana = '';
...
if (isset($_SESSION['escola']['id'])) {
	 $unidadeInscricao = buscaEscola($_SESSION['escola']['id']);
     $unidadeInscricao = $unidadeInscricao[$_SESSION['escola']['id']][1];
} else {
    $escolaRematricula = (buscaEscolaRematricula($_SESSION['id']));
	$escola = buscaEscola($escolaRematricula[7]);
    $unidadeInscricao = $escola[$escolaRematricula[7]][1];
}
...
if (isset($_SESSION['mae'])) {
    ...
    if (isset($_SESSION['mae']['data_nascimento'])) {
		...
		$etniaMae = buscaEtnia($_SESSION['mae']['etnia']);
        $etniaMae = $etniaMae[1];
		$religiaoMae = buscaReligiao($_SESSION['mae']['religiao']);
        $religiaoMae = $religiaoMae[1];
		$profissaoMae = buscaProfissao($_SESSION['mae']['profissao']);
        $profissaoMae = $profissaoMae[1];
        ...
        $cidadeMae = buscaMunicipio($_SESSION['mae']['municipio']);
        $cidadeMae = $cidadeMae[1][1];
        $ufMae = buscaNomeEstado($_SESSION['mae']['estado']);
        $ufMae = $ufMae[2];
        ...
        if ($_SESSION['mae']['cep_trabalho']) {
            if ($_SESSION['mae']['cep_trabalho'] != '') {
                ...
                $cidadeTrabalhoMae = buscaMunicipio($_SESSION['mae']['municipio_trabalho']);
			    $cidadeTrabalhoMae = $cidadeTrabalhoMae[1][1];
				$ufTrabalhoMae = buscaNomeEstado($_SESSION['mae']['estado_trabalho']);
                $ufTrabalhoMae = $ufTrabalhoMae[2];
            } else {
                $cepTrabalhoMae = '';
...
if (isset($_SESSION['pai'])) {
    ...
    if (isset($_SESSION['pai']['data_nascimento'])) {
        ...
        $etniaPai = buscaEtnia($_SESSION['pai']['etnia']);
        $etniaPai = $etniaPai[1];
		$religiaoPai = buscaReligiao($_SESSION['pai']['religiao']);
        $religiaoPai = $religiaoPai[1];
        $profissaoPai = buscaProfissao($_SESSION['pai']['profissao']);
        $profissaoPai = $profissaoPai[1];
        ...
        $bairroPai = $_SESSION['pai']['bairro'];
       	$cidadePai = buscaMunicipio($_SESSION['pai']['municipio']);
	    $cidadePai = $cidadePai[1][1];
		$ufPai = buscaNomeEstado($_SESSION['pai']['estado']);
        $ufPai = $ufPai[2];
        ...
        if (isset($_SESSION['pai']['cep_trabalho'])) {
            if ($_SESSION['pai']['cep_trabalho'] != '') {
                ...
                $cidadeTrabalhoPai = buscaMunicipio($_SESSION['pai']['municipio_trabalho']);
                $cidadeTrabalhoPai = $cidadeTrabalhoPai[1][1];
				$ufTrabalhoPai = buscaNomeEstado($_SESSION['pai']['estado_trabalho']);
                $ufTrabalhoPai = $ufTrabalhoPai[2];
            } else {
                $cepTrabalhoPai = '';
...
if (isset($_SESSION['responsavel'])) {
    ...
    if (isset($_SESSION['responsavel']['data_nascimento'])) {
		...
		$etniaResp = buscaEtnia($_SESSION['responsavel']['etnia']);
        $etniaResp = $etniaResp[1];
        $religiaoResp = buscaReligiao($_SESSION['responsavel']['religiao']);
        $religiaoResp = $religiaoResp[1];
		$profissaoResp = buscaProfissao($_SESSION['responsavel']['profissao']);
        $profissaoResp = $profissaoResp[1];
...
$cidadeTrabalhoResp = buscaMunicipio($_SESSION['responsavel']['municipio_trabalho']);
$cidadeTrabalhoResp = $cidadeTrabalhoResp[1][1];
$ufTrabalhoResp = buscaNomeEstado($_SESSION['responsavel']['estado_trabalho']);
$ufTrabalhoResp = $ufTrabalhoResp[2];
...
$pdf->AddPage();
// Logo
$pdf->Image('../img/logosystem.png', 3, 6, 70);
// Arial bold 15
...
$pdf->Cell(192, 0, iconv('utf-8', 'iso-8859-1', 'Secretaria Municipal de Educação'), 0, 0, 'C');
// Line break
$pdf->Ln(5);
// Arial bold 15
$pdf->SetFont('Arial', 'B', 10);
$pdf->Cell(183, 0, iconv('utf-8', 'iso-8859-1', 'Sistema de Gerenciamento Escolar'), 0, 0, 'C');
// Line break
$pdf->Ln(10);
// Arial bold 15
$pdf->SetFont('Arial', 'B', 12);
$pdf->Cell(0, 0, iconv('utf-8', 'iso-8859-1', 'Formulário de Cadastro de Aluno - Educação de Jovens e Adultos'), 0, 0, 'C');
$pdf->Ln(10);
// Line break
...
$moraFamilia = $_SESSION['renda']['moraFamilia'];
$nFilhos = $_SESSION['renda']['numeroFilhos'];
$nDependentes = $_SESSION['renda']['numeroDependentes'];
$nDepTrabalham = $_SESSION['renda']['numeroDependentesTrabalham'];
$nHabitantes = $_SESSION['renda']['numeroHabitantes'];
$rendaPropria = $_SESSION['renda']['rendaPropria'];
$rendaFamiliar = $_SESSION['renda']['rendaFamiliar'];
$recebeAjuda = $_SESSION['renda']['recebeAjuda'];
$carteira = $_SESSION['renda']['carteira'];
$jaCarteira = $_SESSION['renda']['jaCarteira'];
$procuraEmprego = $_SESSION['renda']['procuraEmprego'];
$pretensao = $_SESSION['renda']['pretensao'];
$estagio = $_SESSION['renda']['estagio'];
$voluntario = $_SESSION['renda']['voluntario'];
$localVoluntario = $_SESSION['renda']['localVoluntario'];
$habmot = $_SESSION['renda']['habmot'];
$empresa = $_SESSION['renda']['empresa'];
$funcao = $_SESSION['renda']['funcao'];
$comQuemDeixara = $_SESSION['renda']['comQuemDeixara'];

$pdf->DadosRendaEJA($moraFamilia, $nFilhos, $nDependentes, $nDepTrabalham, $nHabitantes, $rendaPropria, $rendaFamiliar, $recebeAjuda, 
    $carteira, $jaCarteira, $procuraEmprego, $pretensao, $estagio, $voluntario, $localVoluntario, $habmot, $empresa, $funcao, $comQuemDeixara);
