...
$pdf->Ln(6);
$pdf->Cell(0, 10, utf8_decode('Relatório - Alunos Atendidos'),0,0,'C');
$pdf->Ln(12);
...
foreach ($escolas as $key => $value) {
    $k++;
    $sql = sprintf("SELECT count(*), a.Lista_Fase_Periodo_Escola_Pessoa_Juridica_Pessoa_id_pessoa, a.Lista_Fase_Periodo_Fase_id_ano_serie FROM matricula.lista_aluno_atendidas a
        where Lista_Fase_Periodo_Fase_Curso_id_curso = 1
        and a.Lista_Fase_Periodo_Escola_Pessoa_Juridica_Pessoa_id_pessoa = %s
        group by a.Lista_Fase_Periodo_Escola_Pessoa_Juridica_Pessoa_id_pessoa, a.Lista_Fase_Periodo_Fase_id_ano_serie"
