...
$db->open("SELECT * FROM bannerSuporte WHERE ID_SISTEMA = 1 ORDER BY ID ");
...
<link rel="stylesheet" href="../../layout/themePMF/css/style.css">
 ...
 <input id="autocomplete" type="text" class="form-control" aria-label="Text input with dropdown button" placeholder = "Pesquisar por P&aacute;gina (Ex: Como acessar..., gif...)" style="width: 50%; margin: auto;" onclick="uiMenu()">
		...
		<div class="row" align="center">
			...
			<div class="col-md-4">
				<video width="320" height="240" controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #1A272B">
					...
					<a href="sefinnetsuporte/gifpf.php"><h4 style="color:white">GIF PF 🔗</h4></a>
				</div>
			...
			<div class="col-md-4">
				<video width="320" height="240"  controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #1A272B">
					...
					<a href="sefinnetsuporte/gifpj.php"><h4 style="color:white">GIF PJ 🔗</h4></a>
				</div>
			<div class="col-md-4">
				<video width="320" height="240"  controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #1A272B">
					...
					<a href="sefinnetsuporte/gifpj.php">	<h4 style="color:white">DES SP 🔗</h4></a>
				</div>
			<div class="col-md-4">
				<video width="320" height="240"  controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #1A272B">
					...
					<a href="sefinnetsuporte/gifpj.php"><h4 style="color:white">DES ST 🔗</h4></a>
				</div>
...
<script >
	$( function() {
		$( "#autocomplete" ).autocomplete({
			source: 'banco/getpagesefinnet.php',
			minLength: 1,
