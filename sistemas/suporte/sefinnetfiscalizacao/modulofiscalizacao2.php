...
<script>
  ...
  <title>Módulo Fiscalização 2</title>
     <?php
...
<div style="display:center;">
 ...
 <div id= "videoContainer" style="grid-template-columns: auto auto auto;"align="center">
  ...
  <div>
    <video onended="acabou(1);" poster="videosrastreabilidade/thumbnail.png" width="320"  height="240"controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747">
      <source src="videosrastreabilidade/cnaegifst.mp4" type="video/mp4">
        Seu navegador não suporta HTML5.
      </video>
    <h4 id="video1">Aula 01 - Como configurar um CNAE para GIF ST PF</h4>
  </div>



  <div>
    <video onended="acabou(2);" poster="videosrastreabilidade/thumbnail.png" width="320"  height="240"controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747">
      <source src="videosrastreabilidade/matriculacei.mp4" type="video/mp4">
        Seu navegador não suporta HTML5.
      </video>
    <h4 id="video2">Aula 02 - Visualizar Declarações por Matrícula CEI</h4>
  </div>
...
<br>
 ...
 <script type='text/javascript'>
    ...
    function acabou(id){
      progresso+=50;
      document.getElementById("video"+id).style.color = "green";
