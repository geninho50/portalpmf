...
<div style="margin-left: 60px;">Progresso de vídeos assistidos:</div>
...
<center><h3 text>MODULO II - Construção Civil </h3></center>

  <div class="questionario" style="display: none;margin-left: 20px;margin-right: 40px">
     
      <? echo $questoesModulo2; ?>
 ...
 <div class= "videoContainer" style="grid-template-columns: auto auto auto;"align="center">
  ...
  <div>
    <video id= "video11"onplay="inicioVideo(2,11)" onended="completaVideo(2,11);" poster="videosrastreabilidade/thumbnail.png" width="520"  height="440"controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747">
  ...
  <div>
    <video  id="video12" onplay="inicioVideo(2,12)" onended="completaVideo(2,12);" poster="videosrastreabilidade/thumbnail.png" width="520"  height="440"controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747">
...
<center><h3 text>MODULO III - Administração aplicada à GFIS</h3></center>

    <div class="questionario" style="display: none;margin-left: 20px;margin-right: 40px">
     
      <? echo $questoesModulo3; ?>
...
<div id = "modulo4" style="display:center;">
  ...
  <center><h3 text>MODULO IV - Simples Nacional</h3></center>

     <div class="questionario" style="display: none;margin-left: 20px;margin-right: 40px">
     
      <? echo $questoesModulo4; ?>
  ...
  <div class= "videoContainer" style="grid-template-columns: auto auto auto;"align="center">
    ...
    <div>
      <video  poster="videosrastreabilidade/thumbnail.png" width="520"  height="440"controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747">
        <source src="videosrastreabilidade/optantesimples.mp4" type="video/mp4">
          Seu navegador não suporta HTML5.
        </video>
        <h4 id="video2">Aula 01 - Optante Simples Nacional</h4>
      </div>

      <div>
        <video  poster="videosrastreabilidade/thumbnail.png" width="520"  height="440"controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747">
          <source src="videosrastreabilidade/divergencias.mp4" type="video/mp4">
            Seu navegador não suporta HTML5.
          </video>
          <h4 id="video2">Aula 02 - Divergências DAS x NFE</h4>
        </div>

      <div>
        <video poster="videosrastreabilidade/thumbnail.png" width="520"  height="440"controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747">
          <source src="videosrastreabilidade/coletorciga.mp4" type="video/mp4">
            Seu navegador não suporta HTML5.
          </video>
          <h4 id="video2">Aula 03 - Informações Coletor CIGA</h4>
        </div>
...
<div>
    <video poster="videosrastreabilidade/thumbnail.png" width="520"  height="440"controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747">
      <source src="videosrastreabilidade/painelgerencial.mp4" type="video/mp4">
        Seu navegador não suporta HTML5.
      </video>
    <h4 id="video2">Aula 01 - Painel Gerencial</h4>
  </div>

  <div>
    <video poster="videosrastreabilidade/thumbnail.png" width="520"  height="440"controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747">
      <source src="videosrastreabilidade/painelgerencialgif.mp4" type="video/mp4">
        Seu navegador não suporta HTML5.
      </video>
    <h4 id="video2">Aula 02 - Painel Gerencial GIF</h4>
  </div>

    <div>
    <video poster="videosrastreabilidade/thumbnail.png" width="520"  height="440"controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747">
      <source src="videosrastreabilidade/painelgerencialcnae.mp4" type="video/mp4">
        Seu navegador não suporta HTML5.
      </video>
    <h4 id="video2">Aula 03 - Painel Gerencial CNAE</h4>
  </div>
...
<div>
    <video onended="acabou(2);" poster="videosrastreabilidade/thumbnail.png" width="520"  height="440"controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747">
      <source src="videosrastreabilidade/painelgerencialorgaopublico.mp4" type="video/mp4">
        Seu navegador não suporta HTML5.
      </video>
  ...
  <div>
    <video onended="acabou(2);" poster="videosrastreabilidade/thumbnail.png" width="520"  height="440"controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747">
      <source src="videosrastreabilidade/manutencaoorgaopublico.mp4" type="video/mp4">
        Seu navegador não suporta HTML5.
      </video>
...
<div id = "modulo12" style="display:center;">
	<center><h3 text>MODULO XII - Simples Nacional</h3></center>
...
function carregaModulo(){
  ...
  miniHeader[0].style.display="none";
   ...
   <?php
   $db->open("SELECT * FROM suporteStm.aulasFiscalizacao WHERE ID_MODULO = ".$modulo." AND AULA_COMPLETADA= '1' AND ID_USUARIO = ".$_SESSION["idUsuario"]);
    for($i = 0; $i < count($db->gs['ID']); $i++){ 
    ?>

    acabouVideoExibeProgresso(<?echo $db->gs['ID_MODULO'][$i]?>,<?echo $db->gs['NUM_AULA'][$i]?>);
