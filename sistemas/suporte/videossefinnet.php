 ...
 <div class="col-md-12" align="center">
   <div class="col-md-4">
    <video width="320"  height="240"controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747">
      <source src="sefinnetsuporte/imagens/Envio.mp4" type="video/mp4">
   ...
   <div class="col-md-4">
    <video width="320"  height="240"controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747">
      <source src="sefinnetsuporte/imagens/Checklist.mp4" type="video/mp4">
        Seu navegador não suporta HTML5.
      </video>
  ...
  <div class="col-md-4">
    <video width="320"  height="240"controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747">
      <source src="sefinnetsuporte/imagens/Importacao.mp4" type="video/mp4">
        Seu navegador não suporta HTML5.
      </video>
    <h4>Importação</h4>
  </div>
...
<div id="gifVideos"  style="display:none;">
 ...
 <div class="col-md-12" align="center">
  <div class="col-md-4">
    <video   width="320" height="240" controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747">
      <source src="sefinnetsuporte/imagens/GIF PF.mp4" type="video/mp4">
        Seu navegador não suporta HTML5.
      </video>
       <a href="sefinnetsuporte/gifpf.php"><h4>GIF PF🔗</h4></a>
  </div>

  <div class="col-md-4">
    
    <video width="320" height="240" controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747">
      <source src="sefinnetsuporte/imagens/GIF PJ.mp4" type="video/mp4">
        Seu navegador não suporta HTML5.
      </video>
   <a href="sefinnetsuporte/gifpj.php"><h4>GIF PJ🔗</h4></a>
  </div>

  <div class="col-md-4">

    <video width="320"  height="240"controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747">
      <source src="sefinnetsuporte/imagens/GIF SS.mp4" type="video/mp4">
        Seu navegador não suporta HTML5.
      </video>
    <a href="sefinnetsuporte/gifss.php"><h4>GIF SS🔗</h4></a>
  </div>

  <div class="col-md-4">
    <video width="320" height="240" controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747"> 
      <source src="sefinnetsuporte/imagens/GIF ST.mp4" type="video/mp4">
        Seu navegador não suporta HTML5.
      </video>
      <a href="sefinnetsuporte/gifst.php"><h4>GIF ST🔗</h4></a>
  </div>


    <div class="col-md-4">
      <video width="320" height="240" controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747"> 
        <source src="sefinnetsuporte/imagens/GIF IF MENSAL.mp4" type="video/mp4">
          Seu navegador não suporta HTML5.
        </video>
      <h4>GIF IF Mensal</h4>
   </div>
  ...
  <div class="col-md-4">
    <video width="320" height="240" controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747"> 
      <source src="sefinnetsuporte/imagens/Balancete.mp4" type="video/mp4">
        Seu navegador não suporta HTML5.
      </video>
  ...
  <div class="col-md-4">
    <video width="320" height="240" controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747"> 
      <source src="sefinnetsuporte/imagens/Plano Geral.mp4" type="video/mp4">
        Seu navegador não suporta HTML5.
      </video>
 ...
 <div id="desVideos"  style="display:none;">
  ...
  <div class="col-md-4">
    <video   width="320" height="240" controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747">
      <source src="sefinnetsuporte/imagens/Prestador-Tomador.mp4" type="video/mp4">
        Seu navegador não suporta HTML5.
      </video>
  ...
  <div class="col-md-4">
    ...
    <video width="320" height="240" controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747">
      <source src="sefinnetsuporte/imagens/Documentos Fiscais.mp4" type="video/mp4">
        Seu navegador não suporta HTML5.
      </video>
  ...
  <div class="col-md-4">
    ...
    <video width="320"  height="240"controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747">
      <source src="sefinnetsuporte/imagens/DES SP.mp4" type="video/mp4">
        Seu navegador não suporta HTML5.
      </video>
    <a href="sefinnetsuporte/dessp.php"><h4>DES SP (Serviços Prestados)🔗</h4></a>
  </div>

  <div class="col-md-4">
    <video width="320" height="240" controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747">
      <source src="sefinnetsuporte/imagens/DES ST.mp4" type="video/mp4">
        Seu navegador não suporta HTML5.
      </video>
      <a href="sefinnetsuporte/desst.php"><h4>DES ST (Serviços Tomados)🔗</h4></a>
  </div>
</div>
 ...
 <div class="col-md-12" align="center">
  <div class="col-md-4">
    <video   width="320" height="240" controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747">
      <source src="sefinnetsuporte/imagens/Demonstrativo de debito.mp4" type="video/mp4">
        Seu navegador não suporta HTML5.
      </video>
       <a href="sefinnetsuporte/demonstrativodebito.php"><h4>Demonstrativo de Débitos🔗</h4></a>
  </div>

  <div class="col-md-4">
    <video   width="320" height="240" controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747">
      <source src="sefinnetsuporte/imagens/Demonstrativo pagamento.mp4" type="video/mp4">
        Seu navegador não suporta HTML5.
      </video>
       <a href="sefinnetsuporte/demonstrativopagamento.php"><h4>Demonstrativo de Pagamentos🔗</h4></a>
  </div>

  <div class="col-md-4">
    
    <video width="320" height="240" controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747">
      <source src="sefinnetsuporte/imagens/Impressao DAM.mp4" type="video/mp4">
        Seu navegador não suporta HTML5.
      </video>
   <h4>Impressão DAM</h4>
  </div>
  ...
  <div class="col-md-4">
    ...
    <video width="320" height="240" controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747">
      <source src="sefinnetsuporte/imagens/Recibos de Envio.mp4" type="video/mp4">
        Seu navegador não suporta HTML5.
      </video>
   <h4>Recibos de Envio</h4>
    ...
    <video width="320" height="240" controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747">
      <source src="sefinnetsuporte/imagens/Segunda Via DAM.mp4" type="video/mp4">
        Seu navegador não suporta HTML5.
      </video>
   <a href="sefinnetsuporte/segundaviadam.php"><h4>Segunda Via DAM🔗</h4></a>
  </div>
