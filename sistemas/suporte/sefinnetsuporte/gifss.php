...
<script>
  ...
  <link rel="canonical" href="http://www.pmf.sc.gov.br/sistemas/suporte/sefinnetsuporte/gifss.php"/>
  <meta property="og:locale" content="pt_BR"/>
  <meta property="og:type" content="website"/>
  <meta property="og:title" content="GIF SS - Prefeitura de Florianópolis"/>
  ...
  <meta property="og:url" content="http://www.pmf.sc.gov.br/sistemas/suporte/sefinnetsuporte/gifss.php"/>
...
<body onload="carregaPopup()">
  ...
  <div id="conteudo_pagina" class="column6-lg"  style="margin:auto">
    ...
    <video width="600"  height="360"controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747; margin-left: 20%">
      <source src="imagens/GIF SS.mp4" type="video/mp4">
        Seu navegador não suporta HTML5.
      </video>


      <h3>Segue abaixo passo a passo como Realizar uma Nova Declaração GIF SS:</h3>

      <li>Selecione a opção Novo no menu Superior a Esquerda para criar uma Nova Declaração.</li>


      <img src="imagens/ssnova.png" width="100%"alt="">
      ...
      <li>Na aba "Sócios/Empregados" primeiramente clique em "Inserir", preencha as informações de acordo com os campos e clique em "Salvar".</li>

      <img src="imagens/sssocios.png" width="100%" alt="">
     
      <hr style=" border-top: 1px solid black;">

      <li>Na aba "Foma de Pagamento" escolha se deseja pagar uma cota única ou se deseja parcelar o pagamento.</li>
      <img src="imagens/sspagamento.png" width="100%" alt="">

      <hr style=" border-top: 1px solid black;">

      <li>Na aba "Notas emitidas (ano anterior)", para cada nota emitida, primeiramente clique em "Inserir", preencha os dados da nota e clique em "Salvar".</li>

      <img src="imagens/ssnotasemitidas.png" width="100%" alt="">    

      <hr style=" border-top: 1px solid black;">

      <li>Na aba "Notas Canceladas" insira, caso existam, os números das notas canceladas.</li>
      <img src="imagens/sscanceladas.png" width="100%" alt="">
...
<iframe src="https://sefinnetweb.pmf.sc.gov.br/Sefinnet/hotSite.vm?tela=AREA_MANUAL_GIFSS&sistema=1" width="0" height="0"></iframe>
