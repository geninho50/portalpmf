...
<script>
  ...
  <link rel="canonical" href="http://www.pmf.sc.gov.br/sistemas/suporte/sefinnetsuporte/dessp.php"/>
  <meta property="og:locale" content="pt_BR"/>
  <meta property="og:type" content="website"/>
  <meta property="og:title" content="DES ST - Prefeitura de Florianópolis"/>
  ...
  <meta property="og:url" content="http://www.pmf.sc.gov.br/sistemas/suporte/sefinnetsuporte/dessp.php"/>
...
<body onload="carregaPopup()">
  ...
  <div id="conteudo_pagina" class="column6-lg"  style="margin:auto">
    ...
    <video width="600"  height="360"controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747; margin-left: 20%">
      <source src="imagens/DES SP.mp4" type="video/mp4">
        Seu navegador não suporta HTML5.
      </video>


      <h3>Segue abaixo passo a passo de como declarar um Serviço Prestado (DES SP):</h3>

      <li>Selecione a opção "Novo" no menu Superior a Esquerda para criar um novo DES SP.</li>


      <img src="imagens/desspnova.PNG" width="70%"alt="">

      <hr style=" border-top: 1px solid black;">

      <li>Preencha os dados do Prestador</li>

     <img src="imagens/desspprestador.png" width="100%" style="margin-bottom: 10px;border-bottom: 1px solid black;" alt="">
     <img src="imagens/desstprestador2.png" width="65%" alt="">

      <hr style=" border-top: 1px solid black;">

      <li>Preencha o restante das informações¹ da DES-ST. </li>

      <img src="imagens/desspdados.png" width="100%" alt="">
      <p>¹Dependendo da escolha do Código de Situação Tributária (CST), os campos de Valores, Base e Alíquota estarão disponíveis.</p>

      <hr style=" border-top: 1px solid black;">

      <li>Após terminar de preencher os dados clique em "Salvar".</li>
      <img src="imagens/desspsalvar.png" width="100%" alt="">


      <hr style=" border-top: 1px solid black;">

       <h2 align="center">DES SP Facultativa</h2>

      <p>Os contribuintes em regime Nota Fiscal de Prestação de Serviço Eletrônica - NFPS-e estão desobrigados da entrega da DES-SP, conforme previsto no decreto 17.753, Art. 25º, Item J de 03 de julho de 2017 (Clique Aqui), que cita:

        <br>
      <b>
      "As pessoas jurídicas, prestadoras de serviços, obrigadas ao uso de documentação fiscal na forma do art. 25 A, ficam dispensadas da entrega da declaração eletrônica prevista no art. 51, deste Anexo, relativamente aos serviços prestados." </b></p>
...
<iframe src="https://sefinnetweb.pmf.sc.gov.br/Sefinnet/hotSite.vm?tela=AREA_DES_SP&sistema=1" width="0" height="0"></iframe>
