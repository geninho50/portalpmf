...
<script>
  ...
  <link rel="canonical" href="http://www.pmf.sc.gov.br/sistemas/suporte/sefinnetsuporte/demonstrativopagamento.php"/>
  <meta property="og:locale" content="pt_BR"/>
  <meta property="og:type" content="website"/>
  <meta property="og:title" content="Demonstrativo de Pagamentos - Prefeitura de Florianópolis"/>
  ...
  <meta property="og:url" content="http://www.pmf.sc.gov.br/sistemas/suporte/sefinnetsuporte/demonstrativopagamento.php"/>
...
<body onload="carregaPopup()">
  ...
  <div id="conteudo_pagina" class="column6-lg"  style="margin:auto">
    ...
    <h2 align="center">Demonstrativo de Pagamentos</h2>
    ...
    <video width="600"  height="360"controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747; margin-left: 20%">
      <source src="imagens/Demonstrativo pagamento.mp4" type="video/mp4">
        Seu navegador não suporta HTML5.
      </video>


      <h3>Segue abaixo passo a passo de como visualizar o Demonstrativo de Pagamentos:</h3>

      <li>Primeiramente clique na aba "Impressões" e na opção "Demonstrativo de Pagamentos".</li>


      <img src="imagens/DemonstrativoPagamento1.png" width="100%"alt="">
     ...
     <img src="imagens/DemonstrativoPagamento2.png" width="100%" style="margin-bottom: 10px;border-bottom: 1px solid black;" alt="">
    ...
    <iframe src="https://sefinnetweb.pmf.sc.gov.br/Sefinnet/hotSite.vm?tela=AREA_DEMONSTRATIVO_PAGAMENTO&sistema=1" width="0" height="0"></iframe>
