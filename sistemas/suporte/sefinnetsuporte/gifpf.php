...
<script>
  ...
  <link rel="canonical" href="http://www.pmf.sc.gov.br/sistemas/suporte/sefinnetsuporte/gifpf.php"/>
  <meta property="og:locale" content="pt_BR"/>
  <meta property="og:type" content="website"/>
  <meta property="og:title" content="GIF PF - Prefeitura de Florianópolis"/>
  ...
  <meta property="og:url" content="http://www.pmf.sc.gov.br/sistemas/suporte/sefinnetsuporte/gifpf.php"/>
...
<body onload="carregaPopup()">
  ...
  <div id="conteudo_pagina" class="column6-lg"  style="margin:auto">
    ...
    <a type="button" class="btn btn-primary botao" href="https://sefinnetweb.pmf.sc.gov.br/Sefinnet/pessoafisica/index.vm" target="_blank" style="color: white;margin-bottom:20px;margin-top: 20px">Sistema Sefinnet Web</a>

    <h2 align="center">GIF PF</h2>
    ...
    <video width="600"  height="360"controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747; margin-left: 20%">
      <source src="imagens/GIF PF.mp4" type="video/mp4">
        Seu navegador não suporta HTML5.
      </video>

      <h3>Quem deverá realizar essa declaração?</h3>
      <p>Os Profissionais Autônomos de Nível Superior do Município de Florianópolis deverão realizar sua declaração GIF PF Anualmente em Janeiro, nesta declaração os mesmos deverão informar se irão prestar serviços, caso sim o valor do respectivo ISSQN poderá ser pago em conta Única com Desconto ou ser parcelado em até 12x com vencimento em 20/01.</p>

      <h3>Segue abaixo passo a passo como Realizar uma Nova Declaração GIF PF:</h3>

      <li>Selecione a opção Novo no menu Superior a Esquerda para criar uma Nova Declaração.</li>


      <img src="imagens/pfnova.png" width="100%"alt="">

      <hr style=" border-top: 1px solid black;">

      <li>No campo "Período de Apuração" informe a competência.</li>
      <li>No campo "Suspender o CMC?", caso não ocorra prestação do serviço na competência, selecione a opção para suspender o CMC. Desta forma não será cobrado o ISS.</li>
      <li>No campo de parcelar, escolha se deseja parcelar o valor no ISS ou pagar uma cota única.</li>

      <img src="imagens/apuracaopf.png" width="100%" alt="">

      <hr style=" border-top: 1px solid black;">

      <li>Na aba "Informações Cadastrais" preencha as informações de acordo com os campos. ¹</li>

      <img src="imagens/pfinformacoescadastrais.png" width="100%" alt="">
      <p><em>¹ Caso não seja sua primeira declaração, as informações serão automaticamente preenchidas.</em></p>
      <hr style=" border-top: 1px solid black;">

      <li>Na aba "Inscrições CMC" clique em "Inserir", preencha as informações e clique em "Salvar".</li>
      <img src="imagens/pfinscricoescmc.png" width="100%" alt="">

      <hr style=" border-top: 1px solid black;">

      <li>Caso deseje, na aba "Formas de Pagamento" altere a quantidade de parcelas do pagamento.</li>

      <img src="imagens/pfformasdepagamento.png" width="100%" alt="">                 
      <br> <br>                

      <a type="button" class="btn btn-primary botao" href="/tutorialsefinnet.php" style="color: white;margin-bottom:20px;margin-top: 20px">Home</a>
    </div>

    <iframe src="https://sefinnetweb.pmf.sc.gov.br/Sefinnet/hotSite.vm?tela=AREA_MANUAIS_GIF_PF&sistema=1" width="0" height="0"></iframe>
