...
<script>
  ...
  <link rel="canonical" href="http://www.pmf.sc.gov.br/sistemas/suporte/sefinnetsuporte/desst.php"/>
  ...
  <meta property="og:url" content="http://www.pmf.sc.gov.br/sistemas/suporte/sefinnetsuporte/desst.php"/>
...
<body onload="carregaPopup()">
  ...
  <div id="conteudo_pagina" class="column6-lg"  style="margin:auto">
    ...
    <video width="600"  height="360"controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747; margin-left: 20%">
      <source src="imagens/DES ST.mp4" type="video/mp4">
        Seu navegador não suporta HTML5.
      </video>


      <h3>Segue abaixo passo a passo de como declarar um Serviço Tomado (DES ST):</h3>

      <li>Acesse e faça login no SefinnetWeb: <a href="http://sefinnetweb.pmf.sc.gov.br/Sefinnet/capa.vm">sefinnetweb.pmf.sc.gov.br</a></li>
      <li>Selecione a opção "Novo" no menu Superior a Esquerda para criar uma nova DES ST.</li>


      <img src="imagens/desst.png" width="70%"alt="">

      <hr style=" border-top: 1px solid black;">

      <li>Preencha os dados do Prestador</li>

     <img src="imagens/desstprestador.png" width="100%" style="margin-bottom: 10px;border-bottom: 1px solid black;" alt="">
     <img src="imagens/desstprestador2.png" width="65%" alt="">
      ...
      <img src="imagens/desstdados.png" width="100%" alt="">
      ...
      <img src="imagens/desstsalvar.png" width="100%" alt="">
  ...
  <iframe src="https://sefinnetweb.pmf.sc.gov.br/Sefinnet/hotSite.vm?tela=AREA_DES_ST&sistema=1" width="0" height="0"></iframe>
