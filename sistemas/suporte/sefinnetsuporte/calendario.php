...
<link rel="canonical" href="http://www.pmf.sc.gov.br/sistemas/suporte/sefinnetsuporte/calendario.php"/>
<meta property="og:locale" content="pt_BR"/>
<meta property="og:type" content="website"/>
<meta property="og:title" content="Calendário- Prefeitura de Florianópolis"/>
...
<meta property="og:url" content="http://www.pmf.sc.gov.br/sistemas/suporte/sefinnetsuporte/calendario.php"/>
...
<body onload="carregaPopup(), carregaIframe()">
  <?php
...
<div id="iframeCalendario" style="display:none">
<iframe src="https://sefinnetweb2.pmf.sc.gov.br/Sefinnet/calendario.vm" scrolling="no" width="490" height="2700" frameborder="0"></iframe>
</div>
</div>

<iframe src="https://sefinnetweb.pmf.sc.gov.br/Sefinnet/hotSite.vm?tela=DECL_MANUAIS_SISTEMA_CALENDARIO&sistema=1" width="0" height="0"></iframe>
...
<script>
  ...
  function carregaIframe(){
      document.getElementById("iframeCalendario").style.display = "block";
  }
            ...
            function changeStatus(status) {
                switch (status) {
                    case 0:
                        ...
                        document.getElementById("ambientetestes").style = "display: none";
                    ...
                    case 2:
                        document.getElementById("java").style = "display: none";
                        document.getElementById("ambientetestes").style = "display: block";
                        document.getElementById("certificadoDigital").style = "display: none";
                        break;
                        break;
                    default:
