...
<script>
  ...
  <title>Alerta de Pendência Fiscal</title>
...
<link rel="canonical" href="http://www.pmf.sc.gov.br/sistemas/suporte/sefinnetsuporte/alertapendencia.php"/>
...
<meta property="og:url" content="http://www.pmf.sc.gov.br/sistemas/suporte/sefinnetsuporte/alertapendencia.php"/>
...
<h2 align="center">Alerta de Pendência Fiscal</h2>

<p>Um Alerta de Pendência Fiscal é um aviso apresentado pelo SefinnetWeb ao Contribuinte ou seu Representante Legal, para que sejam tomadas determinadas providências em caráter de auto regularização, evitando assim sanções previstas na legislação atual.</p>
<p>O Auditor Fiscal de Tributos Municipais - AFTM vinculado a este contribuinte receberá uma cópia deste Alerta de Pendência Fiscal para acompanhar as providências realizadas e caso as mesmas não ocorram realizar determinadas ações conforme previsto na legislação atual.</p>

<h2><strong>Como visualizar a(s) Pendência(s) Fiscal(is) dos Contribuinte vinculados ao meu usuário?</strong></h2>
<p>As Pendência(s) Fiscal(is) são exibidas na Tela inicial do SefinnetWeb, para maiores informações <a href="https://sefinnetweb.pmf.sc.gov.br/passo_a_passo/fiscalizacaoAlertaPendenciaFiscal.pdf" style="color:blue" target="_blank">Clique Aqui</a>.</p>

<h2><strong>Como e quando é emitido um Alerta de Pendência Fiscal?</strong></h2>
<p>O sistema SefinnetWeb possui um processo de monitoramento das declarações, realizando determinadas validações e cruzamento de informações internas e externas, de forma periódica para cada Alerta, e ao encontrar uma determinada inconsistência é gerado automaticamente uma Pendência Fiscal.</p>

<h2><strong>Como proceder ao receber um Alerta de Pendência Fiscal?</strong></h2>
<p>O Contribuinte ou seu Representante Legal deverá proceder à determinada providência informada no respectivo alerta o quanto antes. Assim que a determinada providência for resolvida o Alerta de Pendência Fiscal será concluído e não será mais apresentado na tela inicial do SefinnetWeb.</p>

<h2><strong>Existe um prazo para proceder à providência informada no Alerta de Pendência Fiscal?</strong></h2>
<p>O SefinnetWeb registra a data de publicação e a visualização ou ciência de cada Alerta de Pendência Fiscal. Logo, todo alerta deverá será regularizado com a máxima urgência.</p>

<h2><strong>Realizei a(s) providência(s) referente(s) a um determinado Alerta de Pendência Fiscal e o mesmo continua como Pendente, como proceder?</strong></h2>
<p>Entre em contato com a Equipe de Suporte a Sistemas da Secretaria da Fazenda da Prefeitura Municipal de Florianópolis informando o CMC, Competência e o tipo de Alerta de Pendência Fiscal para análise.</p>
...
<iframe src="https://sefinnetweb.pmf.sc.gov.br/Sefinnet/hotSite.vm?tela=AREA_ALERTA_PENDENCIA_FISCAL&sistema=1" width="0" height="0"></iframe>
