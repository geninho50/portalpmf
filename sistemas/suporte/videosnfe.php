...
<div style="display:flex;">
 ...
 <div class="col-md-12" align="center">
   <div class="col-md-4">
    <video poster="nfpssuporte/imagens/thumbnail.png" width="320"  height="240"controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747">
      <source src="nfpssuporte/imagens/Emitir nota.mp4" type="video/mp4">
        Seu navegador não suporta HTML5.
      </video>
    <a href="nfpssuporte/emitirnota.php" target="_blank"><h4>Emitir Nota Eletrônica 🔗</h4></a>
  </div>


 <div class="col-md-4">
    <video poster="nfpssuporte/imagens/thumbnail.png" width="320"  height="240"controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747">
      <source src="nfpssuporte/imagens/Emitir nota simplificada.mp4" type="video/mp4">
        Seu navegador não suporta HTML5.
      </video>
    <a href="nfpssuporte/emitirnotasimplificada.php" target="_blank"><h4>Emitir Nota Simplificada 🔗</h4></a>
  </div>
 ...
 <div class="col-md-4">
    <video poster="nfpssuporte/imagens/thumbnail.png" width="320"  height="240"controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747">
     ...
     <a href="nfpssuporte/emitirnotacelular.php" target="_blank"><h4>Emitir Nota no Celular 🔗</h4></a>
  </div>

  <div class="col-md-4">
    <video poster="nfpssuporte/imagens/thumbnail.png" width="320"  height="240"controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747">
      <source src="nfpssuporte/imagens/Substituir nota.mp4" type="video/mp4">
        Seu navegador não suporta HTML5.
      </video>
     <a href="nfpssuporte/substituirnota.php" target="_blank"><h4>Substituir Nota 🔗</h4></a>
  </div>

  <div class="col-md-4">
    <video poster="nfpssuporte/imagens/thumbnail.png" width="320"  height="240"controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747">
      <source src="nfpssuporte/imagens/Clonar Nota.mp4" type="video/mp4">
        Seu navegador não suporta HTML5.
      </video>
    <a href="nfpssuporte/clonarnota.php" target="_blank"><h4>Copiar Nota 🔗</h4></a>
  </div>
  ...
  <div class="col-md-4">
    ...
    <a href="nfpssuporte/cancelarnota.php" target="_blank"><h4>Cancelar Nota 🔗</h4></a>
  </div>
    ...
    <a href="nfpssuporte/baixarxmlpdf.php" target="_blank"><h4>Baixar XML e PDF da Nota 🔗</h4></a>
  </div>

    <div class="col-md-4">
    <video poster="nfpssuporte/imagens/thumbnail.png" width="320"  height="240"controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747">
      <source src="nfpssuporte/imagens/Trocar Senha.mp4" type="video/mp4">
        Seu navegador não suporta HTML5.
      </video>
    <a href="nfpssuporte/recuperarsenha.php" target="_blank"><h4>Recuperar/Trocar Senha 🔗</h4></a>
  </div>
 ...
 <div class="col-md-4">
    ...
    <a href="nfpssuporte/adesaopf.php" target="_blank"><h4>Adesão Pessoa Física 🔗</h4></a>
  </div>
  ...
  <div class="col-md-4">
    ...
    <a href="nfpssuporte/consultar.php" target="_blank"><h4>Consultar Nota 🔗</h4></a>
  </div>

  <div class="col-md-4">
    <video poster="nfpssuporte/imagens/thumbnail.png" width="320"  height="240"controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747">
      <source src="nfpssuporte/imagens/nfpse_limitesn.mp4" type="video/mp4">
        Seu navegador não suporta HTML5.
      </video>
    <a href="nfpssuporte/limitesn.php" target="_blank"><h4>Limite Simples Nacional 🔗</h4></a>
  </div>
