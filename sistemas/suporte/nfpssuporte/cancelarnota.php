...
<script>
  ...
  <title>Cancelar Nota Eletrônica</title>
     <?php
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="Suporte Nota Fiscal Eletrônica - Prefeitura de Florianópolis. Como Cancelar uma Nota Fiscal Eletrônica."/>
    <meta name="keywords" content="Nota fiscal,nota fiscal eletrônica,nf, como cancelar nota fiscal, como cancelar, como deletar nota fiscal, como cancelar nfps, como excluir nota fiscal eletrônica, nota fiscal pmf exclusão, nota florianópolis, florianópolis, nota fiscal eletrônica deleção, transmissão, criação de nota fiscal"/>
    <meta name="robots" content="index,follow"/>
    <meta name="googlebot" content="index,follow"/>
    <link rel="canonical" href="http://www.pmf.sc.gov.br/sistemas/suporte/nfpsSuporte/cancelarnota.php"/>
    <meta property="og:locale" content="pt_BR"/>
    <meta property="og:type" content="website"/>
    <meta property="og:title" content="Cancelar Nota Eletrônica"/>
    <meta name="description" content="Suporte Nota Fiscal Eletrônica - Prefeitura de Florianópolis. Como Cancelar uma Nota Fiscal Eletrônica."/>
    <meta property="og:url" content="http://www.pmf.sc.gov.br/sistemas/suporte/nfpsSuporte/cancelarnota.php"/>
    <meta property="og:site_name" content="Cancelar Nota Eletrônica"/>
...
<div id="conteudo_pagina" class="column6-lg" align="justify" style="margin:auto">
   ...
   <h2 align="center">Como Cancelar uma Nota Fiscal Eletrônica</h2>
  ...
  <video poster="imagens/thumbnail.png" width="600"  height="360"controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747; margin-left: 20%;">
      <source src="imagens/Cancelar Nota.mp4" type="video/mp4">
        Seu navegador não suporta HTML5.
      </video>


  <p>O Sistema de Nota Fiscal de Prestação de Serviço Eletrônica está  disponível para todos os contribuintes do Município de Florianópolis.  Utilize o descritivo abaixo para lhe auxiliar no cancelamento de um Nota Fiscal de Prestação de Serviços Eletrônica.</p>

  <p>Ao acessar o Sistema de NFPS-e o Contribunte deverá consultar sua Nota Fiscal Eletrônica a ser cancelada.</p>
  <img src="imagens/ProcurarNota.png" alt="" width="100%">

   <hr style=" border-top: 1px solid black;">
  <p>Selecione o icone de ações a direita para ter acesso as demais opções. Selecione a opção "Cancelar".</p>
  <img src="imagens/OpcaoCancelar.png" alt="" width="100%">

  <hr style=" border-top: 1px solid black;">
  <p>Confira o Número da Nota Fiscal Eletrônica e informe o Motivo do Cancelamento. Ao final clique em "Confirmar Cancelamento".</p>
  <img src="imagens/Descricao.png" alt="" width="100%">

  <hr style=" border-top: 1px solid black;">
  <p>O Sistema irá realizar o Cancelamento, apresentando a respectiva Nota Fiscal Eletrônica com o ícone de "Cancelada" e o email será encaminhado.</p>
  <img src="imagens/FinalCancelar.png" alt="" width="100%">
