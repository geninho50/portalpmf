...
<script>
  ...
  <title>Consulta Autenticidade NFPS-e Produção</title>
     <?php
    ...
    ?>
      ...
      <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="Suporte Nota Fiscal Eletrônica - Prefeitura de Florianópolis. Autenticidade Nota Fiscal Eletrônica Produção."/>
    <meta name="keywords" content="Nota fiscal,nota fiscal eletrônica,nf, nfps,autenticidade,autenticação,Produção"/>
    <meta name="robots" content="index,follow"/>
    <meta name="googlebot" content="index,follow"/>
    <meta itemprop="description" content="Suporte Nota Fiscal Eletrônica - Prefeitura de Florianópolis. Autenticidade Nota Fiscal Eletrônica Produção."/> 
    <link rel="canonical" href="http://www.pmf.sc.gov.br/sistemas/suporte/nfpssuporte/autenticidade.php"/>
    <meta property="og:locale" content="pt_BR"/>
    <meta property="og:type" content="website"/>
    <meta property="og:title" content="Consulta Autenticidade NFPS-e Produção"/>
    <meta property="og:description" content="Suporte Nota Fiscal Eletrônica - Prefeitura de Florianópolis. Autenticidade Nota Fiscal Eletrônica Produção."/>
    <meta property="og:url" content="http://www.pmf.sc.gov.br/sistemas/suporte/nfpssuporte/autenticidade.php"/>
    <meta property="og:site_name" content="Consulta Autenticidade NFPS-e Produção"/>
...
<div id="conteudo_pagina" class="column6-lg" align="justify" style="margin:auto">
  ...
  <h2 align="center">NFPS-e - Consulta de autenticidade Produção</h2>

  <br>

  <p>A consulta à NFPS-e poderá ser realizada no prazo máximo de 180 dias contados a partir da data de emissão e mediante a informação do respectivo código de verificação.</p>
  <p><b>Observação:</b> Recomenda-se o uso dos navegadores Mozilla Firefox, Google Chrome ou Microsoft Edge para realizar a consulta. O navegador Internet Explorer não é suportado.</p>

  <iframe src="https://nfps-e.pmf.sc.gov.br/consulta-frontend/" mce_src="https://nfps-e.pmf.sc.gov.br/consulta-frontend/" scrolling="no" width="100%" height="400" frameborder="0"></iframe>                
</div>
...
<div id="popup_ie" align="center" style="display:none; position:fixed;bottom:20px;left:5%;width:400px;height: 80px;background-color: white;border: 2px solid #5A7696;color: #13A0DD">
 <button type="button" onclick="fechaPopup()" style="float:right;color: white;background-color: #F17446">X</button> 
 <br>
 <div style="margin: 0px 5px 2px 5px;">
  Observação: a consulta de autenticação não é suportada no seu navegador, por favor utilize o Mozilla Firefox, Google Chrome ou Microsoft Edge.
 </div>
</div>

<iframe src="https://sefinnetweb.pmf.sc.gov.br/Sefinnet/hotSite.vm?tela=AREA_VERIFICA_AUTENTICIDADE&sistema=3" width="0" height="0"></iframe>
...
<script>
  ...
  function carregaPopup(){
      ...
      var mostrarPopup = "<?php echo $aviso ?>";
       if(mostrarPopup==1 && isIE == false){
           document.getElementById("popup_novo_site").style.display = "block";
        }else if(isIE==true){
          document.getElementById("popup_ie").style.display = "block";
        }
  }
  function fechaPopup(){
    document.getElementById("popup_novo_site").style.display = "none";
    document.getElementById("popup_ie").style.display = "none";
  }
