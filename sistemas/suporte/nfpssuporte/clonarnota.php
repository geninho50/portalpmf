...
<script>
  ...
  <title>Copiar Nota Eletrônica</title>
     <?php
   ...
   <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="Suporte Nota Fiscal Eletrônica - Prefeitura de Florianópolis. Como Copiar uma Nota Fiscal Eletrônica."/>
    <meta name="keywords" content="Nota fiscal,nota fiscal eletrônica,nf, como copiar nota fiscal, como copiar, como duplicar nota fiscal, como duplicar nfps, como clonar nota fiscal eletrônica, nota fiscal pmf clonar, nota florianópolis clonar, florianópolis, nota fiscal eletrônica clonagem, copiar, duplicar de nota fiscal,duplicar"/>
    <meta name="robots" content="max-snippet:-1, max-image-preview:large, max-video-preview:-1"/>
    <link rel="canonical" href="http://www.pmf.sc.gov.br/sistemas/suporte/nfpsSuporte/clonarnota.php"/>
    <meta property="og:locale" content="pt_BR"/>
    <meta property="og:type" content="website"/>
    <meta property="og:title" content="Copiar Nota Eletrônica"/>
    <meta property="og:description" content="Suporte Nota Fiscal Eletrônica - Prefeitura de Florianópolis. Como Copiar uma Nota Fiscal Eletrônica."/>
    <meta property="og:url" content="http://www.pmf.sc.gov.br/sistemas/suporte/nfpsSuporte/clonarnota.php"/>
    <meta property="og:site_name" content="Copiar Nota Eletrônica"/>
...
<div id="conteudo_pagina" class="column6-lg" align="justify" style="margin:auto">
 ...
 <h2 align="center">Como Copiar uma Nota Fiscal Eletrônica</h2>
  ...
  <video poster="imagens/thumbnail.png" width="600"  height="360"controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747; margin-left: 20%;">
      <source src="imagens/Clonar Nota.mp4" type="video/mp4">
        Seu navegador não suporta HTML5.
      </video>

    <br><br>
 <p>O Sistema de Nota Fiscal de Prestação de Serviço Eletrônica está disponível para todos os contribuintes do Município de Florianópolis.   Utilize o descritivo abaixo para lhe auxiliar no procedimento de clonagem de um Nota  Fiscal de Prestação de Serviços Eletrônica.</p>
 <p>Ao acessar o Sistema de NFPS-e o Contribunte deverá consultar sua Nota Fiscal Eletrônica a ser clonada.</p>
 <img src="imagens/ProcurarNota.png" alt="" width="100%"> 
 <hr style=" border-top: 1px solid black;">
 <p>Selecione o icone a direita para ter acesso as demais opções. Selecione a opção "Clonar".</p>
 <img src="imagens/OpcaoClonar.png" alt="" width="100%"> 
 <hr style=" border-top: 1px solid black;">
 <p>Informe a Data da Emissão da Nota Fiscal e a respectiva AEDF.</p>
 <img src="imagens/Data.png" alt="" width="100%"> 
 <hr style=" border-top: 1px solid black;">
 <p>Caso deseje altere as informações do Tomador do Serviço (Contratante) e selecione a opção "Prosseguir".</p>
 <img src="imagens/Tomador.png" alt="" width="100%"> 
  <hr style=" border-top: 1px solid black;">
 <p>O Sistema lhe apresentará as informações sobre os Serviços contidos nesta Nota Fiscal, podendo ser ajustado caso necessário. Selecione a opção "Prosseguir".</p>
 <img src="imagens/Servicos.png" alt="" width="100%"> 
 <hr style=" border-top: 1px solid black;">
 <p>Visualize as informações, conferindo se os dados estão corretos e prossiga selecionando a opção "Transmitir".</p>
 <img src="imagens/FIM.png" alt="" width="100%"> 
 <hr style=" border-top: 1px solid black;">
 ...
 <img src="imagens/Final.png" alt="" width="100%"> 
 <hr style=" border-top: 1px solid black;">
...
<div id="popup_novo_site" align="center" style="display:none; position:fixed;bottom:20px;left:5%;width:360px;height: 80px;background-color: white;border: 2px solid #5A7696;color: #13A0DD">
 ...
 <br>
 Bem vindo(a) ao novo site de Suporte da Nota Eletrônica! <a href="/tutorialnfps.php" style="text-decoration: underline;">Clique aqui</a> para conhecer a Central.
</div>


<iframe src="https://sefinnetweb.pmf.sc.gov.br/Sefinnet/hotSite.vm?tela=AREA_WEB_COMO_CLONAR&sistema=3" width="0" height="0"></iframe>
