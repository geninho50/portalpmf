...
<script>
 ...
 <meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    <link rel="canonical" href="http://www.pmf.sc.gov.br/sistemas/suporte/nfpssuporte/emitirnotacelular.php"/>
    ...
    <meta property="og:url" content="http://www.pmf.sc.gov.br/sistemas/suporte/nfpssuporte/emitirnotacelular.php"/>
...
<div id="conteudo_pagina" class="column6-lg" align="justify" style="margin:auto;">
 ...
 <a href="https://nfps-e.pmf.sc.gov.br/frontend/#!/login" target ="_blank"> <img src="imagens/login.png" alt="" width="100%"></a>
  ...
  <p>Selecione a opção "Criar Nova Nota" no canto superior da tela. As caixas de texto "Documento do tomador", "Nome do tomador", "Período inicio emissão" e "Período fim emissão" servem <b>apenas</b> para pesquisar notas fiscais, como pode ser visto <a href="consultar.php" target="_blank" style="color:blue">aqui</a>.</p>
  <img style="border: 1px solid grey;" src="imagens/CriarNotaCelular.png" alt="" width="100%">
  ...
  <img style="border: 1px solid grey;" src="imagens/AdicionarServicoCelular.png" alt="" width="100%">
  ...
  <img style="border: 1px solid grey;" src="imagens/TransmitirCelular.png" alt="" width="100%">
  ...
  <img style="border: 1px solid grey;" src="imagens/FimCelular.png" alt="" width="100%">        
<hr style=" border-top: 1px solid black;">
