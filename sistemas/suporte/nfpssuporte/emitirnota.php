...
<script>
  ...
  <title>Emitir Nota Eletrônica</title>
   ...
   <meta name="robots" content="index,follow"/>
    ...
    <link rel="canonical" href="http://www.pmf.sc.gov.br/sistemas/suporte/nfpssuporte/emitirnota.php"/>
    ...
    <meta property="og:url" content="http://www.pmf.sc.gov.br/sistemas/suporte/nfpssuporte/emitirnota.php"/>
...
<div id="conteudo_pagina" class="column6-lg" align="justify" style="margin:auto;">
  ...
  <a href="https://nfps-e.pmf.sc.gov.br/frontend/#!/login" target ="_blank"> <img src="imagens/TELALOGIN.png" alt="" width="100%"></a> <br>
  ...
  <a href="https://nfps-e.pmf.sc.gov.br/frontend/#!/login" target ="_blank"> <img src="imagens/0 - LoginCertificado.png" alt="" width="100%"> </a><br>
  <hr style=" border-top: 1px solid black;">
  ...
  <a href="https://nfps-e.pmf.sc.gov.br/frontend/#!/login" target ="_blank"> <img src="imagens/login.png" alt="" width="100%"></a>
  ...
  <img style="border: 1px solid grey;" src="imagens/1 - Criar Nota.png" alt="" width="100%">
  ...
  <p>Preencha os dados do Tomador do Serviço (dados da pessoa ou entidade a quem você prestou o serviço).</p>
  <img src="imagens/3 - Tomador.png" alt="" width="100%">
