...
<script>
  ...
  <title>Consulta Autenticidade NFPS-e Homologação</title>
     <?php
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="Suporte Nota Fiscal Eletrônica - Prefeitura de Florianópolis. Autenticidade Nota Fiscal Eletrônica Homologação."/>
    <meta name="keywords" content="Nota fiscal,nota fiscal eletrônica,nf, nfps,autenticidade,autenticação,homologação"/>
    <meta name="robots" content="max-snippet:-1, max-image-preview:large, max-video-preview:-1"/>
    <link rel="canonical" href="http://www.pmf.sc.gov.br/sistemas/suporte/nfpssuporte/autenticidadehomologacao.php"/>
    <meta property="og:locale" content="pt_BR"/>
    <meta property="og:type" content="website"/>
    <meta property="og:title" content="Consulta Autenticidade NFPS-e Homologação"/>
    <meta property="og:description" content="Suporte Nota Fiscal Eletrônica - Prefeitura de Florianópolis. Autenticidade Nota Fiscal Eletrônica Homologação."/>
    <meta property="og:url" content="http://www.pmf.sc.gov.br/sistemas/suporte/nfpssuporte/autenticidadehomologacao.php"/>
    <meta property="og:site_name" content="Consulta Autenticidade NFPS-e Homologação"/>
...
<div id="conteudo_pagina" class="column6-lg" align="justify" style="margin:auto">
  ...
  <h2 align="center">NFPS-e - Consulta de autenticidade Homologação</h2>

  <br>
  <p>Esta página permite a consulta de NFPS-e emitidas no ambiente de homologação. As notas fiscais consultadas aqui não tem valor fiscal.</p>
  ...
  <iframe src="https://nfps-e-hml.pmf.sc.gov.br/consulta-frontend" mce_src="https://nfps-e-hml.pmf.sc.gov.br/consulta-frontend" scrolling="no" width="490" height="400" frameborder="0"></iframe>     
...
<iframe src="https://sefinnetweb.pmf.sc.gov.br/Sefinnet/hotSite.vm?tela=AREA_VERIFICA_AUTENTICIDADE_H&sistema=3" width="0" height="0"></iframe>
