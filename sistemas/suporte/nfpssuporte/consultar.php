...
<script>
  ...
  <title>Como Consultar Nota Eletrônica</title>
     <?php
    ...
    <link rel="canonical" href="http://www.pmf.sc.gov.br/sistemas/suporte/nfpssuporte/consultar.php"/>
    <meta property="og:locale" content="pt_BR"/>
    <meta property="og:type" content="website"/>
    <meta property="og:title" content="Cancelar Nota Eletrônica"/>
    <meta name="description" content="Suporte Nota Fiscal Eletrônica - Prefeitura de Florianópolis. Como Cancelar uma Nota Fiscal Eletrônica."/>
    <meta property="og:url" content="http://www.pmf.sc.gov.br/sistemas/suporte/nfpssuporte/consultar.php"/>
...
<div id="conteudo_pagina" class="column6-lg" align="justify" style="margin:auto">
   ...
   <h2 align="center">Como Consultar uma Nota Eletrônica no Computador e no Celular</h2>
  ...
  <video poster="imagens/thumbnail.png" width="600"  height="360"controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747; margin-left: 20%;">
      <source src="imagens/nfpse_consultar.mp4" type="video/mp4">
...
<br><br>
  ...
  <p><b>Para consultar uma nota já enviada no <a href="https://nfps-e.pmf.sc.gov.br/frontend/#!/login" target="_blank" style="color:blue">Sistema Web</a>,  <u>faça login e acesse a página incial do sistema</u> </b>, utilize os filtros de pesquisa para encontrar a nota desejada, depois clique em "Consultar". Caso não forneça nenhuma informação nos campos de pesquisa todas as notas serão exibidas.</p>
  <img src="imagens/Consultar1.png" alt="" width="100%">

   <hr style=" border-top: 1px solid black;">
  <p>No celular, clique no icone azul com a seta branca para exibir todas as notas, ou utilize os filtros de pesquisa para encontrar a nota desejada, depois clique no icone.</p>
  <img src="imagens/Consultar2.png" alt="" width="100%">
...
<iframe src="https://sefinnetweb.pmf.sc.gov.br/Sefinnet/hotSite.vm?tela=AREA_WEB_COMO_CONSULTAR_NOTA&sistema=3" width="0" height="0"></iframe>
