...
<script>
  ...
  <title>Limite Simples Nacional</title>
     <?php
  ...
  <br>
    ...
    <link rel="canonical" href="http://www.pmf.sc.gov.br/sistemas/suporte/nfpssuporte/limitesn.php"/>
    ...
    <meta property="og:url" content="http://www.pmf.sc.gov.br/sistemas/suporte/nfpssuporte/limitesn.php"/>
...
<div id="conteudo_pagina" class="column6-lg" align="justify" style="margin:auto">
  ...
  <h2 align="center">Como configurar o limite do Simples Nacional</h2>
    ...
    <video poster="imagens/thumbnail.png" width="600"  height="360"controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747; margin-left: 20%;">
      <source src="imagens/nfpse_limitesn.mp4" type="video/mp4">
        Seu navegador não suporta HTML5.
      </video>
<br><br>

  <p>Para configurar a Ultrapassagem de Limites e Sublimites do Simples Nacional, clique no ícone com três linhas.</strong></p>
  <img src="imagens/limitesn1.png" alt="" width="100%">
  <br>
  <hr style=" border-top: 1px solid black;">
  <p>Selecione a opção "Configurar a Ultrapassagem de Limites e Sublimites do Simples Nacional".</p>
  <img src="imagens/limitesn2.png" alt="" width="100%">
   <hr style=" border-top: 1px solid black;">
  <li>Ao ativar a opção de Ultrapassagem estarão disponíveis os CSTs para o regime normal.</li>
  <li>Ao desativar essa opção estarão disponíveis os CSTs do simples nacional.</li>
  <li>Clique em "Salvar" ao terminar.</li>
  <img src="imagens/limitesn3.png" alt="" width="100%">
   <hr style=" border-top: 1px solid black;">                   
  <br>   
...
<iframe src="https://sefinnetweb.pmf.sc.gov.br/Sefinnet/hotSite.vm?tela=AREA_WEB_LIMITE_SIMPLES_NACIONAL&sistema=3" width="0" height="0"></iframe>
