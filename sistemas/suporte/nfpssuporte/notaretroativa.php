...
<script>
  ...
  <br>
    ...
    <link rel="canonical" href="http://www.pmf.sc.gov.br/sistemas/suporte/nfpssuporte/substituirnota.php"/>
    ...
    <meta property="og:url" content="http://www.pmf.sc.gov.br/sistemas/suporte/nfpssuporte/substituirnota.php"/>
...
<div id="conteudo_pagina" class="column6-lg" align="justify" style="margin:auto">
  ...
  <h2 align="center">É possível realizar uma Nota com data Retroativa?</h2>

  <p>Sim, no entanto existem algumas regras que devem ser seguidas, são elas:</p>
  <ul>
    <li><p>Não é possível criar uma nova nota com data anterior a da ultima nota emitida válida e não cancelada.</p></li>
    <li><p>Não é possível criar uma nova nota com data anterior a de sua Autorização de Emissão de Documento Fiscal Eletrônico (AEDF-e).</p></li>
  </ul>
