...
<script>
  ...
  <title>Recuperar Senha</title>
    ...
    <link rel="canonical" href="http://www.pmf.sc.gov.br/sistemas/suporte/nfpssuporte/recuperarsenha.php"/>
    ...
    <meta property="og:url" content="http://www.pmf.sc.gov.br/sistemas/suporte/nfpssuporte/recuperarsenha.php"/>
...
<p>Para recuperar sua senha como MEI ou Profissional Autônomo, escolha a opção "Realizar Login sem Certificado Digital". Insira seu <b>CMC</b> e clique no botão "Esqueci Minha Senha".</p>
  <img style="border: 1px solid grey;" src="imagens/Esqueci.png" alt="" width="100%">        
<hr style=" border-top: 1px solid black;">

  <p>Confirme se o e-mail cadastrado para a recuperação é o correto e clique em "Enviar".</p>
<img style="border: 1px solid grey;" src="imagens/EmailSenha.png" alt="" width="100%">        
<hr style=" border-top: 1px solid black;">
  ...
  <img style="border: 1px solid grey;" src="imagens/CodigoFinal.png" alt="" width="100%">        
  <hr style=" border-top: 1px solid black;">
