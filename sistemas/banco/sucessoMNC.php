...
<html lang='pt-BR'>
  ...
  <body>
    <div class="container">
        ...
        <br><br><br>
        <p><strong><font color="red">Imprima seu comprovante</font></strong> de inscri&ccedil;&atilde;o que dever&aacute; ser <strong><font color="red">apresentado no dia</font></strong> do curso junto com um comprovante de resid&ecirc;ncia.</p>
        <br>
            <strong>
              <a href="../MinhocaCabeca/comprovante.php?codigoPessoa=<? print $_GET['codigo'];?>&codigoTurma=<? print $_GET['curso'];?>"><button class="btn btn-danger btn-lg btn-block"  role="button">IMPRIMIR</button></a>
           </strong>
        
        <br><br>
        <p>Qualquer altera&ccedil;&atilde;o na ficha de inscri&ccedil;&atilde;o deve ser solicitado por email, junto com o codigo de inscri&ccedil;&atilde;o, para: <font color="red"><strong>minhocanacabeca@comcap.org.br</strong></font></p>
