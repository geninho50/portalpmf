<?php
    ...
    if($gdb->atualizarParticipante($id_pessoa,$cpf,$nome,$rg,$nascimento,$email,$telefone,$celular,$profissao,$numero,$complemento,$quantidade_pessoa,$id_endereco,$cep,$logradouro,$bairro)) {
