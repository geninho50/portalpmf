...
<body>
<form name="login" action="certificado.php">
	  ...
	  <li class="mini-header__social-mobile">
		...
		<div class="flex-container hero-wrapper" id="solicite" >
			<div id="busca-home" class="search-bar search-bar--home column6-lg column8-sm column8-xs">
		        <h1 class="hidden-sm hidden-xs">Certificado</h1><br>
		        <p style="color: white;">Caso você já tenha feito a capacitação, insira seu CPF e obtenha seu certifidado.</p>
