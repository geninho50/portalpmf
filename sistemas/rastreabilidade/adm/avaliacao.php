...
/*
 ...
 $select = "select idavaliacao as chave,
            l.nome,
            a.pergunta1,
            a.pergunta2,
            a.pergunta3,
...
<div class="header">
  ...
  <ul class="header__nav">
	...
	<div class="flex-container hero-wrapper" style="overflow: auto;">
			...
			<div class="column4-lg column4-md column8-sm" style="padding-left: 15px; padding-bottom: 9px;">
 			...
 			<table class="table">
						...
						<tr>  
						   ...
						   <td align="center"><b>Pergunta 1</b></td>
						   <td align="center"><b>Pergunta 2</b></td>
						   <td align="center"><b>Pergunta 3</b></td>
						   <td align="center"><b>Pergunta 4</b></td>
						   <td align="center"><b>Pergunta 5</b></td>
						   <td align="center"><b>Data</b></td>
							...
							foreach($gdb->gs['CHAVE'] as $key=>$value){ 
								...
								<tr>
								   ...
								   <td align="center"><? print $gdb->gs['PERGUNTA1'][$key]; ?></td>
								   <td align="center"><? print $gdb->gs['PERGUNTA2'][$key]; ?></td>
								   <td align="center"><? print $gdb->gs['PERGUNTA3'][$key]; ?></td>
								   <td align="center"><strong><? print $gdb->gs['PERGUNTA4'][$key]; ?></strong></td>
								   <td align="center"><strong><? print $gdb->gs['PERGUNTA5'][$key]; ?></strong></td>
