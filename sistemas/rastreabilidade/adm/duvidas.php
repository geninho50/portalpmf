<?php
 ...
 $select = "select idduvida as chave,
	...
	<div class="flex-container hero-wrapper">
			...
			<div class="column4-lg column4-md column8-sm" style="padding-left: 15px; padding-bottom: 9px;">
				<form method="post" name="frmSituacao">	
					<h1 class="hidden-sm hidden-xs"><span style="color: black;">Dúvidas de Usuários:</span></h1><br>
					<div class="row">
						 <div class="col-md-3">
						...
						<? 
							foreach($gdb->gs['CHAVE'] as $key=>$value){
								...
								<tr>
								   ...
								   <td align="center"><? print $gdb->gs['DUVIDA'][$key]; ?></td>
								   <td align="center"><? print $gdb->gs['DATA'][$key]; ?></td>
								   <td align="center"><? print $gdb->gs['CHAVE'][$key]; ?></td>
