  ...
  <body>
    <div class="container">
        ...
        <div class="row">
           ...
           <div class="row">
            <div class="col-md-12">
            <h2>Identificação do candidato maior de 18 anos:</h2><br>
            </div>
            ...
            <div class="row">           
            <div class="col-md-6"><label id="nacionalidade" >Nacionalidade *</label><input type="text" name="nacionalidade" id="nacionalidade" class="form-control obrigatorio " /></div>
            <div class="col-md-6"><label id="lbcpf" >CPF *</label><input type="text" name="cpf" id="cpf" class="form-control obrigatorio " /></div>
            
            </div><br>

            <div class="row">           
            <div class="col-md-4"><label id="lbrg" >RG *</label><input type="text" name="rg" id="rg" class="form-control obrigatorio " /></div>
            <div class="col-md-4"><label id="lbemissor" >Órgão Emissor *</label><input type="text" name="emissor" id="emissor" class="form-control obrigatorio " /></div>
            <div class="col-md-4"><label id="lbexpedicao" >Expedição *</label><input type="text" name="expedicao" id="expedicao" class="form-control obrigatorio " /></div>
            </div><br>
