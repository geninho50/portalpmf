<<?php
	...
	/* CORPO DO E-MAIL */
	$body .= "<h2>Novo Código de Obras SMDU</h2>";
	$body .= "Nome: $nome <br>";
	$body .= "E-mail: $email <br>";
	$body .= "Ocupacao: $ocupacao<br>";
	$body .= "Tema: $tema<br>"
	$body .= "Sugestão:"
	$body .= $sugestao
	$body .= "<br>";
	...
	$mail->Host = "smtp-relay.gmail.com"; // SMTP servidor
	...
	$to = "thecinhoo@gmail.com"; //Enviar para
	$mail->AddAddress($to);
	$mail->Subject  = "Alteração para Novo Código de Obras de: $nome"; //Assunto
