...
<head>
    ...
    <title>Produto 4: Aspectos Legais</title>
...
<body>
    ...
    <div class="container">
        ...
        <h2 class="text-center">Produto 4: Aspectos Legais</h2>        
        ...
        <div class="pdf">
            <iframe src="http://www.pmf.sc.gov.br/sistemas/consulta/setur/arquivos/produto4.pdf" width="100%" height="100%" style="border: 1px solid;"></iframe>
        </div>
