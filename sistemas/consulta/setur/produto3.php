...
<head>
    ...
    <title>Produto 3: Estudo de Impacto Simplificado</title>
...
<body>
    ...
    <div class="container">
        ...
        <h2 class="text-center">Produto 3: Estudo de Impacto Simplificadoo</h2>
        ...
        <div class="pdf">
            <iframe src="http://www.pmf.sc.gov.br/sistemas/consulta/setur/arquivos/produto3.pdf" width="100%" height="100%" style="border: 1px solid;"></iframe>
        </div>
