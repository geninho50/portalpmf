...
<head>
    ...
    <title>Produto 1: Diagnóstico Ambiental Simplificado </title>
...
<body>
    ...
    <div class="container">
        ...
        <h2 class="text-center">Produto 1: Diagnóstico Ambiental Simplificado</h2>
        ...
        <div class="pdf">
            <iframe src="http://www.pmf.sc.gov.br/sistemas/consulta/setur/arquivos/produto1.pdf" width="100%" height="100%" style="border: 1px solid;"></iframe>
        </div>
