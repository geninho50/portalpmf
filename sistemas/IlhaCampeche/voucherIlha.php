...
$hoje      = date("d/m/Y");
$data      = $hoje;
$url       = "https://www.pmf.sc.gov.br/sistemas/IlhaCampeche/validar.php?codigo=";
$file      = "images/qrcode/";
$voucodigo = 0;
...
if( $temVoucher > 0 ){
    print 'Voce ja tem reserva nesse dia, segue abaixo :';        
...
if( $voucodigo>0 ){
    ...
    echo "<div><h4 class='alinharH4'>Sua reserva foi realizada com sucesso,<br> verifique o voucher abaixo</h4><br></div>";
    echo "<div><h4 class='alinharH4'>Documento so Será Validado com o documento em mãos</h4><br></div>";
