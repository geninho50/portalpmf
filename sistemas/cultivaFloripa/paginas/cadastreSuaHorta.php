				...
				<div class="row">
				  ...
				  <div class="col-md-5 col-xs-5">
						<div class="form-group">
						  ...
						  <input type="text" class="form-control" data-live-search="true" data-width="100%" name="Nome da Horta/Projeto" required>
						</div>
				  </div>
				  ...
				  <div class="col-md-5 col-xs-5">
						<div class="form-group">
						  ...
						  <input type="text" class="form-control" name="Nome do Responsável" placeholder="" required>
						</div>
				  </div>
				   ...
				   <div class="col-md-2 col-xs-2">
						<div class="form-group">
						  ...
						  <input type="tel" class="form-control" name="Telefone" placeholder="" required>
						</div>
				  </div>
				  ...
				  <div class="col-md-4 col-xs-4">
					    <div class="form-group">
						  ...
						  <input type="text" class="form-control" name="volumeBolsa" placeholder="" required>
					    </div>
				  </div>
						  ...
						  <div class="col-md-2" style="background-color:white;">
							...
							<div class="col-md-13 col-xs-13"><hr><br>
								...
								Se a resposta anterior for sim, qual o nome da organização?<br><textarea name="message" rows="1%" cols="30">
								   </textarea>
								</div>
							</div>
							...
							<div class="col-md-13 col-xs-13"><hr><br>
								<div class="form-group">
								  <label for="text">Responsável pela Horta/Projeto?</label>
								  <form> 
								   <textarea name="message" rows="1%" cols="30">
								   </textarea> 
								</form>
