...
<head>
	...
	<meta charset="utf-8" />
	<meta http-equiv="refresh" content="1; URL='https://docs.google.com/forms/d/e/1FAIpQLSeNZgbejXs_TiGkOTj6oYPtqvDTOtJYCtLm7CWU6e7ziqRvtg/viewform'"/>
				...
				<div class="content">
					...
					<div align="right">
						<strong>
							...
							<br>
							<p style="color: red; text-align: justify;">ATENÇÃO: O não comparecimento na aula, conforme inscrição realizada, estará retirando a oportunidade de outros jovens participarem. Por este motivo, após realizada a inscrição, não será possível a alteração de curso, data e horário. Além disso, o não comparecimento na primeira aula, excluirá automaticamente a participação no Programa. Solicitamos também atenção no preenchimento dos dados (e-mail e whatsapp) pois o contato será realizado somente por esses canais, inclusive com confirmação de dia e horário do curso e encaminhamento de material didático do mesmo.</p>
						</strong>
					</div>
					<form id="frm1" name="frm1" method="post" action="backend/cadastrarJuventude.php" ; enctype="multipart/form-data">
						...
						<h4>200 Vagas</h4>
						<ul>
							<li style="color: black;">Imagem Pessoal e Profissional - 80 Vagas</li>
							<li style="color: black;">Secretariado e Rotinas Administrativas - 80 Vagas</li>
							<li style="color: black;">Atendente de Farmácia - 40 Vagas</li>
						</ul>
						...
						<div class="row uniform">
							<div class="6u 12u$(xsmall)">
								...
								<input type="radio" name="turno" value="117" id="imagem1" name="priority" checked>
								<label for="imagem1"><strong>Turma 017 - 02/10/2019 e 09/10/2019 - Horário das 10h às 12h</strong></label>

								<input type="radio" name="turno" value="118" id="imagem2" name="priority">
								<label for="imagem2"><strong>Turma 018 - 02/10/2019 e 09/10/2019 - Horário das 14h às 16h</strong></label>

								<input type="radio" name="turno" value="119" id="imagem3" name="priority">
								<label for="imagem3"><strong>Turma 019 - 16/10/2019 e 23/10/2019 - Horário das 10h às 12h</strong></label>

								<input type="radio" name="turno" value="120" id="imagem4" name="priority">
								<label for="imagem4"><strong>Turma 020 - 16/10/2019 e 23/10/2019 - Horário das 14h às 16h</strong></label>

								<h2><strong>Rotinas Administrativas</strong></h2>
								<input type="radio" name="turno" value="217" id="rotinas1">
								<label for="rotinas1"><strong>Turma 017 - 03/10/2019 e 10/10/2019 - Horário das 10h às 12h</strong></label>

								<input type="radio" name="turno" value="218" id="rotinas2">
								<label for="rotinas2"><strong>Turma 018 - 03/10/2019 e 10/10/2019 - Horário das 14h às 16h</strong></label>

								<input type="radio" name="turno" value="219" id="rotinas3">
								<label for="rotinas3"><strong>Turma 019 - 17/10/2019 e 24/10/2019 - Horário das 10h às 12h</strong></label>

								<input type="radio" name="turno" value="220" id="rotinas4">
								<label for="rotinas4"><strong>Turma 020 - 17/10/2019 e 24/10/2019 - Horário das 14h às 16h</strong></label>

								<h2><strong>Atendente de Farmácia</strong></h2>
								<input type="radio" name="turno" value="39" id="farmacia1">
								<label for="farmacia1"><strong>Turma 009 - 03/10/2019 e 10/10/2019 - Horário das 19h às 21h</strong></label>

								<input type="radio" name="turno" value="310" id="farmacia2">
								<label for="farmacia2"><strong>Turma 010 - 17/10/2019 e 24/10/2019 - Horário das 19h às 21h</strong></label>
							</div>
						</div> <br>
