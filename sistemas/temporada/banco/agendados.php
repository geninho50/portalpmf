...
<link rel="stylesheet" href="../../layout/themePMF/css/style.css">
	...
	<div class="mini-header">
	    <ul class="mini-header__items">
	      <li style="font-size: 13px;">Treinamentos Ambulantes - Operação Verão 2018/2019</li>
	    </ul>
	</div>
...
<div class="header">
 ...
 <?php 
	...
	if ($iphone || $ipad || $android || $palmpre || $ipod || $berry || $symbian == true){
		...
		echo '<div class="flex-container hero-wrapper" style="background-image: url(../rastreabilidade/imagens/praia.jpg);">';  };    ?>
				...
				<div id="busca-home" class="search-bar search-bar--home column6-lg column8-sm column8-xs">
			        <h1 class="hidden-sm hidden-xs">Treinamentos Ambulantes - Operação Verão 2018-2019</h1><br>
			        <p style="color: white;">ACIF Centro - Rua Emilio Blum, 121 - Centro/Fpolis - 40 lugares</p>
			        <p style="color: white;">ACIF Lagoa - Rua Nossa Senhora da Conceição, 30 - Lagoa da Conceição/Fpolis - 60 lugares</p>
    ...
    <h2>Dia do seu curso</h2>
		<div class="row">
			<div class="col-md-6">
			      <?php foreach( $gdb->gs['CHAVE'] as $key=>$value ){ 	
						print "<p value='$value'>".$gdb->gs['DIA'][$key]." - ".$gdb->gs['HORARIO'][$key]." - ".$gdb->gs['LOCAL'][$key]."</p>";
						}
				   ?>
			</div>
        </div><br>  
