...
<script>
  ...
  <title>Emitir Nota Eletrônica</title>
     <?php
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="Suporte Nota Fiscal Eletrônica - Prefeitura de Florianópolis. Como Emitir uma Nota Fiscal Eletrônica."/>
    <meta name="keywords" content="Nota fiscal,nota fiscal eletrônica,nf, como emitir nota fiscal, como emitir, como transmitir nota fiscal, como criar nfps, como criar nota fiscal eletrônica, nota fiscal pmf emissão, nota florianópolis, florianópolis, nota fiscal eletrônica transmissão, transmissão, criação de nota fiscal"/>
    <meta name="robots" content="max-snippet:-1, max-image-preview:large, max-video-preview:-1"/>
    <link rel="canonical" href="http://www.pmf.sc.gov.br/sistemas/nfpsSuporte/EmitirNota.php"/>
    <meta property="og:locale" content="pt_BR"/>
    <meta property="og:type" content="website"/>
    <meta property="og:title" content="Emitir Nota Eletrônica"/>
    <meta property="og:description" content="Suporte Nota Fiscal Eletrônica - Prefeitura de Florianópolis. Como Emitir uma Nota Fiscal Eletrônica."/>
    <meta property="og:url" content="http://www.pmf.sc.gov.br/sistemas/nfpsSuporte/EmitirNota.php"/>
    <meta property="og:site_name" content="Emitir Nota Eletrônica"/>
...
<div id="conteudo_pagina" class="column6-lg" align="justify" style="margin:auto;">
  ...
  <h2 align="center">Como Emitir uma Nota Fiscal Eletrônica</h2>
  ...
  <video poster="../../arquivos/imagensNFPSe/thumbnail.png" width="600"  height="360"controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747; margin-left: 20%">
      <source src="imagens/Emitir nota.mp4" type="video/mp4">
        Seu navegador não suporta HTML5.
      </video>

        <br><br>
  <p>O Sistema de Nota Fiscal de Prestação de Serviço Eletrônica está disponível <a href="https://nfps-e.pmf.sc.gov.br/frontend/#!/login" target="_blank" style="color:blue">aqui</a> para todos os contribuintes do Município de Florianópolis. Utilize o descritivo abaixo para lhe auxiliar na emissão da sua primeira Nota Fiscal de Prestação de Serviços Eletrônica.</p>
  ...
  <a href="https://nfps-e.pmf.sc.gov.br/frontend/#!/login" target ="_blank"> <img src="../../arquivos/imagensNFPSe/TELALOGIN.png" alt="" width="100%"></a> <br>
  ...
  <a href="https://nfps-e.pmf.sc.gov.br/frontend/#!/login" target ="_blank"> <img src="../../arquivos/imagensNFPSe/0 - LoginCertificado.png" alt="" width="100%"> </a><br>
  <hr style=" border-top: 1px solid black;">
  ...
  <a href="https://nfps-e.pmf.sc.gov.br/frontend/#!/login" target ="_blank"> <img src="../../arquivos/imagensNFPSe/login.png" alt="" width="100%"></a>

  <hr style=" border-top: 1px solid black;">
  
  <p>Selecione uma das opções: Criar Nova Nota ou Criar Nova Nota Simplificada*.</p>
  <p style="font-size: 12px; "><br> * A Nota Fiscal Simplicada é uma versão da Nota Fiscal Eletrônica que não deverá ser informado os dados do Tomador, esta funcionalidade esta em de acodo com a legislação atual. <a href="emitirnotasimplificada.php" style="text-decoration: underline;">Clique aqui</a> para mais informações.</p>
  <img style="border: 1px solid grey;" src="../../arquivos/imagensNFPSe/1 - Criar Nota.png" alt="" width="100%">
  ...
  <hr style=" border-top: 1px solid black;">
  <p>Agora informe os dados do Serviço Prestado selecinando a opção Adicionar Serviço.</p>
  <img src="../../arquivos/imagensNFPSe/5 - Add Serviço.png" alt="" width="100%">
  ...
  <img src="../../arquivos/imagensNFPSe/7 - Checagem Final.png" alt="" width="100%">
  ...
  <img style="border: 1px solid grey;" src="../../arquivos/imagensNFPSe/8 - Final.png" alt="" width="100%">        
<hr style=" border-top: 1px solid black;">
...
<iframe src="https://sefinnetweb.pmf.sc.gov.br/Sefinnet/hotSite.vm?tela=AREA_WEB_COMO_EMITIR&sistema=3" width="0" height="0"></iframe>
