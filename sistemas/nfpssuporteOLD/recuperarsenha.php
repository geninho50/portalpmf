...
<script>
  ...
  <title>Recuperar Senha</title>
    ...
    ?>
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="Suporte Nota Fiscal Eletrônica - Prefeitura de Florianópolis. Como Recuperar/Trocar senha de uma Nota Fiscal Eletrônica."/>
    <meta name="keywords" content="Nota fiscal,nota fiscal eletrônica,nf, como recuperar senha nota fiscal,senha, trocar senha, perdi, perder, perdi minha senha, trocar senha pmf nfe, recuperar, login"/>
    <meta name="robots" content="max-snippet:-1, max-image-preview:large, max-video-preview:-1"/>
    <link rel="canonical" href="http://www.pmf.sc.gov.br/sistemas/nfpsSuporte/RecuperarSenha.php"/>
    <meta property="og:locale" content="pt_BR"/>
    <meta property="og:type" content="website"/>
    <meta property="og:title" content="Recuperar Senha"/>
    <meta property="og:description" content="Suporte Nota Fiscal Eletrônica - Prefeitura de Florianópolis. Como Recuperar/Trocar senha de uma Nota Fiscal Eletrônica."/>
    <meta property="og:url" content="http://www.pmf.sc.gov.br/sistemas/nfpsSuporte/RecuperarSenha.php"/>
    <meta property="og:site_name" content="Recuperar Senha"/>
...
<div id="conteudo_pagina" class="column6-lg" align="justify" style="margin:auto;">
  ...
  <video poster="../../arquivos/imagensNFPSe/thumbnail.png" width="600"  height="360"controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747; margin-left: 20%">
      <source src="imagens/Trocar Senha.mp4" type="video/mp4">
        Seu navegador não suporta HTML5.
      </video>
      <br><br>
<p>Para recuperar sua senha como MEI ou Profissional Autônomo, escolha a opção "Realizar Login sem Certificado Digital". Insira seu <b>CMC</b> e clique no botão "Esqueci Minha Senha".</p>
  <img style="border: 1px solid grey;" src="../../arquivos/imagensNFPSe/Esqueci.png" alt="" width="100%">        
<hr style=" border-top: 1px solid black;">

  <p>Confirme se o e-mail cadastrado para a recuperação é o correto e clique em "Enviar".</p>
<img style="border: 1px solid grey;" src="../../arquivos/imagensNFPSe/EmailSenha.png" alt="" width="100%">        
<hr style=" border-top: 1px solid black;">
  <p>Verifique sua caixa postal (inclusive a caixa "Spam") em busca do código de verificação. Após digitar e enviar o código verificador, você poderá trocar sua senha.</p>
  <img style="border: 1px solid grey;" src="../../arquivos/imagensNFPSe/CodigoFinal.png" alt="" width="100%">        
  <hr style=" border-top: 1px solid black;">
...
<iframe src="https://sefinnetweb.pmf.sc.gov.br/Sefinnet/hotSite.vm?tela=AREA_WEB_COMO_RECUPERAR_SENHA&sistema=3" width="0" height="0"></iframe>
