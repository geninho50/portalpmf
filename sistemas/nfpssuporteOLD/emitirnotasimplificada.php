...
<script>
  ...
  <title>Emitir Nota Simplificada</title>
    ...
    <link rel="canonical" href="http://www.pmf.sc.gov.br/sistemas/nfpsSuporte/EmitirNotaSimplificada.php"/>
    ...
    <meta property="og:url" content="http://www.pmf.sc.gov.br/sistemas/nfpsSuporte/EmitirNotaSimplificada.php"/>
...
<li>9609-2/05 ATIVIDADES DE SAUNA E BANHOS</li>
  ...
  <img src="../../arquivos/imagensNFPSe/TELALOGIN.png" alt="" width="100%"> <br>
  ...
  <img src="../../arquivos/imagensNFPSe/0 - LoginCertificado.png" alt="" width="100%"> <br>
  <hr style=" border-top: 1px solid black;">
  ...
  <img style="border: 1px solid grey;" src="../../arquivos/imagensNFPSe/CriarSimplificada.png" alt="" width="100%">
  ...
  <p>Caso deseje informar a identificação do tomador (CPF) clique em "Sim" e informe o CPF apropriado. Observe que este passo não é obrigatório</p>
  <img src="../../arquivos/imagensNFPSe/IdTomador.png" alt="" width="100%" style="margin-bottom: 10px">
  <img src="../../arquivos/imagensNFPSe/CPFTomador.png" alt="" width="100%">
  ...
  <div class="info">
    <div class="info-column">
      <div class="info-block">
        ...
        <ul>
          <li><p style="color: white;">Alexandre Almeida Maria</p></li>
          <li><p style="color: white;">Cyro Bacha Neto</p></li>
        </ul>
      </div>
    </div>
     ...
     <div class="info-column">
      <div class="info-block">
        ...
        <ul>
          <li><p style="color: white;">(48) 3213-5518 - Suporte Sefinnet</p></li>
          <li><p style="color: white;">(48) 3213-5555 - Fiscalização</p></li>
          <li><p style="color: white;">(48) 3251-6400 - Pró-Cidadão</p></li>
        </ul>
      </div>
       ...
       <div class="info-block">
        <h4>Email</h4>
        <ul>
          <li><p style="color: white;">sefinnet@pmf.sc.gov.br</p></li>
        </ul>
      </div>
    </div>
    </div>
