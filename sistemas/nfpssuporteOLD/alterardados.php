...
<script>
  ...
  <title>Alterar Dados Nota Eletrônica</title>
     <?php
  ...
  <br>
    ...
    <meta name="keywords" content="Nota fiscal,nota fiscal eletrônica,nf, como substituir nota fiscal, como alterar dados, como trocar senha, como trocar email, trocar,nota fiscal pmf substituição, nota florianópolis substituir, florianópolis, nota fiscal eletrônica substituir, substituir, substituição de nota fiscal"/>
    <meta name="robots" content="max-snippet:-1, max-image-preview:large, max-video-preview:-1"/>
    <link rel="canonical" href="http://www.pmf.sc.gov.br/sistemas/nfpsSuporte/alterardados.php"/>
    <meta property="og:locale" content="pt_BR"/>
    <meta property="og:type" content="website"/>
    <meta property="og:title" content="Alterar Dados Nota Eletrônica"/>
    <meta property="og:description" content="Suporte Nota Fiscal Eletrônica - Prefeitura de Florianópolis. Como alterar dados cadastrais do Sistema Web da Nota Fiscal Eletrônica."/>
    <meta property="og:url" content="http://www.pmf.sc.gov.br/sistemas/nfpsSuporte/alterardados.php"/>
...
<div id="conteudo_pagina" class="column6-lg" align="justify" style="margin:auto">
  ...
  <h2 align="center">Como Alterar Dados Cadastrais</h2>
    ...
    <video poster="../../arquivos/imagensNFPSe/thumbnail.png" width="600"  height="360"controls="controls" style="border-bottom-style: solid;border-bottom-width: 4px;border-bottom-color: #474747; margin-left: 20%;">
      <source src="imagens/nfpse_alterar_dados.mp4" type="video/mp4">
        Seu navegador não suporta HTML5.
      </video>
<br><br>

  <p>Uma vez logado no <a href="https://nfps-e.pmf.sc.gov.br/frontend/#!/login" target="_blank" style="color:blue;">Sistema Web</a> de emissão de notas, é possível alterar os dados cadastrais como o e-mail e a senha. Caso você tenha perdido sua senha e não consiga logar no sistema, veja o tutorial de <a href="recuperarsenha.php" style="color:blue;" target="_blank">Como Recuperar a Senha</a>.</p>

  <p>Para acessar essa funcionalidade clique no ícone de perfil no canto superior direito da tela.</p>
  <img src="../../arquivos/imagensNFPSe/icone.png" alt="" width="100%">
  <br>
  <hr style=" border-top: 1px solid black;">
  <p>Nesse menu estarão disponíveis as opções de alterar o e-mail e a senha.</p>
  <img src="../../arquivos/imagensNFPSe/iconeopcao.png" alt="" width="100%">
   <hr style=" border-top: 1px solid black;">
  <p>Na opção de "Alterar e-mail" você pode editar o e-mail na caixa de texto. Depois de editar ou trocar o e-mail clique em "Salvar".</p>
  <img src="../../arquivos/imagensNFPSe/alteraremail.png" alt="" width="100%">
   <hr style=" border-top: 1px solid black;">
  <p>Na opção de "Alterar senha" digite a nova senha e depois digite ela novamente para confirmação. Clique em "Salvar".</p>
  <img src="../../arquivos/imagensNFPSe/alterarsenha.png" alt="" width="100%">
<hr style=" border-top: 1px solid black;">
...
<iframe src="https://sefinnetweb.pmf.sc.gov.br/Sefinnet/hotSite.vm?tela=AREA_WEB_ALTERAR_DADOS&sistema=3" width="0" height="0"></iframe>
