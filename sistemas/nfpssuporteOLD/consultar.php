...
<br><br>
  ...
  <p>Para consultar uma nota já enviada no <a href="https://nfps-e.pmf.sc.gov.br/frontend/#!/login" target="_blank" style="color:blue">Sistema Web</a>, utilize os filtros de pesquisa para encontrar a nota desejada, depois clique em "Consultar".</p>
  <img src="../../arquivos/imagensNFPSe/Consultar1.png" alt="" width="100%">

   <hr style=" border-top: 1px solid black;">
  <p>No celular, utilize os filtros de pesquisa para encontrar a nota desejada, depois clique no incone azul com a seta branca.</p>
  <img src="../../arquivos/imagensNFPSe/Consultar2.png" alt="" width="100%">
