...
//		{
		...
		echo "<p align='center'>";
		echo "<a class='lp' href='cadcondutores.php'>Listar Cadastro de Condutores</a>";
	    echo "</p>";
		
		echo "<tr align='center'>";
		echo "<td width='60%' height='40'>";
		echo "<p align='center' ><font face='verdana' size='2'><a href='condutorpermis.php'>Condutor / Permission&aacuterios</a></p>";
		echo "</td>";
		echo "</tr>";

		echo "<tr align='center'>";
		echo "<td width='60%' height='40'>";
		echo "<p align='center' ><font face='verdana' size='2'><a href='permcassadoscpi.php'>Permission&aacuterios que tiveram selo e licen&ccedila recolhidos por motivo judicial</a></p>";
		echo "</td>";
		echo "</tr>";
