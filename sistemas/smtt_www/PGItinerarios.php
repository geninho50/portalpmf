...
echo "<p align='center'><a href='PGItinerariosimp.php?numero_linha=$_varlin' target='_blank' class='lp'>IMPRIMIR</a></p>";
...
echo utf8_encode($_row_0['linha']) . "  -  "  . utf8_encode($_row_0['nome_linha']);
echo "</font>";
echo "</td>";
echo "</tr>";
echo "</table>";
...
echo "</table>";
echo "<p align='center'><a href='PGHorarios.php?numero_linha=$_varlin' class='hr'>Voltar</a></p>";
echo "<br>";
