...
<title>Filtrar Comunica&ccedil&otildees</title>
...
?>
<body>
<form id="form1" name="form1" method="post" action="comunicalista.php">
	<table align="center" border=4 bordercolor='#9ACD32'>
	<tr><th colspan="2"><align="center">Filtrar Comunica&ccedil&otildees</th></tr>
	<tr>
...
//		echo "</td>";
	...
	<td align="left"><input type="text" name="numordem" size="4" maxlength= "4"></a></td>
	</tr><tr>
	...
	<td><input name='filtro' type='hidden' id='filtro' value='f'></td>
	</tr>
	<br/>
	</table>
...
<table align='center' border=0>
<tr>
<td><align='center'><a class='sma' href='javascript:window.history.go(-1)'>Voltar</a>&nbsp&nbsp&nbsp&nbsp&nbsp</td>
