...
<div class="centro">
     ...
     <div id="aba_passosreq" class="aba_serv" onClick="AlternarAbas('aba_passosreq','conteudo_passosreq')"><span>solicitar</span></div>
     <div id="aba_download" class="aba_serv" onClick="AlternarAbas('aba_download','conteudo_download')"><span>downloads</span></div>
     <div id="aba_onde" class="aba_serv" onClick="AlternarAbas('aba_onde','conteudo_onde')"><span>onde encontrar</span></div>
     <div id="aba_links" class="aba_serv" onClick="AlternarAbas('aba_links','conteudo_links')"><span>links</span></div>
     </div><!-- fim painel_abas -->   
     ...
     <?php
		...
		echo("<br><img src=\"../layout/imagens/serv_btn_descricao.png\" alt=\"informações\" border=\"0\" align=\"absmiddle\" />");
		}
      ...
      <?php
		 	if($rowdocumentos !=0)
			{
				$string = "<br><table>";
					...
					{
						$string .= "<tr><td width=\"260\">" . html_entity_decode($objdoc->doc_nome) . "</td><td width=\"140\"><a href=\"index.php?pagina=servdoc&doc=$objdoc->doc_id\"><img src=\"../layout/imagens/serv_btn_info.png\" alt=\"informações\" width=\"38\" height=\"19\" border=\"0\" align=\"absmiddle\" /></a> <a href=\"../arquivos/documentos/$objdoc->doc_link\"><img src=\"../layout/imagens/serv_btn_download.png\" alt=\"online\" height=\"19\" border=\"0\" align=\"absmiddle\" /></a></td></tr> ";
					}
