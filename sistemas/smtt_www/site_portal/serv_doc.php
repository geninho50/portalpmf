...
<div class="centro">
    ...
    <div class="dados_servicos">  
      <h3><img src="../layout/imagens/serv_marcador.jpg" width="15" height="16" align="absmiddle" />&nbsp;serviços relacionados</h3>
      <ul>
        <?php
			$string = NULL;
			while($objservrel = pg_fetch_object($rsqlservrel))
			{
				...
				$string =  "<li><a href=\"index.php?pagina=servpagina&id=$objaux->serv_id\">" . html_entity_decode($objaux->serv_nome) . "</a></li>";
