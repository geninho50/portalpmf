...
if($sAnimal == 3) { 
  $wheres = "i.status is null AND a.sexo = 'M'";
} else if($sAnimal == 4) {
  $wheres = "i.status is null AND a.sexo = 'F'";
} else if($sAnimal == 5) {
  $wheres = "i.status is null";
}
        ...
        <ul class="pagination justify-content-center">
            <li class="page-item disabled">
                ...
                for($i=1; $i <= $paginas_atual; $i++)
                {
                    ...
                    {
                      echo '<a style="padding: 8px 8px !important;" href="indexnovo.php?pag='.$i.'&tipoAnimal='.$tipoAnimal.'&sAnimal='.$sAnimal.'"> '.$i.'</a>';
                    }
                }   
                echo '<a style="padding: 8px 8px !important;" href="indexnovo.php?pag='.$paginas_atual.'&tipoAnimal='.$tipoAnimal.'&sAnimal='.$sAnimal.'"> Última página</a>';
                ?>
            </li>
        </ul>
    </nav>
 ...
 $( function() {
  ...
  <script>
    function filtro(newsAnimal){
      ...
      window.location.replace("indexnovo.php?pag="+pag+"&tipoAnimal="+tipoAnimal+"&sAnimal="+newsAnimal);
    }
