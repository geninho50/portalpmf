  ...
  <body>
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6"><label>Data:</label><input value="<?=$data?>" id="data" class="form-control" type="date"/></div>
        </div>

        <div class="row">
            <div class="col-md-6"><label>Horário:</label><input value="<?=$horario?>" id="horario" class="form-control" type="time"/></div>
        ...
        <div class="row">
	 	...
	 	<div class="responsabilidade">
            ...
            <p>**Qualquer necessidade de alteração na ficha de inscrição deve ser solicitada através do email (educativoffc@gmail.com).</p>
        </div>
    ...
    $("#foneResponsa").mask("(99) 99999999?9");
