...
$gdb->open("select * from pessoa p , pessoaAuxiliar pa  where p.codigopessoa = pa.codigopessoa and cnpj = '$cnpj' and codigoprojeto = '$codigoprojeto' and pa.situacaoSOMAR='V'  ");

if( $gdb->linhas > 0 ){
	$temCPF = 1;
}
	
$gdb->open("select * from pessoa p , pessoaAuxiliar pa  where p.codigopessoa = pa.codigopessoa and email = '$email' and codigoprojeto = '$codigoprojeto' and pa.situacaoSOMAR='V' ");
