...
print '
<section>
	<form id="formHortelao" name="formHortelao">
	<div class="full-title5">
		<div class="container">
			<!-- Page Heading/Breadcrumbs -->
			<h1 class="mt-4 mb-3">CADASTRO DO HORTELÃO</h1>
		</div>
	</div><br>
	<div class="container">
		...
		<br>
			<div class="row">
				...
				<div class="col-md-12"><br>
					<div class="col-md-3">
						<input type="button" onclick="salvarHortelao();" value="Salvar" class="btn btn-success btn-medium">
					</div><br>
				</div>
...
<!--
				...
				<div class="col-md-1" style="background-color:#white;">
					<label>... </label><input type="button" value="Buscar" onclick="#filtroCEP()" class="btn btn-info  btn-small ">	
				</div>
-->