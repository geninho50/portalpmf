...
?>	
	<body class="subpage">
		...
		<!-- Nav -->
			<nav id="menu">
				<ul class="links">
					<li><a href="http://www.pmf.sc.gov.br/sistemas/MinhocaCabeca-adm/">Sair</a></li>
				</ul>
			</nav>
	...
	<? if( $gdb->linhas>0 && $gdb->gs['SITUACAO'][0] == 'Enviado'  ){?>		
		<!-- Main -->
			<div id="main" class="container">

							<!-- Form -->
								<h2>Dados do Participante</h2>
								<p>Todos os campos s&atilde;o obrigat&oacute;rios. <br /> Ao finalizar a inscri&ccedil;&atilde;o imprima o seu comprovante e leve-o assinado no dia da Oficina. Leve tamb�m comprovante de resid�ncia!</p>
										...
										<div class="row uniform">
											<div class="">
												...
												<?  foreach( $gdb->gs['DATA'] as $i=>$value ){ 												
												        $dia = $arrayDia[(date('N',strtotime( $gdb->gs['DATAP'][$i]) )-1 ) ];
	...
	<? }else{
	      for( $i=0; $i<6; $i++ ){ print "<br>";}			  
		    if( $gdb->gs['SITUACAO'][0] == 'Esperando' ){ ?>
	            <h3 class="align-center" ><b>Tivemos um problema tecnico e pedimos desculpas! Voce acaba de retorna para fila de espera!<b></h3><?
			}else{?>  
