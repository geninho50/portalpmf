...
<table width=666 cellspacing=5 cellpadding=0 border=0 align=Default>
  <tr>
    <td width=41><img src='logo_empresa.png'></td>
...
<table cellspacing=0 cellpadding=0 width=666 border=0><tr><td class=cp width=150> 
  <span class="campo"><IMG src="imagens/logocaixa.jpg" width="150" height="40" border=0></span></td>
...
numero</td></tr><tr><td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td><td class=cp valign=top width=268 height=12>
...
<img height=13 src=imagens/1.png width=1 border=0></td><td class=ct valign=top width=43 height=13>Especie</td><td class=ct valign=top height=13 width=7>
