...
function salvarCadastro() { 
    if ($('#nomeCadastro').val() == '') {
        ...
        xhr3.open('POST', 'https://www.pmf.sc.gov.br/sistemas/IlhaCampeche/php/salvarCadastro.php', true);
...
function salvarEstrangeiro() {
    if ($('#nomeEstrangeiro').val() == '') {
        alert('Informe o Nome!');
        $('#nomeEstrangeiro').focus();
    } else if ($('#documento').val() == '') {
        alert('Informe o documento!');
        $('#documento').focus();
    } else if ($('#dataEstrangeiro').val() == '') {
        alert('Informe a Data!');
        $('#dataEstrangeiro').focus();
    } else if ($('#emailEstrageiro').val() == '') {
        alert('Informe o E-mail!');
        $('#emailEstrageiro').focus();
    } else if ($('#telefoneEstrangeiro').val() == '') {
        alert('Informe o Telefone!');
        $('#telefoneEstrangeiro').focus();
    } else if ($('#pais').val() == '') {
        alert('Informe o pais!');
        $('#pais').focus();
    } else if ($('#senhaEstrangeiro').val() == '') {
        alert('Informe a senha!');
        $('#senhaEstrangeiro').focus();
    } else if ($('#senhaConf2').val() !== $('#senhaEstrangeiro').val()) {
        alert('Informe o repedir a senha!');
        $('#senhaEstrangeiro').val("");
        $('#senhaConf2').val("");
        $('#senhaConf2').focus();
    } else {  
        ...
        var dados = {
            nome: document.getElementById("nomeEstrangeiro").value,            
            documento: document.getElementById("documento").value,        
            data: document.getElementById("dataEstrangeiro").value,        
            email: document.getElementById("emailEstrageiro").value,  
            telefone: document.getElementById("telefoneEstrangeiro").value,
            pais: document.getElementById("paises").value,          
            senha: document.getElementById("senhaEstrangeiro").value            
        }

        var dadosJSON = JSON.stringify(dados);

        // Configure a chamada AJAX
        xhr3.open('POST', 'https://www.pmf.sc.gov.br/sistemas/IlhaCampeche/php/salvarEstrangeiro.php', true);
