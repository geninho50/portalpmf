...
<head>
    ...
    <title>PMGIRS Caderno 7: Minuta da Pol&iacute;tica Municipal</title>
...
<body>
   ...
   <div class="menu pull-left esquerda">
    ...
    <div class="container">
        ...
        <h2 class="text-center">PMGIRS Caderno 7: Minuta da Pol&iacute;tica Municipal</h2>

        <br>

        <div class="pdf">
            <iframe src="https://www.pmf.sc.gov.br/sistemas/pmgirs/arquivos/PMGIRS_CADERNO_7_Minuta da politica Municipal.pdf" width="100%" height="100%" style="border: 1px solid;"></iframe>
        </div>
