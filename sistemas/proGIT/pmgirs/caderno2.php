...
<head>
    ...
    <title>PMGIRS Caderno 2: Diagnostico PMGIRS Florianopolis</title>
...
<body>
   ...
   <div class="menu pull-left esquerda">
    ...
    <div class="container">
        ...
        <h2 class="text-center">PMGIRS Caderno 2: Diagnostico PMGIRS Florianopolis</h2>

        <br>

        <div class="pdf">
            <iframe src="https://www.pmf.sc.gov.br/sistemas/pmgirs/arquivos/PMGIRS_CADERNO_2_Diagnostico_PMGIRS_Florianopolis.pdf" width="100%" height="100%" style="border: 1px solid;"></iframe>
        </div>
