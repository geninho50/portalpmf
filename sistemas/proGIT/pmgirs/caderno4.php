...
<head>
    ...
    <title>PMGIRS Caderno 4: PMGIRS Aspectos Gerais do Planejamento das A&ccedil;&otilde;es Florian&oacute;polis</title>
...
<body>
   ...
   <div class="menu pull-left esquerda">
    ...
    <div class="container">
        ...
        <h2 class="text-center">PMGIRS Caderno 4: PMGIRS Aspectos Gerais do Planejamento das A&ccedil;&otilde;es Florian&oacute;polis</h2>

        <br>

        <div class="pdf">
            <iframe src="arquivos/PMGIRS_CADERNO_4_Aspectos_Gerais_do_Planejamento_das_Acoes_PMGORS_Florianopolis.pdf" width="100%" height="100%" style="border: 1px solid;"></iframe>
        </div>
