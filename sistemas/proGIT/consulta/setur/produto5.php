...
<head>
    ...
    <title>Produto 5: Estudo Preliminar Arquitetônico e Urbanístico</title>
...
<body>
    ...
    <div class="container">
        ...
        <h2 class="text-center">Produto 5: Estudo Preliminar Arquitetônico e Urbanístico</h2>
        ...
        <div class="pdf">
            <iframe src="http://www.pmf.sc.gov.br/sistemas/consulta/setur/arquivos/produto5.pdf" width="100%" height="100%" style="border: 1px solid;"></iframe>
        </div>
