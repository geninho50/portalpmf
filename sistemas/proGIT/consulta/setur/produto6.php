...
<head>
    ...
    <title>Produto 6: Estudo de Viabilidade Econômico-Financeiro</title>
...
<body>
    ...
    <div class="container">
        ...
        <h2 class="text-center">Produto 6: Estudo de Viabilidade Econômico-Financeiro</h2>
        ...
        <div class="pdf">
            <iframe src="http://www.pmf.sc.gov.br/sistemas/consulta/setur/arquivos/produto6.pdf" width="100%" height="100%" style="border: 1px solid;"></iframe>
        </div>
