...
<head>
    ...
    <title>Produto 2: Estudo de Territorialidade</title>
...
<body>
    ...
    <div class="container">
        ...
        <h2 class="text-center">Produto 2: Estudo de Territorialidade</h2>
        ...
        <div class="pdf">
            <iframe src="http://www.pmf.sc.gov.br/sistemas/consulta/setur/arquivos/produto2.pdf" width="100%" height="100%" style="border: 1px solid;"></iframe>
        </div>
