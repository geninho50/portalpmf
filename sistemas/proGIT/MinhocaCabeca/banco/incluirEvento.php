<?php
    ...
    if( $gdb->incluirEvento( $nome_evento,$descricao,$ministrante,$carga_horaria,$local,$vagas,$data,$hora,$status_evento, $observacao ) ) {
        echo json_encode(array('success' => '1'));    
    } else {
        echo json_encode(array('error' => 'Ocorreu algum problema ao incluir o evento.'));    
    }
