                    ...
                    <div class="row align-items-center justify-content-between">
                        <div class="col-lg-6 col-md-6">
                            <div class="philophy_text">
                                <h4 id="titulo"><?php print $msg; ?></h4>
                                <h6 id="titulo">Por favor faça login para continuar ou clique em voltar.</h6>
                                <!-- Botão para acionar modal -->
                                <button type="button" class="btn_1" data-toggle="modal" data-target="#modalExemplo">Fazer login</button>
                                <input type="button" class="btn_1"  name="btnVoltar" value="Voltar" onclick="history.back();" >
                                            <!-- Modal -->
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="sistemaUsuario.php" method="POST">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="email" name="usuario" placeholder="fulano@gmail.com">
                                                            </div>
                                                            <div class="form-group">
