...
$sqlEventoLivbre = " SELECT e.id_evento as codigo,
                            Upper(nome_evento) as nome_evento,
                                ...
                                <div class="card-body">
                                    ...
                                    <form id="frm">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="cpf" maxlength="11" max aria-describedby="emailHelp" placeholder="(Somente números)">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="rg" maxlength="15" placeholder="(Somente números)">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="celular">Informe o evento que você deseja fazer a inscrição : </label>
                                            <select name = 'id_evento' id = 'id_evento' class="form-control" >
                                            <?php foreach( $gdb->gs['NOME_EVENTO'] as $i=>$value ){ ?>
                                                <option value="<?php echo $gdb->gs['CODIGO'][$i]; ?>">
                                                    <?php echo $value.' - '.$gdb->gs['DATA'][$i].' '. $gdb->gs['HORA'][$i]; ?>
                                                </option>
                                            <?php }    ?>    
                                            </select>                                                                                                
                                        </div>
    ...
    <script>
        ...
        function update() {
            ...
            /*else if ($('#rg').val() == '') {
                ...
                alert('Informe o telefone ou o celular !');
                $('#telefone').focus();
            } else if ($('#profissao').val() == '') {
                alert('Informe sua profissao!');
                $('#profissao').focus();
            } else if ($('#numero').val() == '' && $('#complemento').val() == '' ) {
                alert('Informe o número da sua casa ou uma referência ( complemento ) !');
                $('#numero').focus();
                ...
                form_data.append('id_evento', $('#id_evento').val());
