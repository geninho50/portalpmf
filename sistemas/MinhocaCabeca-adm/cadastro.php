		...
		<!-- Nav -->
			<nav id="menu">
				<ul class="links">
					...
					<li><a href="login.html">&Aacute;rea do Participante</a></li>
				</ul>
			</nav>
		...
		<!-- Main -->
			<div id="main" class="container">
							...
							<!-- Form -->
								...
								<p>Todos os campos s&atilde;o obrigat&oacute;rios. <br /> Ao finalizar a inscri&ccedil;&atilde;o imprima o seu comprovante e leve-o assinado no dia da Oficina.</p>
								...
								<form method="post" action="#" id="formIndex" name="formIndex" >
									<div class="row uniform">
										...
										<input id="curso"  name="curso" type="hidden" value="<? print $_POST['curso']; ?>" />
		...
		<!-- Scripts -->
			...
			function enviar(){
				...
				if( err != 	'Tem' ){        
					...
					$.ajax({			
						   type: "POST",
						   url: "../banco/cadastrarMNCPessoas.php",
						   dataType: "json",
						   data: obj,
