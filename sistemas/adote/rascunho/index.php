  ...
  <div id="bannernoticias" class="carousel slide carousel-fade" data-ride="carousel">
    ...
    <div id="banner" class="carousel-inner">
      <div id="banner" class="carousel-item active">
        <img id="banner" src="img/banner9.jpg" class="d-block mx-auto w-100 img-fluid" alt="...">
      </div>
      <div id="banner" class="carousel-item">
        <img id="banner" src="img/banner12.jpg" class="d-block mx-auto w-100 img-fluid" alt="...">
      </div>
      <div id="banner" class="carousel-item">
        <img id="banner" src="img/banner13.jpg" class="d-block mx-auto w-100 img-fluid" alt="...">
      </div>
      <div id="banner" class="carousel-item">
        <img id="banner" src="img/banner14.jpg" class="d-block mx-auto w-100 img-fluid" alt="...">
      </div>
      <div id="banner" class="carousel-item">
        <img id="banner" src="img/banner15.jpg" class="d-block mx-auto w-100 img-fluid" alt="...">
      </div>
      <div id="banner" class="carousel-item">
        <img id="banner" src="img/banner16.jpg" class="d-block mx-auto w-100 img-fluid" alt="...">
      </div>
      <div id="banner" class="carousel-item">
        <img id="banner" src="img/banner17.jpg" class="d-block mx-auto w-100 img-fluid" alt="...">
      </div>
      <div id="banner" class="carousel-item">
        <img id="banner" src="img/banner18.jpg" class="d-block mx-auto w-100 img-fluid" alt="...">
      </div>
      <div id="banner" class="carousel-item">
        <img id="banner" src="img/banner19.jpg" class="d-block mx-auto w-100 img-fluid" alt="...">
      </div>
      <div id="banner" class="carousel-item">
        <img id="banner" src="img/banner20.jpg" class="d-block mx-auto w-100 img-fluid" alt="...">
      </div>
    </div>
  </div>
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination justify-content-center">
            <li class="page-item disabled">
                ...
                echo '<a style="padding: 8px 8px !important;" href="index.php?pag=1&tipoAnimal='.$tipoAnimal.'">'.'Primeira página'.'</a>';
                for($i=1; $i <= $paginas_atual; $i++)
                {
                    ...
                    {
                      echo '<a style="padding: 8px 8px !important;" href="index.php?pag='.$i.'&tipoAnimal='.$tipoAnimal.'"> '.$i.'</a>';
                    }
                }   
                echo '<a style="padding: 8px 8px !important;" href="index.php?pag='.$paginas_atual.'&tipoAnimal='.$tipoAnimal.'"> Última página</a>';
                ?>
            </li>
        </ul>
    </nav>
