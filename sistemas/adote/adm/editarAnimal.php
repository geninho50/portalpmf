...
if ($user == "adote.pmf@gmail.com" && $password == "Dibea.123") {
    ...
    $gdb->open("SELECT a.nome_animal, a.porte, a.sobre AS SOBRE_ANIMAL, a.idade_animal, g.img_principal, g.img_dois, g.img_tres, ta.id_temperamento, soa.id_sociavel, vba.id_vive_bem, saa.id_saude, la.id_localizacao, l.id_local FROM adoteDibea.animal a
        ...
        LEFT JOIN adoteDibea.local_animal l ON l.id_animal = a.id_animal
        WHERE a.ativo = 1 AND a.id_animal = $idAnimal");
    ...
    $localizacao_animal = $gdb->gs["ID_LOCALIZACAO"][0];
        ...
        <header>
            <nav class="navbar navbar-expand-lg navbar-light">
                <a class="navbar-brand" href="../index.php">
                    <img style="height: 35px !important;" src="../img/logosdp5.png" alt="">
                </a>
                ...
                <div class="collapse navbar-collapse flex-row-reverse" id="navbarNavAltMarkup">
                    <div class="navbar-nav">
                        ...
                        <a class="nav-item nav-link" href="../index.html"><span>Sair</span></a>
                    </div>
                </div>
            </nav>
        </header>
            ...
            <form id="frm">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="nome_animal" placeholder="Nome do Animal" value="<?= $nome_animal; ?>">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="sobre">Sobre o Animal</label>
                        <textarea class="form-control" id="sobre" placeholder="Sobre o Animal"><?= $sobre_animal; ?></textarea>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="nome_animal">Idade do Animal</label>
                        <input type="text" class="form-control" id="idade_animal" placeholder="Idade do Animal" value="<?= $idade_animal; ?>">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-12">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" <?php if (in_array(1, $sociavel_animal)) {
                                echo 'checked="checked"';
                            } ?> name="sociavel" id="sociavel1" value="1">
                            <label class="form-check-label" for="sociavel1">Crianças</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" <?php if (in_array(2, $sociavel_animal)) {
                                echo 'checked="checked"';
                            } ?> name="sociavel" id="sociavel2" value="2">
                            <label class="form-check-label" for="sociavel2">Outros Animais</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" <?php if (in_array(3, $sociavel_animal)) {
                                echo 'checked="checked"';
                            } ?> name="sociavel" id="sociavel3" value="3">
                            <label class="form-check-label" for="sociavel3">Idosos</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" <?php if (in_array(4, $sociavel_animal)) {
                                echo 'checked="checked"';
                ...
                <div class="form-row">
                    <div class="form-group col-md-12">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" <?php if (in_array(1, $vive_bem_animal)) {
                                echo 'checked="checked"';
                            } ?> name="vive_bem" id="vive1" value="1">
                            <label class="form-check-label" for="vive1">Casa</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" <?php if (in_array(2, $vive_bem_animal)) {
                                echo 'checked="checked"';
                            } ?> name="vive_bem" id="vive2" value="2">
                            <label class="form-check-label" for="vive2">Apartamento</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" <?php if (in_array(3, $vive_bem_animal)) {
                                echo 'checked="checked"';
                            } ?> name="vive_bem" id="vive3" value="3">
                            <label class="form-check-label" for="vive3">Apartamento telado</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" <?php if (in_array(4, $vive_bem_animal)) {
                                echo 'checked="checked"';
                            } ?> name="vive_bem" id="vive4" value="4">
                            <label class="form-check-label" for="vive4">Com outro animal</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" <?php if (in_array(5, $vive_bem_animal)) {
                                echo 'checked="checked"';
                ...
                <div class="form-row">
                    <div class="form-group col-md-12">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" <?php if (in_array(1, $saude_animal)) {
                                echo 'checked="checked"';
                            } ?> name="saude" id="saude1" value="1">
                            <label class="form-check-label" for="saude1">Vacinado</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" <?php if (in_array(2, $saude_animal)) {
                                echo 'checked="checked"';
                            } ?> name="saude" id="saude2" value="2">
                            <label class="form-check-label" for="saude2">Castrado</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" <?php if (in_array(3, $saude_animal)) {
                                echo 'checked="checked"';
                ...
                <input name="btnSubmit" onclick="javascript:update()" id="btnSubmit" class="btn btn-primary botao" value="Salvar">
    ...
    <script>
    	window.onload = function() {
    		$("#localizacao")[0].value = <?=$localizacao_animal;?>;
      };
      ...
      function update() {
        if ($('#nome_animal').val() == '') {
            ...
            form_data.append('idade_animal', $('#idade_animal').val());
