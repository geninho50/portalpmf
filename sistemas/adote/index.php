...
LEFT JOIN adoteDibea.galeria g ON g.id_galeria = ga.id_galeria
LEFT JOIN adoteDibea.interesse i ON i.id_animal = a.id_animal
WHERE ".$where." AND a.ativo = 1");   //a.tipo = 'Cachorro'
...
$gdb->open("SELECT COUNT(*) AS NUMERO FROM adoteDibea.animal a 
            LEFT JOIN adoteDibea.galeria_animal ga ON a.id_animal = ga.id_animal
            LEFT JOIN adoteDibea.galeria g ON g.id_galeria = ga.id_galeria
            LEFT JOIN adoteDibea.interesse i ON i.id_animal = a.id_animal
            WHERE i.status is null AND a.tipo = 'Cachorro' AND a.ativo = 1");  //a.tipo = 'Cachorro' AND
...
$gdb->open("SELECT COUNT(*) AS NUMERO FROM adoteDibea.animal a 
            ...
            LEFT JOIN adoteDibea.galeria g ON g.id_galeria = ga.id_galeria
            LEFT JOIN adoteDibea.interesse i ON i.id_animal = a.id_animal
            WHERE i.status is null AND a.tipo = 'Gato' AND a.ativo = 1");
