...
require($_SERVER[DOCUMENT_ROOT].'/ouvidoria/com/config.php');
   ...
   $image_server="";
   $image_css="http://www3.pr.gov.br/ouvidoria/";
   if (!($p_estado != "0" && $p_estado != "")) {
        $p_estado = 'SC';
        $p_munic=75493;
   }
?>
...
<option value=4>Sugestão</option>
                                  ...
                                  <tr>
                                        ...
                                        <td align=left valign=top height="15"><div id="dv_mun">
                                                        ...
                                                        <option value='' > </option> <?
                                                        $l_municipio=municipio($p_estado,$p_munic);
                                                        print $l_municipio;  ?>
                                                        </select>
                                  ...
                                  <tr>
                                    ...
                                    <td align=left valign=top height="15">
                                        <select name='p_orgao_sugestao' class="texto_form"  >
                                                 <?
                                                 $l_orgao= orgaoNome($p_orgao_sugestao);
                                                 print $l_orgao; ?>
                                        </select>
                                    </td>
                                  </tr>
